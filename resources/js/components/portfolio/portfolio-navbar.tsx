    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                ...
                >
                    <DockIcon className="rounded-3xl cursor-pointer size-full bg-background p-0 text-muted-foreground hover:text-foreground hover:bg-muted backdrop-blur-3xl border border-border transition-colors overflow-hidden">
                        <AnimatePresence mode="wait" initial={false}>
                            ...
                            >
                                {resolvedAppearance === 'dark' ? <Sun className="size-full" /> : <Moon className="size-full" />}
                            </motion.div>
                        </AnimatePresence>
                    </DockIcon>
                </button>
