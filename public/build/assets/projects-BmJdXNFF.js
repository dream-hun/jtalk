...
((n.definition = { methods: [`get`, `head`], url: `/projects` }),
...
((i.definition = { methods: [`get`, `head`], url: `/projects/create` }),
...
((o.definition = { methods: [`post`], url: `/projects` }),
...
((c.definition = { methods: [`get`, `head`], url: `/projects/{project}` }),
    (c.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { project: n }),
            ...
            (n = t(n)));
        let i = {
            project: typeof n.project == `object` ? n.project.uuid : n.project,
        };
        return (
            c.definition.url
...
((f.definition = { methods: [`put`, `patch`], url: `/projects/{project}` }),
    (f.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { project: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
...
((m.definition = { methods: [`delete`], url: `/projects/{project}` }),
    (m.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { project: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
