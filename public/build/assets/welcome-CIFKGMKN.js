...
import { t as u } from './utils-DDQLTkD9.js';
import { t as d } from './button-DTg8VAj1.js';
import { t as f } from './createLucideIcon-BEXpI4i1.js';
import { t as p } from './chevron-down-BWhPWOV5.js';
import { t as m } from './chevron-right-BYoOqPwK.js';
import { n as h, r as g, t as _ } from './blog-DQ8ZM9pB.js';
import { t as v } from './input-D7RkL3Of.js';
import { n as y, r as b, t as x } from './avatar-CXXw4HJO.js';
import { t as S } from './input-error-0fpqe6UA.js';
import { t as C } from './label-Bi32WZ_t.js';
import { t as w } from './spinner-Co1CPAeO.js';
import { t as T } from './blur-fade-BwZlzK6U.js';
import { n as E } from './ContactController-CNo9HCOD.js';
import { t as D } from './badge-BbICtkl5.js';
var O = f(`arrow-up-right`, [
    ...
    j = ({
        ...
        let l = (0, k.useRef)(null),
            d = (0, k.useRef)(null),
            [f, p] = (0, k.useState)(!1),
            [m, h] = (0, k.useState)({ width: 0, height: 0 }),
            [g, _] = (0, k.useState)(`rgb(0, 0, 0)`),
            v = (0, k.useCallback)((e) => {
                if (typeof window > `u`) return `rgb(0, 0, 0)`;
                let t = e || `var(--foreground)`;
                if (t.startsWith(`var(`)) {
                    ...
                    let n = window.getComputedStyle(e).color;
                    return (document.body.removeChild(e), n || `rgb(0, 0, 0)`);
                }
                return t;
            }, []);
        (0, k.useEffect)(() => {
        ...
        let y = (0, k.useMemo)(
                () =>
                    ((e) => {
                        if (typeof window > `u`) return `rgba(0, 0, 0,`;
                        let t = document.createElement(`canvas`);
                        t.width = t.height = 1;
                        let n = t.getContext(`2d`);
                        if (!n) return `rgba(255, 0, 0,`;
                        ((n.fillStyle = e), n.fillRect(0, 0, 1, 1));
                        let [r, i, a] = Array.from(
            ...
            b = (0, k.useCallback)(
                (n, r, i) => {
                    ...
                    ((n.width = r * a),
                        ...
                        (n.style.width = `${r}px`),
                        (n.style.height = `${i}px`));
                    let o = Math.floor(r / (e + t)),
                        c = Math.floor(i / (e + t)),
                        l = new Float32Array(o * c);
                    for (let e = 0; e < l.length; e++) l[e] = Math.random() * s;
                    return { cols: o, rows: c, squares: l, dpr: a };
                },
                [e, t, s],
            ),
            x = (0, k.useCallback)(
                (e, t) => {
                    for (let r = 0; r < e.length; r++)
                        Math.random() < n * t && (e[r] = Math.random() * s);
                },
                [n, s],
            ),
            S = (0, k.useCallback)(
        ...
        return (
            (0, k.useEffect)(() => {
                ...
                let r,
                    o,
                    s = () => {
                        let n = i || t.clientWidth,
                            r = a || t.clientHeight;
                        (h({ width: n, height: r }), (o = b(e, n, r)));
                    };
                s();
                let c = 0,
                    u = (t) => {
                                  ...
                                  (0, A.jsxs)(`div`, {
                                      ...
                                      children: [
                                          ...
                                          (0, A.jsx)(`p`, {
                                              ...
                                              children: `Thoughts on web development, life, and more.`,
                                          }),
                                      ],
                                  }),
                              ],
                                          ...
                                          children: (0, A.jsxs)(`a`, {
                                              ...
                                              children: [
                                                  ...
                                                  (0, A.jsxs)(`div`, {
                                                      ...
                                                      children: [
                                                          (0, A.jsx)(`p`, {
                                                              className: `tracking-tight text-base font-medium`,
                                                              children: (0,
                                                              A.jsxs)(`span`, {
        ...
        children: (0, A.jsx)(T, {
            ...
            children: (0, A.jsxs)(`div`, {
                ...
                children: [
                    ...
                    (0, A.jsx)(`div`, {
                        className: `absolute inset-0 top-0 left-0 right-0 h-1/3 rounded-xl overflow-hidden`,
                        children: (0, A.jsx)(j, {
                        ...
                        children: [
                            (0, A.jsxs)(`div`, {
                                ...
                                children: [
                                    ...
                                    e.email &&
                                        (0, A.jsxs)(`p`, {
                                            className: `mt-2 text-muted-foreground text-balance`,
                                            children: [
                                    ...
                                    !e.email &&
                                        (0, A.jsx)(`p`, {
                                            className: `mt-2 text-muted-foreground text-balance`,
                                            children: `Want to collaborate or just say hi? Fill out the form below.`,
                                        }),
                                ],
                            }),
                            (0, A.jsx)(n, {
...
function re({ name: e, description: t }) {
    return (0, A.jsx)(`section`, {
        id: `hero`,
        className: `w-full`,
        children: (0, A.jsxs)(`div`, {
...
var ie = (e) =>
        (0, A.jsxs)(`svg`, {
            ...
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `Laravel` }),
                (0, A.jsx)(`path`, {
    ...
    L = (e) =>
        (0, A.jsxs)(`svg`, {
            ...
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `TypeScript` }),
                (0, A.jsx)(`path`, {
    ...
    R = (e) =>
        (0, A.jsxs)(`svg`, {
            ...
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `Tailwind CSS` }),
                (0, A.jsx)(`path`, {
    ...
    z = (e) =>
        (0, A.jsxs)(`svg`, {
            ...
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `Python` }),
                (0, A.jsx)(`path`, {
                    fill: `url(#skill-python-a)`,
                    d: `M31.885 16c-8.124 0-7.617 3.523-7.617 3.523l.01 3.65h7.752v1.095H21.197S16 23.678 16 31.876c0 8.196 4.537 7.906 4.537 7.906h2.708v-3.804s-.146-4.537 4.465-4.537h7.688s4.32.07 4.32-4.175v-7.019S40.374 16 31.885 16zm-4.275 2.454a1.394 1.394 0 1 1 0 2.79 1.393 1.393 0 0 1-1.395-1.395c0-.771.624-1.395 1.395-1.395z`,
                }),
                (0, A.jsx)(`path`, {
                    fill: `url(#skill-python-b)`,
    ...
    V = (e) =>
        (0, A.jsxs)(`svg`, {
            ...
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `Data Analysis` }),
                (0, A.jsx)(`line`, { x1: `18`, y1: `20`, x2: `18`, y2: `10` }),
                (0, A.jsx)(`line`, { x1: `12`, y1: `20`, x2: `12`, y2: `4` }),
                (0, A.jsx)(`line`, { x1: `6`, y1: `20`, x2: `6`, y2: `14` }),
                (0, A.jsx)(`line`, { x1: `2`, y1: `20`, x2: `22`, y2: `20` }),
            ],
        }),
    H = (e) =>
        (0, A.jsxs)(`svg`, {
            viewBox: `0 0 24.51 24.51`,
            fill: `currentColor`,
            xmlns: `http://www.w3.org/2000/svg`,
            ...e,
            children: [
                (0, A.jsx)(`title`, { children: `Inertia` }),
                (0, A.jsx)(`path`, {
                    d: `M7.05 5.45H0L6.81 12.26L0 19.07H7.05L13.86 12.26Z`,
                }),
                (0, A.jsx)(`path`, {
                    d: `M17.70 5.45H10.65L17.47 12.26L10.65 19.07H17.70L24.51 12.26Z`,
                }),
            ],
        }),
    U = (e) =>
...
function G({ src: e, title: t }) {
    ...
    return e && !n
        ...
        : (0, A.jsx)(`div`, { className: `w-full h-48 bg-muted` });
}
function K({ project: e }) {
    let t = `${W(e.starting_date)} – ${W(e.ending_date)}`;
    return (0, A.jsxs)(`div`, {
        ...
        children: [
            ...
            (0, A.jsxs)(`div`, {
                ...
                children: [
                    ...
                    e.description &&
                        (0, A.jsx)(`p`, {
                            className: `text-xs flex-1 text-pretty font-sans leading-relaxed text-muted-foreground line-clamp-3`,
                              ...
                              children: [
                                  ...
                                  (0, A.jsxs)(`div`, {
                                      ...
                                      children: [
                                          ...
                                          (0, A.jsx)(`p`, {
                                              className: `text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center`,
                                              children: `A collection of projects I've worked on from ideas to shipped products.`,
                                          }),
                                      ],
                                  }),
                              ],
...
function oe(e) {
    if (e) return J[e.toLowerCase().replace(/[^a-z]/g, ``)];
}
function se({ skills: e }) {
    let t = e.length > 0 ? e : ae;
    return (0, A.jsx)(`section`, {
        id: `skills`,
        className: `w-full`,
        children: (0, A.jsxs)(`div`, {
...
var ce = o,
    Y = k.forwardRef(({ className: e, ...t }, n) =>
        (0, A.jsx)(i, { ref: n, className: u(`border-b`, e), ...t }),
    );
Y.displayName = `AccordionItem`;
var X = k.forwardRef(({ className: e, children: t, ...n }, r) =>
    (0, A.jsx)(c, {
        className: `flex`,
        children: (0, A.jsx)(l, {
            ref: r,
...
var Z = k.forwardRef(({ className: e, children: t, ...n }, r) =>
    (0, A.jsx)(s, {
        ref: r,
                                  ...
                                  return (0, A.jsxs)(
                                      Y,
                                      {
                                          ...
                                          children: [
                                              ...
                                              (0, A.jsx)(Z, {
                                                  className: `p-0 ml-11 md:ml-13 text-xs sm:text-sm text-muted-foreground`,
                                                  children: e.description,
                                              }),
                                          ],
                                      },
...
function ue({
    ...
    if (!e)
        return (0, A.jsxs)(`div`, {
            ...
            children: [
                (0, A.jsx)(`p`, { children: `Portfolio not configured yet.` }),
                s &&
                    (0, A.jsx)(`a`, {
                        href: `/register`,
        ...
        children: [
            ...
            (0, A.jsxs)(`div`, {
                ...
                children: [
                    ...
                    (0, A.jsx)(`div`, {
                        className: `absolute inset-x-0 top-0 h-25 overflow-hidden z-0`,
                        children: (0, A.jsx)(j, {
                            className: `h-full w-full`,
                            squareSize: 2,
                            gridGap: 2,
                    ...
                    (0, A.jsxs)(`main`, {
                        id: `main-content`,
                        className: `relative z-10 mx-auto w-full max-w-2xl px-6 py-12 pb-24 sm:py-24 space-y-14`,
                        children: [
                            (0, A.jsx)(re, {
                                name: e.name,
                                title: e.title,
                            ...
                            (0, A.jsx)($, { works: r }),
                            (0, A.jsx)(te, { education: i }),
                            (0, A.jsx)(se, { skills: a }),
                            (0, A.jsx)(q, { projects: n }),
                            (0, A.jsx)(M, { posts: o }),
                            (0, A.jsx)(N, { setting: e }),
                        ],
                    }),
