...
import { n as t, r as n, t as r } from './vendor-react-gF8_I9RY.js';
function i(e) {
...
function A(e) {
    return a.Buffer !== void 0 && a.Buffer.isBuffer(e);
}
function j(e, t) {
    return M(e, void 0, e, new Map(), t);
}
function M(e, t, n, r = new Map(), i = void 0) {
    let a = i?.(e, t, n, r);
    ...
    if (Array.isArray(e)) {
        ...
        r.set(e, t);
        for (let a = 0; a < e.length; a++) t[a] = M(e[a], a, n, r, i);
        return (
    ...
    if (e instanceof Map) {
        let t = new Map();
        r.set(e, t);
        for (let [a, o] of e) t.set(a, M(o, a, n, r, i));
        return t;
    }
    if (e instanceof Set) {
        let t = new Set();
        r.set(e, t);
        for (let a of e) t.add(M(a, void 0, n, r, i));
        return t;
    }
    ...
    if (e instanceof DataView) {
        ...
        return (r.set(e, t), N(t, e, n, r, i), t);
    }
    ...
    if (typeof e == `object` && le(e)) {
        let t = Object.create(Object.getPrototypeOf(e));
        return (r.set(e, t), N(t, e, n, r, i), t);
    }
    return e;
}
function N(e, t, n = e, r, i) {
    let a = [...Object.keys(t), ...d(t)];
    for (let o = 0; o < a.length; o++) {
        let s = a[o],
            c = Object.getOwnPropertyDescriptor(e, s);
        (c == null || c.writable) && (e[s] = M(t[s], s, n, r, i));
    }
}
function le(e) {
    switch (f(e)) {
...
function P(e) {
    return M(e, void 0, e, new Map(), void 0);
}
function ue(e) {
...
function de(e, t, n) {
    return R(e, t, void 0, void 0, void 0, void 0, n);
}
...
function fe(e, t, n, r) {
    ...
    let i = f(e),
        a = f(t);
    if (
        (i === `[object Arguments]` && (i = w),
        a === `[object Arguments]` && (a = w),
        i !== a)
    )
        return !1;
    switch (i) {
        ...
        switch (i) {
            case b:
                ...
                for (let [i, a] of e.entries())
                    if (!t.has(i) || !R(a, t.get(i), i, e, t, n, r)) return !1;
                return !0;
            case ee: {
                if (e.size !== t.size) return !1;
                ...
                for (let o = 0; o < i.length; o++) {
                    let s = i[o],
                        c = a.findIndex((i) => R(s, i, void 0, e, t, n, r));
                    if (c === -1) return !1;
                    a.splice(c, 1);
                }
                return !0;
            ...
            case ce:
                ...
                for (let i = 0; i < e.length; i++)
                    if (!R(e[i], t[i], i, e, t, n, r)) return !1;
                return !0;
            case C:
                return e.byteLength === t.byteLength
                    ? fe(new Uint8Array(e), new Uint8Array(t), n, r)
                    : !1;
            case te:
                return e.byteLength !== t.byteLength ||
            ...
            case w: {
                if (
                    !(
                        fe(e.constructor, t.constructor, n, r) ||
                        (ue(e) && ue(t))
                    )
                )
                    return !1;
                let i = [...Object.keys(e), ...d(e)],
                    a = [...Object.keys(t), ...d(t)];
...
function ge(e) {
    return e.replace(/[&<>"']/g, (e) => he[e]);
}
function _e(e) {
    return e != null && typeof e != `function` && me(e.length);
}
function ve(e) {
    switch (typeof e) {
        case `number`:
...
function z(e, t, n) {
    ...
    switch (typeof t) {
        case `string`: {
            if (F(t)) return n;
            let r = e[t];
            return r === void 0 ? (ve(t) ? z(e, xe(t), n) : n) : r;
        }
        case `number`:
        case `symbol`: {
            typeof t == `number` && (t = ye(t));
            let r = e[t];
            return r === void 0 ? n : r;
        }
        default: {
            if (Array.isArray(t)) return Se(e, t, n);
            if (((t = Object.is(t?.valueOf(), -0) ? `-0` : String(t)), F(t)))
                return n;
            let r = e[t];
            return r === void 0 ? n : r;
        }
...
function Oe(e) {
    return typeof e == `object` && !!e && f(e) === `[object Arguments]`;
}
function ke(e, t) {
    let n;
    if (
    ...
    for (let e = 0; e < n.length; e++) {
        ...
        if (
            ...
            !((Array.isArray(r) || Oe(r)) && De(t) && t < r.length)
        )
            return !1;
        r = r[t];
    }
...
function Pe(e, t) {
    return Array.isArray(e)
        ? !1
        : typeof e == `number` || typeof e == `boolean` || e == null || i(e)
          ? !0
          : (typeof e == `string` && (Ne.test(e) || !Me.test(e))) ||
            (t != null && Object.hasOwn(t, e));
}
var Fe = (e, t, n) => {
    let r = e[t];
    (!(Object.hasOwn(e, t) && L(r, n)) || (n === void 0 && !(t in e))) &&
        (e[t] = n);
};
function Ie(e, t, n, r) {
    if (e == null && !Ce(e)) return e;
    let i;
    i = Pe(t, e) ? [t] : Array.isArray(t) ? t : xe(t);
    let a = n(z(e, i)),
        o = e;
...
function Le(e, t = 0, n = {}) {
    ...
    let c,
        ...
        d = function (...t) {
            return a != null &&
                (l === null && (l = Date.now()), Date.now() - l >= a)
                ? ((c = e.apply(this, t)),
                  (l = Date.now()),
                  u.cancel(),
                  u.schedule(),
...
function Be(e, t, n, r) {
    if ((c(e) && (e = Object(e)), typeof t != `object` || !t)) return e;
    if (r.has(t)) return u(r.get(t));
    if ((r.set(t, e), Array.isArray(t))) {
        t = t.slice();
        for (let e = 0; e < t.length; e++) t[e] = t[e] ?? void 0;
    }
    let i = [...Object.keys(t), ...d(t)];
    for (let a = 0; a < i.length; a++) {
        let o = i[a];
        if (F(o)) continue;
        let s = t[o],
...
function Ze(e, t = new FormData(), n = null) {
    for (let r in e)
...
function Qe(e, t, n) {
    if (Array.isArray(n)) return n.forEach((n, r) => Qe(e, `${t}[${r}]`, n));
...
function tt(e = {}) {
    ...
    return {
        ...
        async request(e) {
            let t = Ye(e.url, e.baseURL, e.params),
            ...
            let d = [`GET`, `DELETE`].includes(i) ? void 0 : $e(e.data, a);
            ...
            try {
                ...
                r = n.headers.get(`content-type`)?.includes(`application/json`)
                    ? await n.json()
                    : await n.text();
                let o = { status: n.status, data: r, headers: et(n.headers) };
                if (!n.ok) throw new Ge(o);
                return o;
            } catch (e) {
                throw (
                    l && clearTimeout(l),
...
var nt = tt(),
    ...
    at = void 0,
    ot = `same-origin`,
    st = (e) => `${e.method}:${e.baseURL ?? it ?? ``}${e.url}`,
    ct = (e) =>
        e.status === 204 && e.headers[`precognition-success`] === `true`,
    lt = {},
    V = {
        get: (e, t = {}, n = {}) => dt(ut(`get`, e, t, n)),
        post: (e, t = {}, n = {}) => dt(ut(`post`, e, t, n)),
        patch: (e, t = {}, n = {}) => dt(ut(`patch`, e, t, n)),
        put: (e, t = {}, n = {}) => dt(ut(`put`, e, t, n)),
        delete: (e, t = {}, n = {}) => dt(ut(`delete`, e, t, n)),
        useHttpClient(e) {
            return ((rt = e), V);
        },
        withBaseURL(e) {
        ...
        withCredentials(e) {
            return (
                (ot = typeof e == `string` ? e : e ? `include` : `omit`),
                V
            );
        },
        fingerprintRequestsUsing(e) {
            return ((st = e === null ? () => null : e), V);
        },
        determineSuccessUsing(e) {
            return ((ct = e), V);
        },
        withXsrfCookieName(e) {
            return (nt.setXsrfCookieName(e), V);
        },
        withXsrfHeaderName(e) {
            return (nt.setXsrfHeaderName(e), V);
        },
    },
    ut = (e, t, n, r) => ({
        url: t,
        ...
        ...([`get`, `delete`].includes(e)
            ? { params: Ve({}, n, r?.params) }
            : { data: Ve({}, n, r?.data) }),
    }),
    dt = (e = {}) => {
        let t = [ft, mt, ht].reduce((e, t) => t(e), e);
            ...
            : ((t.onStart ?? (() => null))(),
              rt
                  ...
                  .then(
                      ...
                      (e) => {
                          if (_t(e)) return Promise.reject(e);
                          let n = e;
                          return (
                              t.precognitive && gt(n.response),
                              (
                                  vt(t, n.response.status) ??
    ...
    ft = (e) => {
        ...
        return {
            ...e,
            timeout: e.timeout ?? at,
            precognitive: e.precognitive !== !1,
            fingerprint: e.fingerprint === void 0 ? st(e, rt) : e.fingerprint,
            headers: {
                ...e.headers,
    ...
    mt = (e) =>
        typeof e.fingerprint == `string`
            ? (lt[e.fingerprint]?.abort(), delete lt[e.fingerprint], e)
            : e,
    ht = (e) =>
        typeof e.fingerprint != `string` || e.signal || !e.precognitive
            ? e
            : ((lt[e.fingerprint] = new AbortController()),
              { ...e, signal: lt[e.fingerprint].signal }),
    gt = (e) => {
    ...
    _t = (e) => !(e instanceof Ge) || typeof e.response?.status != `number`,
    vt = (e, t) =>
        ({
    ...
    yt = (e) =>
        ...
        e.headers?.[`Content-type`] ??
        e.headers?.[`content-type`] ??
        (We(e.data) ? `multipart/form-data` : `application/json`),
    bt = (e, t) => {
    ...
    St = (e, t) =>
        Object.fromEntries(
            Object.entries(e).filter(([e]) => !t.some((t) => xt(e, t))),
        ),
    Ct = (e, t = {}) => {
        let n = {
                errorsChanged: [],
            ...
            f = (e) => {
                let t = Tt(e);
                return pe(d, t) ? [] : ((d = t), n.errorsChanged);
            },
            p = (e) => {
                let t = { ...d };
                return (delete t[Et(e)], f(t));
            },
                    ...
                    (t) => {
                        e({
                            get: (e, n = {}, r = {}) =>
                                V.get(e, w(n), S(r, t, n)),
                            post: (e, n = {}, r = {}) =>
                                V.post(e, w(n), S(r, t, n)),
                            patch: (e, n = {}, r = {}) =>
                                V.patch(e, w(n), S(r, t, n)),
                            put: (e, n = {}, r = {}) =>
                                V.put(e, w(n), S(r, t, n)),
                            delete: (e, n = {}, r = {}) =>
                                V.delete(e, w(n), S(r, t, n)),
                        }).catch((e) =>
                            e instanceof Ke ||
                            (e instanceof Ge && e.response?.status === 422)
                                ? null
                                : Promise.reject(e),
                        );
                    },
    ...
    Et = (e) => (typeof e == `string` ? e : e.target.name),
    Dt = (e) => {
        let t = { ...e };
        return (
    ...
    Mt = new (class {
        ...
        get(e) {
            return ke(this.config, e) ? z(this.config, e) : z(this.defaults, e);
        }
        set(e, t) {
            typeof e == `string`
                ? B(this.config, e, t)
...
var Pt = (e) => H(`before`, { cancelable: !0, detail: { visit: e } }),
    Ft = (e) => H(`error`, { detail: { errors: e } }),
    It = (e) => H(`networkError`, { cancelable: !0, detail: { error: e } }),
    Lt = (e) => H(`finish`, { detail: { visit: e } }),
    Rt = (e) => H(`httpException`, { cancelable: !0, detail: { response: e } }),
    zt = (e) => H(`beforeUpdate`, { detail: { page: e } }),
    Bt = (e) => H(`navigate`, { detail: { page: e } }),
    Vt = (e) => H(`progress`, { detail: { progress: e } }),
    Ht = (e) => H(`start`, { detail: { visit: e } }),
    Ut = (e) => H(`success`, { detail: { page: e } }),
    Wt = (e, t) =>
        H(`prefetched`, {
            detail: { fetchedAt: Date.now(), response: e, visit: t },
        }),
    Gt = (e) => H(`prefetching`, { detail: { visit: e } }),
    Kt = (e) => H(`flash`, { detail: { flash: e } }),
    U = class {
    ...
    qt = async (e) => {
        ...
        return await Xt(t, n, e);
    },
    Jt = { key: `historyKey`, iv: `historyIv` },
    Yt = async (e) => {
        let t = Qt(),
            n = await nn();
        if (!n) throw Error(`Unable to decrypt history`);
        return await Zt(t, n, e);
    },
    Xt = async (e, t, n) => {
        if (typeof window > `u`) throw Error(`Unable to encrypt history`);
    ...
    Qt = () => {
        ...
        return (U.set(Jt.iv, Array.from(t)), t);
    },
    $t = async () =>
    ...
    en = async (e) => {
        ...
        U.set(Jt.key, Array.from(new Uint8Array(t)));
    },
    tn = async (e) => {
        if (e) return e;
        let t = await $t();
        return t ? (await en(t), t) : null;
    },
    nn = async () => {
        let e = U.get(Jt.key);
        return e
    ...
    an = (e, t, n) => {
        if (e === t) return !0;
        for (let r in e)
            if (!n.includes(r) && e[r] !== t[r] && !on(e[r], t[r])) return !1;
    ...
    ln = new (class {
            ...
            let [a, o] = this.extractStaleValues(n),
                s = new Promise((n, r) => {
                    t({
                        ...
                        onPrefetchError(t) {
                            (ln.removeFromInFlight(e), r(t));
                        },
                    });
                }).then((t) => {
                    this.remove(e);
                    let n = t.getPageResponse();
                    (G.mergeOncePropsIntoResponse(n),
                        this.cached.push({
                            params: { ...e },
        ...
        updateCachedOncePropsFromCurrentPage() {
            this.cached.forEach((e) => {
                e.response.then((t) => {
                    let n = t.getPageResponse();
                    G.mergeOncePropsIntoResponse(n, { force: !0 });
                    for (let [e, t] of Object.entries(n.deferredProps ?? {})) {
                        let r = t.filter((e) => z(n.props, e) === void 0);
                        r.length > 0
                            ? (n.deferredProps[e] = r)
    ...
    hn = typeof window > `u`,
    gn = !hn && /Firefox/i.test(window.navigator.userAgent),
    W = class {
        static save() {
        ...
        static reset() {
            ((!hn && window.location.hash) || this.scrollToTop(),
        ...
        static scrollToAnchor() {
            let e = hn ? null : window.location.hash;
            e &&
                setTimeout(() => {
...
function vn(e) {
    return (
        _n(e) ||
        (e instanceof FormData && Array.from(e.values()).some((e) => vn(e))) ||
        (typeof e == `object` && !!e && Object.values(e).some((e) => vn(e)))
    );
}
var yn = (e) => e instanceof FormData;
function bn(e, t = new FormData(), n = null, r = `brackets`) {
    e ||= {};
    for (let i in e)
        Object.prototype.hasOwnProperty.call(e, i) &&
            Sn(t, xn(n, i, `indices`), e[i], r);
    return t;
}
function xn(e, t, n) {
...
function Tn(e, t) {
    let n = [];
    return (An(e, ``, n, t), n.length ? `?` + n.join(`&`) : ``);
}
function En(e) {
    let t = e.indexOf(`=`);
...
var Mn = (e, t, n, r, i) => {
    let a = typeof e == `string` ? jn(e) : e;
    if (
        ((vn(t) || r) &&
            !yn(t) &&
            (Mt.get(`form.forceIndicesArrayFormatInFormData`) &&
                (i = `indices`),
            (t = bn(t, new FormData(), null, i))),
        yn(t))
    )
        return [a, t];
    let [o, s] = Nn(n, a, t, i);
...
function Nn(e, t, n, r = `brackets`) {
    let i = e === `get` && !yn(n) && Object.keys(n).length > 0,
        a = Bn(t.toString()),
    ...
    if (i) {
        let e = Cn(d) ? `indices` : r;
        d.search = Tn({ ...wn(d.search), ...n }, e);
    }
    return [
        [
            a ? `${d.protocol}//${d.host}` : ``,
...
var Fn = (e, t) => {
        e.hash && !t.hash && Pn(e).href === t.href && (t.hash = e.hash);
    },
    In = (e, t) => Pn(e).href === Pn(t).href,
    Ln = (e, t) => e.origin === t.origin && e.pathname === t.pathname;
function Rn(e) {
    return (
        typeof e == `object` &&
        !!e &&
...
var G = new (class {
            ...
            return (
                ...
                this.resolve(e.component, e).then((o) => {
                    ...
                    let s = typeof window > `u`,
                        ...
                        l = !s && n ? W.getScrollRegions() : [];
                    t ||= In(jn(e.url), c);
                    let u = { ...e, flash: {} };
                    return new Promise((e) =>
                        t ? K.replaceState(u, e) : K.pushState(u, e),
                    ).then(() => {
                        ...
                        if (
                            ...
                            (this.cleared = !1),
                            this.hasOnceProps() &&
                                ln.updateCachedOncePropsFromCurrentPage(),
        ...
        mergeOncePropsIntoResponse(e, { force: t = !1 } = {}) {
            Object.entries(e.onceProps ?? {}).forEach(([n, r]) => {
                ...
                i !== void 0 &&
                    (t || z(e.props, r.prop) === void 0) &&
                    (B(e.props, r.prop, z(this.page.props, i.prop)),
    ...
    Un = typeof window > `u`,
    Wn = new Hn(),
    Gn = !Un && /CriOS/.test(window.navigator.userAgent),
    Kn = class {
        ...
        decrypt(e = null) {
            if (Un) return Promise.resolve(e ?? G.get());
        ...
        decryptPageData(e) {
            return e instanceof ArrayBuffer ? Yt(e) : Promise.resolve(e);
        }
        ...
        saveDocumentScrollPosition(e) {
            Wn.add(() =>
                Promise.resolve().then(() => {
                    if (
                        window.history.state?.page &&
                        !pe(this.getDocumentScrollPosition(), e)
                    )
                        return this.doReplaceState({
                            page: window.history.state.page,
        ...
        doPushState(e, t) {
            return this.withThrottleProtection(() => {
                try {
                    ...
                    qn.fireInternalEvent(`historyQuotaExceeded`, t);
                }
            });
        }
        getState(e, t) {
        ...
        browserHasHistoryEntry() {
            return !Un && !!window.history.state?.page;
        }
        clear() {
            (U.remove(Jt.key), U.remove(Jt.iv));
        }
        setCurrent(e) {
            this.current = e;
        }
...
var K = new Kn(),
    qn = new (class {
        ...
        init() {
            (typeof window < `u` &&
                ...
                window.addEventListener(
                    `scroll`,
                    Nt(W.onWindowScroll.bind(W), 100),
                    !0,
                )),
                typeof document < `u` &&
                    document.addEventListener(
                        `scroll`,
                        Nt(W.onScroll.bind(W), 100),
                        !0,
                    ));
        }
        onGlobalEvent(e, t) {
        ...
        handlePopstateEvent(e) {
            ...
            if (t === null) {
                ...
                ((e.hash = window.location.hash),
                    K.replaceState({ ...G.getWithoutFlashData(), url: e.href }),
                    W.reset());
                return;
            }
            ...
            K.decrypt(t.page)
                .then((e) => {
                    if (G.get().version !== e.version) {
                        this.onMissingHistoryItem();
                        return;
                    }
                    (Q.cancelAll({ prefetch: !1 }),
                        G.setQuietly(e, { preserveState: !1 }).then(() => {
                            (W.restore(K.getScrollRegions()), Bt(G.get()));
                            let t = {},
                                n = G.get().props;
                            for (let [r, i] of Object.entries(
                                e.initialDeferredProps ?? e.deferredProps ?? {},
                            )) {
                                let e = i.filter((e) => z(n, e) === void 0);
                                e.length > 0 && (t[r] = e);
                            }
    ...
    Yn = class {
        ...
        static handleBackForward() {
            if (!Jn.isBackForward() || !K.browserHasHistoryEntry()) return !1;
                ...
                K.decrypt()
                    .then((t) => {
                        G.set(t, {
                            ...
                            (W.restore(e), Bt(G.get()));
                        });
                    })
                    .catch(() => {
                        qn.onMissingHistoryItem();
                    }),
                !0
            );
        }
        static handleLocation() {
            if (!U.exists(U.locationVisitKey)) return !1;
            let e = U.get(U.locationVisitKey) || {};
            return (
                U.remove(U.locationVisitKey),
                typeof window < `u` && G.setUrlHash(window.location.hash),
                K.decrypt(G.get())
                    .then(() => {
                        let t = K.getState(K.rememberedState, {}),
                            n = K.getScrollRegions();
                        (G.remember(t),
                            G.set(G.get(), {
                                preserveScroll: e.preserveScroll,
                                preserveState: !0,
                            }).then(() => {
                                (e.preserveScroll && W.restore(n),
        ...
        static fireInitialEvents() {
            let e = G.get();
            (Bt(e),
                Object.keys(e.flash).length > 0 &&
                    queueMicrotask(() => Kt(e.flash)));
        }
    },
    Xn = class {
        id = null;
...
var or = class {
        ...
        async request(e) {
            let t = await q.processRequest(e);
            try {
                let e = await this.doRequest(t);
                return await q.processResponse(e);
            } catch (e) {
                throw (
                    (e instanceof $n || e instanceof tr || e instanceof er) &&
                        (await q.processError(e)),
                    e
                );
            }
        }
        doRequest(e) {
            return new Promise((t, n) => {
                ...
                (e.data !== null &&
                    ...
                    (r.onabort = () =>
                        n(new er(`Request was cancelled`, e.url))),
                    (r.onerror = () => n(new tr(`Network error`, e.url))),
                    (r.onload = () => {
                        let i = {
                            status: r.status,
                            data: r.responseText,
...
var lr = {
        ...
        setClient(e) {
            ...
            ((sr = new or(e)),
                e.xsrfCookieName && V.withXsrfCookieName(e.xsrfCookieName),
                e.xsrfHeaderName && V.withXsrfHeaderName(e.xsrfHeaderName));
        },
        onRequest: q.onRequest.bind(q),
        onResponse: q.onResponse.bind(q),
        onError: q.onError.bind(q),
        processRequest: q.processRequest.bind(q),
        processResponse: q.processResponse.bind(q),
        processError: q.processError.bind(q),
    },
    ur = class e {
        callbacks = [];
        params;
        ...
        headers() {
            ...
            this.isPartial() &&
                (e[`X-Inertia-Partial-Component`] = G.get().component);
    ...
    fr = (e, t) => e === t || e.startsWith(`${t}.`),
    pr = (e, t) => {
        let { only: n, except: r } = e;
        return !(
            (n.length === 0 && r.length === 0) ||
            (n.length > 0 && !n.some((e) => fr(t, e))) ||
            (r.length > 0 && r.some((e) => fr(t, e)))
        );
    },
    mr = (e, t) => t.some((t) => pr(e, t)),
    hr = new Hn(),
    gr = class e {
        constructor(e, t, n) {
        ...
        async handlePrefetch() {
            In(this.requestParams.all().url, window.location) && this.handle();
        }
        async handle() {
            return hr.add(() => this.process());
        }
        async process() {
            if (this.requestParams.all().prefetch)
                return (
                    ...
                    Wt(this.response, this.requestParams.all()),
                    Promise.resolve()
                );
            if (
            ...
            Object.keys(e).length > 0 &&
                ...
                (Kt(e), this.requestParams.all().onFlash(e));
            let t = G.get().props.errors || {};
            if (Object.keys(t).length > 0) {
                let e = this.getScopedErrors(t);
                return (Ft(e), this.requestParams.all().onError(e));
            }
            (Q.flushByCacheTags(
                this.requestParams.all().invalidateCacheTags || [],
            ),
                this.wasPrefetched || Q.flush(G.get().url),
                Ut(G.get()),
        ...
        async handleNonInertiaResponse() {
            if (this.isInertiaRedirect()) {
                Q.visit(this.getHeader(`x-inertia-redirect`), {
            ...
            if (this.isLocationVisit()) {
                let e = jn(this.getHeader(`x-inertia-location`));
                return (
                    Fn(this.requestParams.all().url, e),
            ...
            if (this.requestParams.all().onHttpException(e) !== !1 && Rt(e))
                return dr.show(e.data);
        }
        isInertiaResponse() {
        ...
        async setPage() {
            ...
            return this.shouldSetPage(e)
                ? (this.mergeProps(e),
                  G.mergeOncePropsIntoResponse(e),
                  ...
                  (e.url = K.preserveUrl ? G.get().url : this.pageUrl(e)),
        ...
        shouldSetPage(e) {
            ...
            let t = jn(this.originatingPage.url),
                n = jn(G.get().url);
        ...
        pageUrl(e) {
            ...
            return (
                e.preserveFragment
                    ...
                    : Fn(this.requestParams.all().url, t),
                t.pathname + t.search + t.hash
            );
        }
        preserveOptimisticProps(e) {
            if (Q.hasPendingOptimistic())
                for (let t of Object.keys(e.props))
                    G.hasBaseline(t) &&
                        (G.updateBaseline(t, e.props[t]),
                        (e.props[t] = G.get().props[t]));
        }
        preserveEqualProps(e) {
            if (e.component !== G.get().component) return;
            let t = G.get().props;
            Object.entries(e.props).forEach(([n, r]) => {
                pe(r, t[n]) && (e.props[n] = t[n]);
            });
        }
        mergeProps(e) {
            if (
                !this.requestParams.isPartial() ||
                e.component !== G.get().component
            )
                return;
            let t = e.mergeProps || [],
                n = e.prependProps || [],
            ...
            ((e.props = { ...G.get().props, ...e.props }),
                this.shouldPreserveErrors(e) &&
                    (e.props.errors = G.get().props.errors),
                G.get().scrollProps &&
                    (e.scrollProps = {
                        ...(G.get().scrollProps || {}),
                        ...(e.scrollProps || {}),
                ...
                this.requestParams.isDeferredPropsRequest() &&
                    (e.flash = { ...G.get().flash }));
            let s = G.get().initialDeferredProps;
            (s && Object.keys(s).length > 0 && (e.initialDeferredProps = s),
                (e.rescuedProps = this.mergeRescuedProps(e)));
        }
        mergeRescuedProps(e) {
            let t = G.get().rescuedProps ?? [],
                n = e.rescuedProps ?? [],
                r = new Set(t.filter((e) => !pr(this.requestParams.all(), e)));
    ...
    _r = class e {
        constructor(e, t, { optimistic: n = !1 } = {}) {
            ((this.page = t),
                (this.requestParams = ur.create(e)),
        ...
        async send() {
            ...
            return lr
                ...
                .request({
                    ...
                    url: Pn(this.requestParams.all().url).href,
        ...
        onProgress(e) {
            this.requestParams.data() instanceof FormData &&
                (Vt(e), this.requestParams.all().onProgress(e));
        }
        getHeaders() {
            let e = {
    ...
    J = () => {},
    yr = class {
        syncRequestStream = new vr({ maxConcurrent: 1, interruptible: !0 });
        asyncRequestStream = new vr({
            maxConcurrent: 1 / 0,
            interruptible: !1,
        });
        clientVisitQueue = new Hn();
        ...
        init({
            ...
            (G.init({
                ...
                qn.on(`loadDeferredProps`, (e) => {
                    this.loadDeferredProps(e);
                }),
                qn.on(`historyQuotaExceeded`, (e) => {
        ...
        on(e, t) {
            return typeof window > `u` ? () => {} : qn.onGlobalEvent(e, t);
        }
        hasPendingOptimistic() {
        ...
        poll(e, t = {}, n = {}) {
            return Zn.add(e, () => this.reload({ preserveErrors: !0, ...t }), {
        ...
        visit(e, t = {}) {
            ...
            ((n.only.length > 0 || n.except.length > 0 || n.reset.length > 0
                ...
                !G.isCleared() && !n.preserveUrl && W.save());
            let a = { ...n, ...r },
                o = () => {
                    let e = ln.get(a);
                    e
                        ? (bi.reveal(e.inFlight), ln.use(e, a))
                        : (bi.reveal(!0),
                          (n.async
        ...
        getCached(e, t = {}) {
            return ln.findCached(this.getPrefetchParams(e, t));
        }
        flush(e, t = {}) {
            ln.remove(this.getPrefetchParams(e, t));
        }
        flushAll() {
            ln.removeAll();
        }
        flushByCacheTags(e) {
            ln.removeByTags(Array.isArray(e) ? e : [e]);
        }
        getPrefetching(e, t = {}) {
            return ln.findInFlight(this.getPrefetchParams(e, t));
        }
        prefetch(e, t = {}, n = {}) {
            if ((t.method ?? (Rn(e) ? e.method : `get`)) !== `get`)
            ...
            if (i.onBefore(r) === !1 || !Pt(r)) return;
            (bi.hide(), this.asyncRequestStream.interruptInFlight());
            let a = { ...r, ...i };
            new Promise((e) => {
                let t = () => {
                    G.get() ? e() : setTimeout(t, 50);
                };
                t();
            }).then(() => {
                ln.add(
                    a,
                    (e) => {
                        this.asyncRequestStream.send(_r.create(e, G.get()));
                    },
                    {
        ...
        replaceProp(e, t, n) {
            this.replace({
                ...
                preserveState: !0,
                props(n) {
                    let r = typeof t == `function` ? t(z(n, e), n) : t;
                    return B(P(n), e, r);
                },
                ...(n || {}),
            });
        ...
        flash(e, t) {
            ...
            (G.setFlash(r), Object.keys(r).length && Kt(r));
        }
        ...
        performClientVisit(e, { replace: t = !1 } = {}) {
            let n = G.get(),
                ...
                p = ur.resolvePreserveOption(e.preserveScroll ?? !1, f),
                m = ur.resolvePreserveOption(e.preserveState ?? !1, f);
            return G.set(f, {
                replace: t,
                preserveScroll: p,
                preserveState: m,
                ...
                .then(() => {
                    let t = G.get().flash;
                    Object.keys(t).length > 0 && (Kt(t), l?.(t));
                    let n = G.get().props.errors || {};
        ...
        performInstantSwap(e) {
            ...
            return G.set(a, {
                replace: e.replace,
                preserveScroll: ur.resolvePreserveOption(e.preserveScroll, a),
                preserveState: !1,
        ...
        applyOptimisticUpdate(e, t) {
            ...
            if (!r) return;
            let i = [];
            for (let e of Object.keys(r)) pe(n[e], r[e]) || i.push(e);
            if (i.length === 0) return;
            let a = G.nextOptimisticId(),
                o = G.get().component;
            for (let e of i) G.setBaseline(e, P(n[e]));
            (G.registerOptimistic(a, e), G.setPropsQuietly({ ...n, ...r }));
            let s = !0,
                c = t.onSuccess;
            t.onSuccess = (e) => ((s = !1), c(e));
            let l = t.onFinish;
            t.onFinish = (e) => {
                if ((G.unregisterOptimistic(a), s && G.get().component === o)) {
                    let e = G.replayOptimistics();
                    Object.keys(e).length > 0 &&
                        G.setPropsQuietly({ ...G.get().props, ...e });
                }
                return (
                    G.pendingOptimisticCount() === 0 &&
                        G.clearOptimisticState(),
                    l(e)
                );
            };
        }
...
function Tr(e) {
    ...
    if (typeof e != `object` || !e || _n(e)) return e;
    if (wr(e)) {
        let t = [];
        for (let n = 0; n < Object.keys(e).length; n++) t[n] = Tr(e[n]);
        return t;
    }
    let t = {};
...
function Er(e) {
    ...
    for (let [n, r] of e.entries()) {
        ...
        if (e[e.length - 1] === ``) {
            ...
            else if (i && typeof i == `object` && !_n(i)) {
                let e = Object.keys(i)
                    .filter((e) => /^\d+$/.test(e))
                    .map(Number)
                    .sort((e, t) => e - t);
                B(t, n, e.length > 0 ? [...e.map((e) => i[e]), r] : [r]);
            } else B(t, n, [r]);
            continue;
        }
        Cr(t, e.map(String), r);
            ...
            i = Object.values(r)
                ...
                .reduce((e, n) => {
                    ...
                    if (n.indexOf(`<title `) === 0) {
                        ...
                        return (
                            (e.title = r ? `${r[1]}${t(r[2])}${r[3]}` : n),
                            e
                        );
                    }
                    let r = n.match(/ data-inertia="[^"]+"/);
                    return (
                        r ? (e[r[0]] = n) : (e[Object.keys(e).length] = n),
                        e
                    );
                }, n);
...
var kr = `X-Inertia-Infinite-Scroll-Merge-Intent`,
    Ar = (e) => {
        let t = () => {
                let t = G.get().scrollProps?.[e.getPropName()];
                if (t) return t;
                throw Error(
                ...
                n.loading ||
                    ...
                    Q.reload({
                        ...
                        onFinish: (i) => {
                            ((n.loading = !1),
                                t === `next`
                                    ? e.onCompleteNextRequest(n.lastLoadedPage)
                                    : e.onCompletePreviousRequest(
                                          n.lastLoadedPage,
                                      ),
                                r.onFinish?.(i));
                        },
    ...
    Mr = `infiniteScrollPage`,
    Nr = `infiniteScrollIgnore`,
    Pr = (e) => e.dataset[Mr],
    Fr = (e) => {
        let t = jr(),
            n,
            ...
            f = new Set(),
            p = (e) => !(Mr in e.dataset) && !(Nr in e.dataset),
            m = () => {
                (Array.from(f).forEach((e) => {
                    (p(e) && (e.dataset[Nr] = `true`), n.observe(e));
                }),
                    f.clear());
            },
            h = (e) =>
        ...
        let t = !0,
            n = (n) => {
                Ir.add(
                    () =>
                        new Promise((r) => {
                            if (!t) return ((Lr = Rr = null), r());
                            if (!Lr || !Rr) {
                                let e = G.get().url;
                                ((Lr = jn(e)), (Rr = jn(e)), (zr = Bn(e)));
                            }
                            let i = e.getPageName(),
                                a = Rr.searchParams;
...
function Hr(e) {
    let t = Br({ ...e, getPageName: () => i.getPageName() }),
        n = Vr(e),
        r = Fr({
            ...e,
        ...
        i = Ar({
            ...
            onCompletePreviousRequest: (t) => {
                (e.onCompletePreviousRequest(),
                    pn(() => r.processServerLoadedElements(t), 2));
            },
            onCompleteNextRequest: (t) => {
                (e.onCompleteNextRequest(),
                    pn(() => r.processServerLoadedElements(t), 2));
            },
    ...
    let c = Q.on(`success`, () => pn(r.refreshTriggers, 2));
    return {
        dataManager: i,
        elementManager: r,
        flush: () => {
...
function Gr(e) {
    return Wr(e) && `component` in e;
}
function Kr(e, t) {
    return `component` in e && t(e.component);
}
function qr(e, t) {
    return !Wr(e) || t(e) || Kr(e, t)
        ? !1
...
function Jr(e, t) {
    return Wr(e) && !t(e) && !Kr(e, t) && !qr(e, t);
}
function Yr(e, t) {
    if (Jr(e, t)) return !0;
    if (!Wr(e) || t(e) || Kr(e, t)) return !1;
    let n = Object.values(e);
    return n.length > 0 && n.every((e) => typeof e == `function`);
}
function Xr(e, t) {
    return (
        Array.isArray(e) && e.length === 2 && t(e[0]) && Wr(e[1]) && !t(e[1])
    );
}
function Zr(e, t) {
    if (Array.isArray(e) && t(e[0]))
        return { component: e[0], props: e[1] ?? {} };
    if (Gr(e) && t(e.component))
...
function Qr(e, t, n) {
    return !e || (n && n(e))
        ? []
        : qr(e, t)
          ? Object.entries(e).map(([e, n]) => ({ ...Zr(n, t), name: e }))
          : Xr(e, t)
...
function ti(e) {
    ...
    return !$r(e) && (e.key === `Enter` || (t && e.key === ` `));
}
var Y = `nprogress`,
    ni,
    X,
    ...
    ai = (e) => {
        (Object.assign(Z, e),
            (ni = Z.popover ?? `popover` in HTMLElement.prototype),
            Z.includeCSS && vi(Z.color),
            (X = document.createElement(`div`)),
            (X.id = Y),
            (X.innerHTML = Z.template),
            ni && (X.popover = `manual`));
    },
    oi = (e) => {
        let t = si();
        ((e = hi(e, Z.minimum, 1)), (ri = e === 1 ? null : e));
        let n = di(!t),
            r = n.querySelector(Z.barSelector),
            i = Z.speed,
            a = Z.easing;
        (n.offsetWidth,
            _i((t) => {
                let o = {
                    ...
                    transform: `translate3d(${gi(e)}%,0,0)`,
                };
    ...
    li = (e) => {
        (!e && !ri) || (ui(0.3 + 0.5 * Math.random()), oi(1));
    },
    ui = (e) => {
        let t = ri;
        if (t === null) return ci();
    ...
    di = (e) => {
        if (mi()) return document.getElementById(Y);
        document.documentElement.classList.add(`${Y}-busy`);
        let t = X.querySelector(Z.barSelector),
            n = e ? `-100` : gi(ri || 0);
        if (
            ((t.style.transition = `all 0 linear`),
            (t.style.transform = `translate3d(${n}%,0,0)`),
            Z.showSpinner || X.querySelector(Z.spinnerSelector)?.remove(),
            ni)
        )
            (document.body.appendChild(X), ii || X.showPopover());
        else {
            let e = fi();
            (e !== document.body && e.classList.add(`${Y}-custom-parent`),
                e.appendChild(X),
                ii && (X.style.display = `none`));
        }
        return X;
    },
    fi = () => document.querySelector(Z.parent),
    pi = () => {
        if (
            (document.documentElement.classList.remove(`${Y}-busy`),
            ni && X?.isConnected)
        )
            try {
                X.hidePopover();
            } catch {}
        (ni || fi().classList.remove(`${Y}-custom-parent`), X?.remove());
    },
    mi = () => document.getElementById(Y) !== null;
function hi(e, t, n) {
    ...
    bi = new (class {
        ...
        reveal(e = !1) {
            ((this.hideCount = Math.max(0, this.hideCount - 1)),
                (e || this.hideCount === 0) && yi.show());
        }
        hide() {
            (this.hideCount++, yi.hide());
        }
        set(e) {
            yi.set(Math.max(0, Math.min(1, e)));
        }
        finish() {
            yi.done();
        }
...
function xi(e) {
    (document.addEventListener(`inertia:start`, (t) => Si(t, e)),
        document.addEventListener(`inertia:progress`, Ci));
}
function Si(e, t) {
    e.detail.visit.showProgress || bi.hide();
    let n = setTimeout(() => bi.start(), t);
    document.addEventListener(`inertia:finish`, (e) => wi(e, n), { once: !0 });
}
function Ci(e) {
    bi.isStarted() &&
        ...
        bi.isStarted() &&
            (e.detail.visit.completed
                ...
                : e.detail.visit.interrupted
                  ? bi.reset()
                  : e.detail.visit.cancelled && bi.remove()));
}
function Ti({
    delay: e = 250,
    color: t = `#29d`,
    ...
    (xi(e),
        yi.configure({ showSpinner: r, includeCSS: n, color: t, popover: i }));
}
var Ei = Symbol(`FormComponentReset`);
function Di(e) {
    return (
...
function Ai(e, t) {
    ...
    if (e instanceof HTMLInputElement) return Oi(e, t);
...
var Q = new yr(),
    ...
    Pi = e(t(), 1),
    Fi = r(),
    Ii = (0, $.createContext)(null);
Ii.displayName = `InertiaHeadContext`;
var Li = Ii,
    Ri = Ur();
function zi(e, t) {
    typeof e == `string` ? Ri.setFor(e, t) : Ri.set(e);
}
function Bi() {
    Ri.reset();
}
var Vi = (0, $.createContext)(null);
Vi.displayName = `InertiaPageContext`;
var Hi = Vi;
function Ui(e) {
    return (
        typeof e == `function` ||
...
function Xi({
    ...
    let [s, c] = (0, $.useState)({
        ...
        l = (0, $.useMemo)(
            () => Or(typeof window > `u`, i || ((e) => e), a || (() => {})),
            [],
        ),
        u = (0, $.useSyncExternalStore)(Ri.subscribe, Ri.get, () => Yi);
    if (
        ((qi ||=
            (Q.init({
                initialPage: t,
                resolveComponent: r,
                swapComponent: async (e) => Ji(e),
                onFlash: (e) => {
                    c((t) => ({ ...t, page: { ...t.page, flash: e } }));
                },
            }),
            !0)),
        (0, $.useEffect)(() => {
            ((Ji = async ({ component: e, page: t, preserveState: n }) => {
                if (Ki) {
                    Ki = !1;
                    return;
                }
        ...
        return (0, $.createElement)(
            Li.Provider,
            { value: l },
            (0, $.createElement)(Hi.Provider, { value: s.page }, null),
        );
    let d =
        e ||
        (({ Component: e, props: t, key: n }) => {
            let r = (0, $.createElement)(e, { key: n, ...t }),
                i,
                a = null,
                c = e.layout;
            if (Gi(c)) {
                let e = c(t);
                if ((0, $.isValidElement)(e)) return c(r);
                Yr(e, Ui)
                    ? ((i = o?.(s.page.component, s.page)), (a = e))
                    : (i = e);
            } else
                Jr(c, Ui)
                    ? ((i = o?.(s.page.component, s.page)), (a = c))
                    : (i = c ?? o?.(s.page.component, s.page));
            let l = Qr(i, Ui, c && !a ? Wi : void 0);
            return (
                a &&
    ...
    return (0, $.createElement)(
        ...
        (0, $.createElement)(
            Hi.Provider,
            { value: s.page },
            d({ Component: s.component, key: s.key, props: s.page.props }),
        ),
    );
}
Xi.displayName = `Inertia`;
async function Zi({
    id: e = `app`,
    resolve: t,
    setup: n,
    ...
    (_a.replace(s), c && _a.set(`nonce`, c), l && lr.setClient(l));
    let p = typeof window > `u`,
        m = (e) => (d ? (0, $.createElement)($.StrictMode, null, e) : e),
    ...
    if (p && !a && !o)
        return async (t, i) => {
            let a = [],
                ...
                s;
            n
                ? (s = n({ el: null, App: Xi, props: o }))
                : ((s = m((0, $.createElement)(Xi, o))),
                  f && (s = f(s, { ssr: !0 })));
            let c = Ni(e, t, i(s));
    ...
    let g = a || mn(e),
        ...
        v = await Promise.all([
            ...
            let i = {
                ...
                resolveComponent: h,
                titleCallback: r,
                onHeadUpdate: p ? (e) => (_ = e) : void 0,
                defaultLayout: u,
            };
            if (p) return n({ el: null, App: Xi, props: i });
            let a = document.getElementById(e);
            if (n) return n({ el: a, App: Xi, props: i });
            let o = m((0, $.createElement)(Xi, i));
            (f && (o = f(o, { ssr: !1 })),
                a.hasAttribute(`data-server-rendered`)
                    ? (0, Fi.hydrateRoot)(a, o)
                    : (0, Fi.createRoot)(a).render(o));
        });
    if ((!p && i && Ti(i), p && o && v)) {
        let t = Ni(e, g, o(v));
...
var $i = ({ children: e, data: t, rescue: n, fallback: r }) => {
    if (!t)
        throw Error(
            '`<Deferred>` requires a `data` prop to be a string or array of strings',
        );
    if (!r) throw Error('`<Deferred>` requires a `fallback` prop');
    let [i, a] = (0, $.useState)(!1),
        o = (0, $.useRef)(new Set()),
        s = Qi(),
        c = s.props,
        l = (0, $.useMemo)(() => (Array.isArray(t) ? t : [t]), [t]),
        u = (0, $.useMemo)(() => new Set(s.rescuedProps), [s.rescuedProps]);
    (0, $.useEffect)(() => {
        let e = Q.on(`start`, (e) => {
                let t = e.detail.visit;
                t.preserveState === !0 &&
                    Ln(t.url, window.location) &&
                    mr(t, l) &&
                    (o.current.add(t), a(!0));
            }),
            t = Q.on(`finish`, (e) => {
                let t = e.detail.visit;
                o.current.has(t) &&
                    (o.current.delete(t), a(o.current.size > 0));
            });
        return () => {
            (e(), t(), o.current.clear());
        };
    }, [l]);
    let d = (0, $.useMemo)(() => l.every((e) => z(c, e) !== void 0), [l, c]),
        f = (0, $.useMemo)(() => l.some((e) => u.has(e)), [l, u]);
    return d && !f
        ? typeof e == `function`
            ? e({ reloading: i })
            : e
...
function ea(e) {
    let { data: t, useDataState: n, useErrorsState: r } = e,
        ...
        o = P(a()),
        s = (0, $.useRef)(!1),
        c = (0, $.useRef)(e.precognitionEndpoint ?? null),
        [l, u] = (0, $.useState)(P(o)),
        [d, f] = n ? n() : (0, $.useState)(P(o)),
        [p, m] = r ? r() : (0, $.useState)({}),
        [h, g] = (0, $.useState)(!1),
        [_, v] = (0, $.useState)(null),
        [y, b] = (0, $.useState)(!1),
        ...
        [ie, D] = (0, $.useState)([]),
        O = (0, $.useRef)(null),
        ae = () => O.current ?? _a.get(`form.withAllErrors`),
        k = (0, $.useRef)(d);
    ((0, $.useEffect)(() => {
        k.current = d;
    }),
    ...
    let oe = (0, $.useCallback)(
        ...
        j = (0, $.useCallback)(
            (e, t) => {
                m((n) => {
                    ...
                    return (T.current?.setErrors(r), r);
                });
            },
            [m],
        ),
                ...
                m((t) => {
                    ...
                    return (
                        T.current &&
                            (e.length === 0
                                ? T.current.setErrors({})
                                : e.forEach(T.current.forgetError)),
                        n
                    );
                });
            },
        ...
        le = (0, $.useCallback)(() => {
            (M(),
                ...
                (S.current = window.setTimeout(() => {
                    s.current && x(!1);
                }, _a.get(`form.recentlySuccessfulDuration`))));
        }, [M, b, x]),
        ue = (0, $.useCallback)(() => {
            (b(!1), x(!1), clearTimeout(S.current));
        }, [b, x]),
        F = (0, $.useCallback)(() => {
            (g(!1), v(null));
        }, [g, v]),
        ...
        L = (e, t) => (t(e), e),
        de = (0, $.useCallback)((e) => ie.includes(e), [ie]),
        R = (0, $.useCallback)((e) => e in p, [p]),
        fe = (0, $.useCallback)(
            (e) => (typeof e == `string` ? E.includes(e) : E.length > 0),
            [E],
        ),
        me = {
            data: d,
        ...
        he = (e, t) => {
            if (
                ...
                T.current.validate(t);
            else {
                let n = Et(e),
                    r = C.current(k.current);
                T.current.validate(n, z(r, n), t);
            }
            return me;
        };
    return (
        (me.withPrecognition = (...e) => {
            if (((c.current = br.createWayfinderCallback(...e)), !T.current)) {
                let e = Ct((e) => {
                ...
                ((T.current = e),
                    e
                        ...
                        .on(`errorsChanged`, () => {
                            (m(ae() ? e.errors() : wt(e.errors())),
                                D(e.valid()));
                        }));
            }
            let t = Object.assign(me, {
                validating: te,
                validator: () => T.current,
                valid: de,
                invalid: R,
                touched: fe,
                withoutFileValidation: () =>
                    L(t, () => T.current?.withoutFileValidation()),
                touch: (e, ...n) => (
                    Array.isArray(e)
                        ? T.current?.touch(e)
                        : typeof e == `string`
                ...
                withAllErrors: () => L(t, () => (O.current = !0)),
                setValidationTimeout: (e) =>
                    L(t, () => T.current?.setTimeout(e)),
                validateFiles: () => L(t, () => T.current?.validateFiles()),
                validate: he,
                setErrors: (e) => L(t, () => me.setError(e)),
                forgetError: (e) => L(t, () => me.clearErrors(Et(e))),
            });
            return t;
        }),
        c.current && me.withPrecognition(c.current),
        {
            form: me,
            setDefaultsState: u,
            transformRef: C,
            ...
            clearErrors: M,
            setError: j,
            defaultsCalledInOnSuccessRef: w,
            resetBeforeSubmit: ue,
            finishProcessing: F,
            withAllErrors: {
                enabled: ae,
                enable: () => {
    ...
    return (
        (0, $.useEffect)(() => {
            ...
            if (e && e.length > 0 && typeof r == `object` && r) {
                let n = { ...r };
                (e.forEach((e) => delete n[e]), Q.remember(n, t));
            } else Q.remember(r, t);
        }, [r, t]),
        [r, i]
    );
...
function na(...e) {
    let {
        ...
        s = (0, $.useRef)(null),
        {
            ...
            data: n,
            precognitionEndpoint: r,
            useDataState: t ? () => ta(i, `${t}:data`, o) : void 0,
            useErrorsState: t ? () => ta({}, `${t}:errors`) : void 0,
        }),
        x = (0, $.useCallback)(
            (...e) => {
                let {
                    ...
                    url: n,
                    options: r,
                } = br.parseSubmitArguments(e, d.current);
                y.current = !1;
                let i = {
                    ...r,
                    onCancelToken: (e) => (
                ...
                t === `delete` ? Q.delete(n, { ...i, data: o }) : Q[t](n, o, i);
            },
            [_, v, u],
        ),
        S = (0, $.useCallback)(() => {
        ...
        C = (0, $.useMemo)(
            () => ({
                ...
                post: (e, t = {}) => x(`post`, e, t),
                put: (e, t = {}) => x(`put`, e, t),
                patch: (e, t = {}) => x(`patch`, e, t),
                delete: (e, t = {}) => x(`delete`, e, t),
            }),
            [x],
        );
    Object.assign(c, {
        ...
        ...C,
        cancel: S,
        dontRemember: (...e) => ((o.current = e), w),
        optimistic: (e) => ((s.current = e), w),
    });
    let w = c,
        T = c.withPrecognition;
    return ((w.withPrecognition = (...e) => (T(...e), w)), d.current, w);
}
var ra = (e) => {
        ...
        (
            {
                ...
                onError: h = ia,
                onCancelToken: g = ia,
                onSubmitComplete: _ = ia,
                disableWhileProcessing: v = !1,
                resetOnError: y = !1,
                resetOnSuccess: b = !1,
                setDefaultsOnSuccess: ee = !1,
                invalidateCacheTags: x = [],
                validateFiles: S = !1,
                validationTimeout: C = 1500,
                withAllErrors: w = null,
                component: T = null,
                instant: te = !1,
                children: ne,
                ...E
            ...
            (S && D.validateFiles(),
                (w ?? Mt.get(`form.withAllErrors`)) && D.withAllErrors(),
                D.transform(ie));
            let O = (0, $.useRef)(void 0),
                ae = (0, $.useMemo)(
                    () => (Rn(e) ? e.method : t.toLowerCase()),
                    [e, t],
                ),
                k = (0, $.useMemo)(
                    () => T || (te && Rn(e) ? zn(e) : null),
                ...
                [oe, se] = (0, $.useState)(!1),
                ce = (0, $.useRef)(new FormData()),
                A = (e) => new FormData(O.current, e),
                j = (e) => Er(A(e)),
                M = (t) => Nn(ae, Rn(e) ? e.url : e, j(t), r),
                N = (e) => {
                    (e.type === `reset` && e.detail?.[Ei] && e.preventDefault(),
                        ra(() =>
                            se(
                                e.type === `reset`
                                    ? !1
                ...
                le = (...e) => (D.clearErrors(...e), D);
            ((0, $.useEffect)(() => {
                ((ce.current = A()), D.setDefaults(j()));
                let e = [`input`, `change`, `reset`];
                return (
                    e.forEach((e) => O.current.addEventListener(e, N)),
                    () => {
                        e.forEach((e) => O.current?.removeEventListener(e, N));
                    }
                );
            }, []),
                (0, $.useEffect)(() => {
                    D.setValidationTimeout(C);
                }, [C]),
                (0, $.useEffect)(() => {
                    S ? D.validateFiles() : D.withoutFileValidation();
                }, [S]));
            let P = (...e) => {
                    (O.current && Mi(O.current, ce.current, e), D.reset(...e));
                },
                ue = (...e) => {
                    (le(...e), P(...e));
                },
                F = (e) => {
                    e && (e === !0 ? P() : e.length > 0 && P(...e));
                },
                I = (e) => {
                    let [t, v] = M(e);
                    if (
                ...
                de = {
                    ...
                    recentlySuccessful: D.recentlySuccessful,
                    isDirty: oe,
                    clearErrors: le,
                    ...
                    invalid: D.invalid,
                    validate: (e, t) =>
                        D.validate(...br.mergeHeadersForValidation(e, t, n)),
                    touch: D.touch,
                    touched: D.touched,
                };
            (0, $.useImperativeHandle)(re, () => de, [D, oe, I]);
            let R = (0, $.createElement)(
                `form`,
                {
                    ...E,
                    ref: O,
                    ...
                    method: ae,
                    onSubmit: (e) => {
                        (e.preventDefault(), I(e.nativeEvent.submitter));
                    },
                    inert: v && D.processing,
                },
                typeof ne == `function` ? ne(de) : ne,
            );
            return (0, $.createElement)(aa.Provider, { value: de }, R);
        },
    );
oa.displayName = `InertiaForm`;
var sa = oa,
    ca = function ({ children: e, title: t }) {
        let n = (0, $.use)(Li),
            r = (0, $.useMemo)(() => n.createProvider(), [n]),
            i = typeof window > `u`;
        (0, $.useEffect)(
            () => (
                r.reconnect(),
        ...
        function d(e) {
            let n = $.Children.toArray(e)
                .filter((e) => e)
                .map((e) => u(e));
            return (
                t &&
                    !n.find((e) => e.startsWith(`<title`)) &&
                    n.push(`<title data-inertia="">${He(t)}</title>`),
                n
            );
        }
        ...
        e
            ? e && typeof e == `object` && `current` in e
                ...
                : typeof e == `string`
                  ...
                  : t
            : t,
    ua = (e, t, n = null) => (e ? (typeof e == `function` ? e(t) : e) : n),
    da = (0, $.forwardRef)(
        (
            {
                data: e,
            ...
            let [b, ee] = (0, $.useState)(null),
                x = (0, $.useCallback)((e) => ee(e), []),
                [S, C] = (0, $.useState)(null),
                w = (0, $.useCallback)((e) => C(e), []),
                [T, te] = (0, $.useState)(null),
                ne = (0, $.useCallback)((e) => te(e), []),
                E = Qi().scrollProps?.[e],
                [re, ie] = (0, $.useState)(!1),
                [D, O] = (0, $.useState)(!1),
                [ae, k] = (0, $.useState)(0),
                [oe, se] = (0, $.useState)(!!E?.previousPage),
                [ce, A] = (0, $.useState)(!!E?.nextPage),
                [j, M] = (0, $.useState)(null),
                [N, le] = (0, $.useState)(null),
                [P, ue] = (0, $.useState)(null);
            ((0, $.useEffect)(() => {
                M(l ? la(l, b) : b);
            }, [l, b]),
                (0, $.useEffect)(() => {
            ...
            let [L, de] = (0, $.useState)(null),
                R = (0, $.useMemo)(() => L?.dataManager, [L]),
                fe = (0, $.useMemo)(() => L?.elementManager, [L]),
                pe = (0, $.useCallback)(() => {
                    F
                        ? F.scrollTo({
                              top: F.scrollHeight,
            ...
            (0, $.useEffect)(() => {
                if (!P) return;
                function t() {
                    (k(n.dataManager.getRequestCount()),
                        se(n.dataManager.hasPrevious()),
                        A(n.dataManager.hasNext()));
                }
                let n = Hr({
                    getPropName: () => e,
                    inReverseMode: () => I.current.reverse,
                    shouldFetchNext: () => !I.current.onlyPrevious,
                    shouldFetchPrevious: () => !I.current.onlyNext,
                    shouldPreserveUrl: () => I.current.preserveUrl,
                    getReloadOptions: () => I.current.params,
                    getTriggerMargin: () => I.current.buffer,
                    getStartElement: () => j,
                    getEndElement: () => N,
                    getItemsElement: () => P,
            ...
            let me = (0, $.useMemo)(() => r || (i > 0 && ae >= i), [r, i, ae]),
                he = (0, $.useMemo)(() => !me, [me]);
            ((0, $.useEffect)(() => {
                he ? fe?.enableTriggers() : fe?.disableTriggers();
            }, [he, g, _, j, N]),
                (0, $.useEffect)(() => {
                    (s === void 0 ? o : s) && pe();
                }, [F]),
                (0, $.useImperativeHandle)(
                    y,
                    () => ({
                        fetchNext: R?.fetchNext || (() => {}),
                        fetchPrevious: R?.fetchPrevious || (() => {}),
                        hasPrevious: R?.hasPrevious || (() => !1),
                        hasNext: R?.hasNext || (() => !1),
                    }),
                    [R],
                ));
            let ge = he && !g,
                ...
                xe = { loading: re || D, loadingPrevious: re, loadingNext: D },
                z = [];
            return (
                l ||
                    z.push(
...
da.displayName = `InertiaInfiniteScroll`;
var fa = () => void 0,
    pa = (0, $.forwardRef)(
        (
            {
            ...
            let [ae, k] = (0, $.useState)(0),
                oe = (0, $.useRef)(void 0),
                se = (0, $.useMemo)(
                    () => (Rn(r) ? r.method : i.toLowerCase()),
                    [r, i],
                ),
                ce = (0, $.useMemo)(
                    () => E || (re && Rn(r) ? zn(r) : null),
                ...
                F = (0, $.useMemo)(
                    () =>
                        T === 0
                            ? ue.length === 1 && ue[0] === `click`
                                ? 0
                                : _a.get(`prefetch.cacheFor`)
                            : T,
                    [T, ue],
                ),
                I = (0, $.useMemo)(
                    () => () => {
                        Q.prefetch(
                            M,
                            { ...le, onPrefetching: S, onPrefetched: C },
                            { cacheFor: F, cacheTags: te },
                        );
                    },
                    [M, le, S, C, F, te],
                );
            ((0, $.useEffect)(
                ...
                (0, $.useEffect)(() => {
                    ue.includes(`mount`) && setTimeout(() => I());
                }, ue));
            let L = {
                    onClick: (e) => {
                        (m(e), ei(e) && (e.preventDefault(), Q.visit(M, P)));
                    },
                },
                de = {
                    onMouseEnter: () => {
                ...
                R = {
                    onMouseDown: (e) => {
                        ei(e) && (e.preventDefault(), I());
                    },
                    onKeyDown: (e) => {
                        ti(e) && (e.preventDefault(), I());
                    },
                    onMouseUp: (e) => {
                        ei(e) && (e.preventDefault(), Q.visit(M, P));
                    },
                    onKeyUp: (e) => {
                        ti(e) && (e.preventDefault(), Q.visit(M, P));
                    },
                    onClick: (e) => {
                        (m(e), ei(e) && e.preventDefault());
                    },
                },
                fe = (0, $.useMemo)(
                    () =>
...
function ha(...e) {
    let {
        ...
        [c, l] = (0, $.useState)(null),
        {
            ...
            clearErrors: y,
            setError: b,
            defaultsCalledInOnSuccessRef: ee,
            resetBeforeSubmit: x,
            finishProcessing: S,
            withAllErrors: C,
        } = ea({
            ...
            async (e, t, n) => {
                if (n.onBefore?.() === !1)
                    return Promise.reject(
                        Error(`Request cancelled by onBefore`),
                    );
                ((ee.current = !1),
                    h.current && x(),
                    (a.current = new AbortController()),
                    n.onCancelToken?.({ cancel: () => a.current?.abort() }),
                    (n.optimistic = n.optimistic ?? s.current ?? void 0),
                    (s.current = null));
                let r;
                if (n.optimistic) {
                    r = P(p.current);
                    let e = n.optimistic(P(r));
                    u.setData((t) => ({ ...t, ...e }));
                }
                (h.current && g(!0), n.onStart?.());
                let i = f.current(p.current),
                    o = vn(i),
                    c = t,
                    m,
                    w;
                if (e === `get`) {
                    ...
                    o
                        ? (m = bn(i))
                        : ((m = JSON.stringify(i)), (w = `application/json`));
                try {
                    let t = await lr.getClient().request({
                            method: e,
                            url: c,
                            data: m,
                            headers: {
                            ...
                            onUploadProgress: (e) => {
                                (h.current && _(e), n.onProgress?.(e));
                            },
                        }),
                        r = t.data ? JSON.parse(t.data) : null;
                    ...
                    throw new $n(`Request failed with status ${t.status}`, t);
                } catch (e) {
                    if ((r && h.current && u.setData(r), e instanceof $n)) {
                        if (e.response.status === 422) {
                            let t = JSON.parse(e.response.data).errors || {},
                                r = C.enabled() ? t : wt(t);
                            (h.current && (y(), b(r)), n.onError?.(r));
                        } else n.onHttpException?.(e.response);
                        throw e;
                    }
                    throw e instanceof er ||
                        (e instanceof Error && e.name === `AbortError`)
                        ? (n.onCancel?.(), new er(`Request was cancelled`, t))
                        : (n.onNetworkError?.(
                              e instanceof Error ? e : Error(`Unknown error`),
                          ),
                          e);
                } finally {
                    (h.current && S(), (a.current = null), n.onFinish?.());
                }
            },
            [y, b],
        ),
        ...
        te = (0, $.useCallback)(
            (...e) => {
                let t = br.parseSubmitArguments(e, m.current);
                return w(t.method, t.url, t.options);
            },
            [w],
        ),
        ne = (0, $.useMemo)(
            () => ({
                get: async (e, t = {}) => w(`get`, e, t),
                post: async (e, t = {}) => w(`post`, e, t),
                put: async (e, t = {}) => w(`put`, e, t),
                patch: async (e, t = {}) => w(`patch`, e, t),
                delete: async (e, t = {}) => w(`delete`, e, t),
            }),
            [w],
        );
    Object.assign(u, {
        ...
        ...ne,
        cancel: T,
        dontRemember: (...e) => ((o.current = e), E),
        optimistic: (e) => ((s.current = e), E),
        withAllErrors: () => (C.enable(), E),
    });
    let E = u,
        re = u.withPrecognition;
    return ((E.withPrecognition = (...e) => (re(...e), E)), m.current, E);
}
var ga = ({
    children: e,
    data: t,
    ...
    ((a ??= !1), (i ??= `div`), (o ??= null));
    let s = Qi().props,
        c = (0, $.useMemo)(() => (t ? (Array.isArray(t) ? t : [t]) : []), [t]),
        [l, u] = (0, $.useState)(
            () => c.length > 0 && c.every((e) => z(s, e) !== void 0),
        ),
        [d, f] = (0, $.useState)(!1),
        p = (0, $.useRef)(!1),
        m = (0, $.useRef)(null),
        ...
        g = (0, $.useRef)(() => ({}));
    ((0, $.useEffect)(() => {
        c.length > 0 && u(c.every((e) => z(s, e) !== void 0));
    }, [s, c]),
        (g.current = (0, $.useCallback)(() => {
            let e = { preserveErrors: !0, ...n };
            return (t && (e.only = Array.isArray(t) ? t : [t]), e);
        }, [n, t])));
    let _ = () => {
        (h.current?.disconnect(),
            (h.current = new IntersectionObserver(
                (e) => {
                    if (!e[0].isIntersecting || p.current || (!a && l)) return;
                    ((p.current = !0), f(!0));
                    let t = g.current();
                    Q.reload({
                        ...t,
                        onStart: (e) => {
                            ((p.current = !0), f(!0), t.onStart?.(e));
                        },
                        onFinish: (e) => {
                            (u(!0),
                                (p.current = !1),
    ...
    let v = () => (typeof e == `function` ? e({ fetching: d }) : e);
    return a || !l
        ? (0, $.createElement)(
              i,
              { props: null, ref: m },
              l ? v() : typeof o == `function` ? o() : o,
          )
        : l
          ? v()
          : null;
};
ga.displayName = `InertiaWhenVisible`;
var _a = Mt.extend();
export {
    zi as a,
    Q as c,
