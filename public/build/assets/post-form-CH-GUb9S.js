...
import { et as i, k as a, t as o } from './vendor-radix-C92RFvrB.js';
...
import { a as d, i as f, n as p, r as m, t as h } from './select-Bz4o1eKy.js';
import { t as g } from './minus-syvLFOki.js';
import { t as _ } from './input-D7RkL3Of.js';
import { t as v } from './separator-CPt1Rane.js';
import { t as y } from './input-error-0fpqe6UA.js';
import { t as b } from './label-Bi32WZ_t.js';
import { t as ee } from './spinner-Co1CPAeO.js';
var te = u(`bold`, [
        [
            `path`,
            {
...
function pe(e, t, n) {
    for (let r = 0; ; r++) {
        ...
        if (i.content.size || a.content.size) {
            let e = pe(i.content, a.content, n + 1);
            if (e != null) return e;
        }
        n += i.nodeSize;
    }
    ...
    for (let i = e.childCount, a = t.childCount; ; ) {
        ...
        if (o.isText && o.text != s.text) {
            ...
            for (
                ;
                e < t &&
                o.text[o.text.length - e - 1] == s.text[s.text.length - e - 1];
            )
                (e++, n--, r--);
            return { a: n, b: r };
        }
        if (o.content.size || s.content.size) {
            let e = me(o.content, s.content, n - 1, r - 1);
            if (e) return e;
        }
        ((n -= c), (r -= c));
    }
...
var S = class e {
    ...
    findIndex(e) {
        if (e == 0) return ge(0, e);
        if (e == this.size) return ge(this.content.length, e);
        if (e > this.size || e < 0)
            throw RangeError(`Position ${e} outside of fragment (${this})`);
        for (let t = 0, n = 0; ; t++) {
            let r = this.child(t),
                i = n + r.nodeSize;
            if (i >= e) return i == e ? ge(t + 1, i) : ge(t, n);
            n = i;
        }
    }
    toString() {
...
S.empty = new S([], 0);
var he = { index: 0, offset: 0 };
function ge(e, t) {
    return ((he.index = e), (he.offset = t), he);
}
function _e(e, t) {
    if (e === t) return !0;
    ...
    if (n) {
        ...
        for (let n in e) if (!(n in t) || !_e(e[n], t[n])) return !1;
...
var C = class e {
    ...
    eq(e) {
        return this == e || (this.type == e.type && _e(this.attrs, e.attrs));
    }
    toJSON() {
...
var ve = class extends Error {},
    w = class e {
        ...
        removeBetween(t, n) {
            return new e(
                ye(this.content, t + this.openStart, n + this.openStart),
                this.openStart,
                this.openEnd,
            );
        }
...
function ye(e, t, n) {
    ...
    return e.replaceChild(r, a.copy(ye(a.content, t - i - 1, n - i - 1)));
}
...
function xe(e, t, n) {
    if (n.openStart > e.depth)
        throw new ve(`Inserted content deeper than insertion position`);
    if (e.depth - n.openStart != t.depth - n.openEnd)
        throw new ve(`Inconsistent open depths`);
    return Se(e, t, n, 0);
}
function Se(e, t, n, r) {
    let i = e.index(r),
    ...
    if (i == t.index(r) && r < e.depth - n.openStart) {
    ...
    } else if (!n.content.size) return De(a, ke(e, t, r));
        ...
        let { start: i, end: o } = Ae(n, e);
        return De(a, Oe(e, i, o, t, r));
    }
}
function Ce(e, t) {
    if (!t.type.compatibleContent(e.type))
        throw new ve(`Cannot join ` + t.type.name + ` onto ` + e.type.name);
}
function we(e, t, n) {
    let r = e.node(n);
    return (Ce(r, t.node(n)), r);
}
function Te(e, t) {
    let n = t.length - 1;
...
function Ee(e, t, n, r) {
    ...
    e &&
        ((a = e.index(n)),
        e.depth > n ? a++ : e.textOffset && (Te(e.nodeAfter, r), a++));
    for (let e = a; e < o; e++) Te(i.child(e), r);
    t && t.depth == n && t.textOffset && Te(t.nodeBefore, r);
}
function De(e, t) {
    return (e.type.checkContent(t), e.copy(t));
}
function Oe(e, t, n, r, i) {
    let a = e.depth > i && we(e, t, i + 1),
        o = r.depth > i && we(n, r, i + 1),
        s = [];
    return (
        Ee(null, e, i, s),
        a && o && t.index(i) == n.index(i)
            ? (Ce(a, o), Te(De(a, Oe(e, t, n, r, i + 1)), s))
            : (a && Te(De(a, ke(e, t, i + 1)), s),
              Ee(t, n, i, s),
              o && Te(De(o, ke(n, r, i + 1)), s)),
        Ee(r, null, i, s),
        new S(s)
    );
}
function ke(e, t, n) {
    ...
    return (
        Ee(null, e, n, r),
        e.depth > n && Te(De(we(e, t, n + 1), ke(e, t, n + 1)), r),
        Ee(t, null, n, r),
        new S(r)
    );
}
...
var je = class e {
        ...
        static resolveCached(t, n) {
            ...
            else Pe.set(t, (r = new Me()));
            let i = (r.elts[r.i] = e.resolve(t, n));
            return ((r.i = (r.i + 1) % Ne), i);
        }
    },
    Me = class {
        constructor() {
    ...
    Le = class e {
        ...
        hasMarkup(e, t, n) {
            return (
                this.type == e &&
                _e(this.attrs, t || e.defaultAttrs || Ie) &&
        ...
        replace(e, t, n) {
            return xe(this.resolve(e), this.resolve(t), n);
        }
        nodeAt(e) {
            for (let t = this; ; ) {
...
var Re = class e extends Le {
    ...
    toString() {
        return this.type.spec.toDebugString
            ...
            : ze(this.marks, JSON.stringify(this.text));
    }
    get textContent() {
        return this.text;
    }
...
function qe(e, t) {
    ...
    return (
        i.length == 0 && e.err(`No node type or group '` + t + `' found`),
        i
    );
}
function Je(e) {
...
function Qe(e) {
    ...
    function n(r) {
        ...
        let a = (t[r.join(`,`)] = new Be(r.indexOf(e.length - 1) > -1));
        for (let e = 0; e < i.length; e++) {
            let r = i[e][1].sort(Xe);
...
function rt(e, t) {
    let n = Object.create(null);
    if (t) for (let r in t) n[r] = new ot(e, r, t[r]);
    return n;
}
var it = class e {
    constructor(e, t, n) {
        ((this.name = e),
            ...
            (this.attrs = rt(e, n.attrs)),
            (this.defaultAttrs = et(this.attrs)),
    ...
    computeAttrs(e) {
        return !e && this.defaultAttrs ? this.defaultAttrs : tt(this.attrs, e);
    }
    create(e = null, t, n) {
        if (this.isText)
            throw Error(`NodeType.create can't construct text nodes`);
        return new Le(this, this.computeAttrs(e), S.from(t), C.setFrom(n));
    }
    createChecked(e = null, t, n) {
        return (
            (t = S.from(t)),
            this.checkContent(t),
            new Le(this, this.computeAttrs(e), t, C.setFrom(n))
        );
    }
    createAndFill(e = null, t, n) {
        ...
        return i ? new Le(this, e, t.append(i), C.setFrom(n)) : null;
    }
    validContent(e) {
    ...
    checkAttrs(e) {
        nt(this.attrs, e, `node`, this.name);
    }
    allowsMarkType(e) {
...
var ot = class {
    ...
    st = class e {
        ...
        checkAttrs(e) {
            nt(this.attrs, e, `mark`, this.name);
        }
        excludes(e) {
    ...
    ct = class {
        constructor(e) {
            ...
            ((t.nodes = x.from(e.nodes)),
                ...
                (this.nodes = it.compile(this.spec.nodes, this)),
                (this.marks = st.compile(this.spec.marks, this)));
            let n = Object.create(null);
            ...
            for (let e in this.marks) {
                let t = this.marks[e],
                    n = t.spec.excludes;
                t.excluded =
                    n == null ? [t] : n == `` ? [] : lt(this, n.split(` `));
            }
            ((this.nodeFromJSON = (e) => Le.fromJSON(this, e)),
        ...
        text(e, t) {
            ...
            return new Re(n, n.defaultAttrs, e, C.setFrom(t));
        }
        mark(e, t) {
    ...
    for (let r = 0; r < t.length; r++) {
        ...
        if (a) n.push(a);
            ...
            for (let t in e.marks) {
                ...
                (i == `_` ||
                    (r.spec.group &&
                        r.spec.group.split(` `).indexOf(i) > -1)) &&
                    n.push((o = r));
            }
...
var bt = class {
        constructor(e, t, n, r, i, a) {
            ((this.type = e),
                ...
                (this.match = i || (a & vt ? null : e.contentMatch)));
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return [];
        ...
        finish(e) {
            ...
            return (
                !e &&
                    this.match &&
                    (t = t.append(this.match.fillBefore(S.empty, !0))),
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode &&
                    !pt.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    xt = class {
        constructor(e, t, n) {
            ...
            let r = t.topNode,
                i,
                a = yt(null, t.preserveWhitespace, 0) | (n ? vt : 0);
            ((i = r
                ? new bt(
                      r.type,
                      r.attrs,
                ...
                : n
                  ? new bt(null, null, C.none, !0, null, a)
                  : new bt(e.schema.topNodeType, null, C.none, !0, null, a)),
                (this.nodes = [i]),
        ...
        addTextNode(e, t) {
            let n = e.nodeValue,
                ...
                i =
                    r.options & _t
                        ? `full`
                        : this.localPreserveWS || (r.options & gt) > 0,
...
`,
        ...
        addElement(e, t, n) {
            ...
            let a = e.nodeName.toLowerCase(),
                o;
            ht.hasOwnProperty(a) && this.parser.normalizeLists && St(e);
            let s =
                (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
                (o = this.parser.matchTag(e, this, n));
            out: if (s ? s.ignore : mt.hasOwnProperty(a))
...
`),
        ...
        insertNode(e, t, n) {
            ...
            if (r) {
                ...
                for (let i of r.concat(e.marks))
                    (t.type
                        ? t.type.allowsMarkType(i.type)
                        : Tt(i.type, e.type)) && (n = i.addToSet(n));
        ...
        enterInner(e, t, n, r = !1, i) {
            ...
            let o = yt(e, i, a.options);
            a.options & vt && a.content.length == 0 && (o |= vt);
            let s = C.none;
            return (
                (n = n.filter((t) =>
                    (a.type ? a.type.allowsMarkType(t.type) : Tt(t.type, e))
                        ? ((s = t.addToSet(s)), !1)
                        : !0,
                )),
                this.nodes.push(new bt(e, t, s, r, null, o)),
                this.open++,
                n
            );
        }
        ...
        sync(e) {
            for (let t = this.open; t >= 0; t--)
                ...
                else this.localPreserveWS && (this.nodes[t].options |= gt);
            return !1;
        }
        get currentPos() {
            this.closeExtra();
...
var Et = class e {
            ...
            e.forEach((e) => {
                if (i.length || e.marks.length) {
                    ...
                    for (; n < i.length && a < e.marks.length; ) {
                        ...
                        if (!t.eq(i[n][0]) || t.type.spec.spanning === !1)
                            break;
                        (n++, a++);
                    }
    ...
    serializeNodeInner(e, t) {
        if (e.isText) return Ot(t).createTextNode(e.text);
        let { dom: n, contentDOM: r } = Mt(
            Ot(t),
    ...
    serializeMark(e, t, n = {}) {
        ...
        return r && Mt(Ot(n), r(e, t), null, e.attrs);
    }
...
function At(e) {
    let t = kt.get(e);
    return (t === void 0 && kt.set(e, (t = jt(e))), t);
}
function jt(e) {
    let t = null;
    function n(e) {
...
function Mt(e, t, n, r) {
    ...
    for (let i = u; i < t.length; i++) {
        ...
        if (a === 0) {
            ...
            let { dom: t, contentDOM: i } = Mt(e, a, n, r);
...
var Wt = class e {
        ...
        appendMappingInverted(e) {
            for (
                let t = e.maps.length - 1,
                    n = this._maps.length + e._maps.length;
                t >= 0;
                t--
            ) {
                let r = e.getMirror(t);
    ...
    Kt = class e {
        ...
        static fromReplace(t, n, r, i) {
            try {
                ...
                if (t instanceof ve) return e.fail(t.message);
                throw t;
            }
        }
    };
function qt(e, t, n) {
    ...
    for (let i = 0; i < e.childCount; i++) {
        let a = e.child(i);
        (a.content.size && (a = a.copy(qt(a.content, t, a))),
            a.isInline && (a = t(a, n, i)),
            r.push(a));
    }
    return S.fromArray(r);
}
var Jt = class e extends T {
    constructor(e, t, n) {
    ...
    apply(e) {
        ...
        return Kt.fromReplace(e, this.from, this.to, i);
    }
    invert() {
...
T.jsonID(`removeMark`, Yt);
var Xt = class e extends T {
    constructor(e, t) {
        (super(), (this.pos = e), (this.mark = t));
    }
    apply(e) {
        let t = e.nodeAt(this.pos);
        if (!t) return Kt.fail(`No node at mark step's position`);
        let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
        return Kt.fromReplace(
            e,
            this.pos,
            this.pos + 1,
        ...
        if (n) {
            ...
            if (t.length == n.marks.length) {
                for (let r = 0; r < n.marks.length; r++)
                    if (!n.marks[r].isInSet(t))
                        return new e(this.pos, n.marks[r]);
...
T.jsonID(`removeNodeMark`, Zt);
var Qt = class e extends T {
    ...
    apply(e) {
        return this.structure && en(e, this.from, this.to)
            ? Kt.fail(`Structure replace would overwrite content`)
            : Kt.fromReplace(e, this.from, this.to, this.slice);
    }
    getMap() {
...
((Qt.MAP_BIAS = 1), T.jsonID(`replace`, Qt));
var $t = class e extends T {
    ...
    apply(e) {
        if (
            this.structure &&
            (en(e, this.from, this.gapFrom) || en(e, this.gapTo, this.to))
        )
            return Kt.fail(`Structure gap-replace would overwrite content`);
        let t = e.slice(this.gapFrom, this.gapTo);
        if (t.openStart || t.openEnd) return Kt.fail(`Gap is not a flat range`);
        let n = this.slice.insertAt(this.insert, t.content);
        return n
            ? Kt.fromReplace(e, this.from, this.to, n)
            : Kt.fail(`Content does not fit in gap`);
    }
    getMap() {
        return new Ut([
            this.from,
            ...
            for (let e = 0; e < u.length; e++)
                u[e].isInSet(f) ||
                    (o && o.to == l && o.mark.eq(u[e])
                        ? (o.to = d)
                        : i.push((o = new Yt(l, d, u[e]))));
            s && s.to == l ? (s.to = d) : a.push((s = new Jt(l, d, r)));
        }
    }),
...
function rn(e, t, n, r = n.contentMatch, i = !0) {
            ...
            if (i && c.isText && n.whitespace != `pre`) {
                ...
                for (; (e = t.exec(c.text)); )
                    ((r ||= new w(
                        ...
                        o.push(
                            new Qt(s + e.index, s + e.index + e[0].length, r),
                        ));
            }
        }
        s = l;
...
function on(e) {
    ...
    for (let n = e.depth, r = 0, i = 0; ; --n) {
        ...
        if (n == 0 || a.type.spec.isolating || !an(a, o, s)) break;
...
function sn(e, t, n) {
    ...
    for (let e = a, t = !1; e > n; e--)
        t || i.after(e + 1) < i.end(e)
            ...
            : l++;
    e.step(new $t(c, l, o, s, new w(u.append(f), d, p), u.size - d, !0));
}
function cn(e, t, n = null, r = e) {
    let i = un(e, t),
        a = i && dn(r, t);
    return a ? i.map(ln).concat({ type: t, attrs: n }).concat(a.map(ln)) : null;
}
function ln(e) {
...
function fn(e, t, n) {
    ...
    let i = t.start,
        a = t.end;
    e.step(new $t(i, a, i, a, new w(r, 0, 0), n.length, !0));
}
function pn(e, t, n, r, i) {
    ...
    e.doc.nodesBetween(t, n, (t, n) => {
        ...
        if (
            t.isTextblock &&
            !t.hasMarkup(r, o) &&
            gn(e.doc, e.mapping.slice(a).map(n), r)
        ) {
            let i = null;
            if (r.schema.linebreakReplacement) {
                let e = r.whitespace == `pre`,
                    t = !!r.contentMatch.matchType(
                        r.schema.linebreakReplacement,
                    );
                e && !t ? (i = !1) : !e && t && (i = !0);
            }
            (i === !1 && hn(e, t, n, a),
                rn(e, e.mapping.slice(a).map(n, 1), r, void 0, i === null));
...
function yn(e, t, n = 1, r) {
    ...
    e.step(new Qt(t, t, new w(a.append(o), n, n), !0));
}
function bn(e, t) {
    let n = e.resolve(t),
        r = n.index();
...
function xn(e, t) {
    ...
    for (let i = 0; i < t.childCount; i++) {
        ...
        if (((n = n.matchType(o)), !n || !e.type.allowsMarks(a.marks)))
            return !1;
    }
    return n.validEnd;
}
function Sn(e, t) {
    return !!(e && t && !e.isLeaf && xn(e, t));
}
function Cn(e, t, n = -1) {
    let r = e.resolve(t);
    for (let e = r.depth; ; e--) {
        ...
        if (
            ...
            i && !i.isTextblock && Sn(i, a) && r.node(e).canReplace(o, o + 1))
        )
            return t;
        if (e == 0) break;
...
function wn(e, t, n) {
    ...
    if (r === !1) {
        ...
        hn(e, r.node(), r.before(), s);
    }
    o.inlineContent &&
        rn(e, t + n - 1, o, a.node().contentMatchAt(a.index()), r == null);
    let c = e.mapping.slice(s),
        l = c.map(t - n);
    if ((e.step(new Qt(l, c.map(t + n, -1), w.empty, !0)), r === !0)) {
        let t = e.doc.resolve(l);
        mn(e, t.node(), t.before(), e.steps.length);
    }
    return e;
}
function Tn(e, t, n) {
...
function Dn(e, t, n = t, r = w.empty) {
    if (t == n && !r.size) return null;
    let i = e.resolve(t),
        a = e.resolve(n);
    return On(i, a, r) ? new Qt(t, n, r) : new kn(i, a, r).fit();
}
function On(e, t, n) {
    return (
        !n.openStart &&
...
var kn = class {
    ...
    fit() {
        ...
        let s = new w(i, a, o);
        return e > -1
            ? new $t(n.pos, e, this.$to.pos, this.$to.end(), s, t)
            : s.size || n.pos != this.$to.pos
              ? new Qt(n.pos, r.pos, s)
              : null;
    }
    findFittable() {
        ...
        for (let t = 1; t <= 2; t++)
            for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
                let e,
                    r = null;
                n
                    ? ((r = Mn(this.unplaced.content, n - 1).firstChild),
                      (e = r.content))
    ...
    dropNode() {
        ...
        if (r.childCount <= 1 && t > 0) {
            ...
            this.unplaced = new w(An(e, t - 1, 1), t - 1, i ? t - 1 : n);
        } else this.unplaced = new w(An(e, t, 1), t, n);
    }
    placeNodes({
        sliceDepth: e,
        frontierDepth: t,
        ...
        (p || (f = -1),
            (this.placed = jn(this.placed, t, S.from(l))),
        ...
        this.unplaced = p
            ...
            : new w(An(a.content, e, c), a.openStart, a.openEnd);
    }
    mustMoveInline() {
        ...
        if (
            !e.type.isTextblock ||
            !Pn(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    close(e) {
        ...
        (t.fit.childCount && (this.placed = jn(this.placed, t.depth, t.fit)),
            (e = t.move));
    ...
    openFrontierNode(e, t = null, n) {
        ...
        ((r.match = r.match.matchType(e)),
            (this.placed = jn(this.placed, this.depth, S.from(e.create(t, n)))),
            this.frontier.push({ type: e, match: e.contentMatch }));
    }
    closeFrontierNode() {
        let e = this.frontier.pop().match.fillBefore(S.empty, !0);
        e.childCount &&
            (this.placed = jn(this.placed, this.frontier.length, e));
    }
};
function An(e, t, n) {
    return t == 0
        ...
        : e.replaceChild(
              0,
              e.firstChild.copy(An(e.firstChild.content, t - 1, n)),
          );
}
function jn(e, t, n) {
    return t == 0
        ...
        : e.replaceChild(
              e.childCount - 1,
              e.lastChild.copy(jn(e.lastChild.content, t - 1, n)),
          );
}
function Mn(e, t) {
...
function Nn(e, t, n) {
    ...
    return (
        t > 1 &&
            (r = r.replaceChild(
                0,
                Nn(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0),
            )),
        t > 0 &&
...
function Pn(e, t, n, r, i) {
    ...
    return s && !Fn(n, a.content, o) ? s : null;
}
function Fn(e, t, n) {
...
function Ln(e, t, n, r) {
    ...
    let i = e.doc.resolve(t),
        a = e.doc.resolve(n);
    if (On(i, a, r)) return e.step(new Qt(t, n, r));
    let o = Vn(i, a);
            ...
            for (let t = 0; t < o.length; t++) {
                ...
                if (f.canReplaceWith(p, p, d.type, d.marks))
                    return e.replace(
                        i.before(l),
                        u ? a.after(l) : n,
                        new w(Rn(r.content, 0, r.openStart, s), s, r.openEnd),
                    );
            }
    }
...
function Rn(e, t, n, r, i) {
    if (t < n) {
        let i = e.firstChild;
        e = e.replaceChild(0, i.copy(Rn(i.content, t + 1, n, r, i)));
    }
    if (t > r) {
...
function Bn(e, t, n) {
    ...
    if (
        ...
        let a = r.sharedDepth(n),
            o = !1;
        for (let e = r.depth; e > a; e--)
            r.node(e).type.spec.isolating && (o = !0);
        for (let e = i.depth; e > a; e--)
            i.node(e).type.spec.isolating && (o = !0);
        if (!o) {
            for (let e = r.depth; e > 0 && t == r.start(e); e--)
                t = r.before(e);
            for (let e = i.depth; e > 0 && n == i.start(e); e--)
                n = i.before(e);
...
var Hn = class e extends T {
    ...
    apply(e) {
        let t = e.nodeAt(this.pos);
        if (!t) return Kt.fail(`No node at attribute step's position`);
        let n = Object.create(null);
...
((Wn = function e(t) {
    ...
    (Wn.prototype.name = `TransformError`));
var Gn = class {
        constructor(e) {
            ((this.doc = e),
                (this.steps = []),
        ...
        step(e) {
            ...
            if (t.failed) throw new Wn(t.failed);
            return this;
        }
        maybeStep(e) {
        ...
        replaceRangeWith(e, t, n) {
            return (zn(this, e, t, n), this);
        }
        deleteRange(e, t) {
            return (Bn(this, e, t), this);
        }
        lift(e, t) {
        ...
        removeNodeMark(e, t) {
            ...
            if (t instanceof C) t.isInSet(n.marks) && this.step(new Zt(e, t));
            else {
                let r = n.marks,
                    i,
                    a = [];
                for (; (i = t.isInSet(r)); )
                    (a.push(new Zt(e, i)), (r = i.removeFromSet(r)));
    ...
    E = class {
        constructor(e, t, n) {
            ((this.$anchor = e),
                (this.$head = t),
                (this.ranges = n || [new qn(e.min(t), e.max(t))]));
        }
        get anchor() {
            ...
            for (let i = 0; i < r.length; i++) {
                ...
                i
                    ...
                    : (e.replaceRangeWith(c, l, t),
                      tr(e, n, t.isInline ? -1 : 1));
            }
        }
        static findFrom(e, t, n = !1) {
            let r = e.parent.inlineContent
                ? new D(e)
                : er(e.node(0), e.parent, e.pos, e.index(), t, n);
            if (r) return r;
        ...
        static near(e, t = 1) {
            return (
                this.findFrom(e, t) || this.findFrom(e, -t) || new Qn(e.node(0))
            );
        }
        static atStart(e) {
            return er(e, e, 0, 0, 1) || new Qn(e);
        }
        static atEnd(e) {
            return er(e, e, e.content.size, e.childCount, -1) || new Qn(e);
        }
        static fromJSON(e, t) {
            if (!t || !t.type)
    ...
    static between(t, n, r) {
        ...
        return (
            t.parent.inlineContent ||
                (i == 0
                    ? (t = n)
                    : ((t = (E.findFrom(t, -r, !0) || E.findFrom(t, r, !0))
                          .$anchor),
                      t.pos < n.pos != i < 0 && (t = n))),
            new e(t, n)
        );
...
function er(e, t, n, r, i, a = !1) {
    ...
    for (
        ...
        let r = t.child(o);
        if (!r.isAtom) {
            let t = er(e, r, n + i, i < 0 ? r.childCount : 0, i, a);
            if (t) return t;
        } else if (!a && O.isSelectable(r))
            return O.create(e, n - (i < 0 ? r.nodeSize : 0));
        n += r.nodeSize * i;
    }
    return null;
}
function tr(e, t, n) {
    ...
    if (r < t) return;
    let i = e.steps[r];
    if (!(i instanceof Qt || i instanceof $t)) return;
    ...
    ar = class extends Gn {
        ...
        setSelection(e) {
            ...
            return (
                (this.curSelection = e),
                (this.curSelectionFor = this.steps.length),
                (this.updated = (this.updated | nr) & ~rr),
...
var sr = class {
        constructor(e, t, n) {
            ((this.name = e),
                (this.init = or(t.init, n)),
                (this.apply = or(t.apply, n)));
        }
    },
    cr = [
        new sr(`doc`, {
    ...
    ur = class e {
        ...
        static create(t) {
            let n = new lr(t.doc ? t.doc.type.schema : t.schema, t.plugins),
                r = new e(n);
        ...
        reconfigure(t) {
            let n = new lr(this.schema, t.plugins),
                r = n.fields,
                i = new e(n);
            for (let e = 0; e < r.length; e++) {
                let n = r[e].name;
        ...
        static fromJSON(t, n, r) {
            ...
            let i = new lr(t.schema, t.plugins),
                a = new e(i);
            return (
                i.fields.forEach((e) => {
                    if (e.name == `doc`) a.doc = Le.fromJSON(t.schema, n.doc);
                    else if (e.name == `selection`)
                        a.selection = E.fromJSON(a.doc, n.selection);
                    else if (e.name == `storedMarks`)
                        n.storedMarks &&
                            (a.storedMarks = n.storedMarks.map(
...
var k = class {
        constructor(e) {
            ((this.spec = e),
                (this.props = {}),
                e.props && dr(e.props, this, this.props),
                (this.key = e.key ? e.key.key : pr(`plugin`)));
        }
        getState(e) {
            return e[this.key];
        }
...
function pr(e) {
    return e in fr ? e + `$` + ++fr[e] : ((fr[e] = 0), e + `$`);
}
var A = class {
        constructor(e = `key`) {
            this.key = pr(e);
...
var gr = (e, t, n) => {
        ...
        let a = i.nodeBefore;
        if (Br(e, i, t, -1)) return !0;
        if (r.parent.content.size == 0 && (br(a, `end`) || O.isSelectable(a)))
            for (let n = r.depth; ; n--) {
                let o = Dn(e.doc, r.before(n), r.after(n), w.empty);
                    ...
                    if (t) {
                        ...
                        (n.setSelection(
                            br(a, `end`)
                                ...
                                : O.create(n.doc, i.pos - a.nodeSize),
                        ),
                            t(n.scrollIntoView()));
                    }
                    return !0;
...
function yr(e, t, n) {
    ...
    let s = Dn(e.doc, i, o, w.empty);
    if (!s || s.from != i || (s instanceof Qt && s.slice.size >= o - i))
        return !1;
    if (n) {
        let t = e.tr.step(s);
...
var xr = (e, t, n) => {
    ...
    return !o || !O.isSelectable(o)
        ? !1
        : (t &&
              t(
                  e.tr
                      .setSelection(O.create(e.doc, a.pos - o.nodeSize))
                      .scrollIntoView(),
              ),
          !0);
};
...
var wr = (e, t, n) => {
        ...
        if (
            ...
            (br(a, `start`) || O.isSelectable(a))
        ) {
            let n = Dn(e.doc, r.before(), r.after(), w.empty);
            if (n && n.slice.size < n.to - n.from) {
                if (t) {
                    let r = e.tr.step(n);
                    (r.setSelection(
                        br(a, `start`)
                            ? E.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1)
                            : O.create(r.doc, r.mapping.map(i.pos)),
                    ),
                        t(r.scrollIntoView()));
                }
                return !0;
    ...
    Tr = (e, t, n) => {
        ...
        return !o || !O.isSelectable(o)
            ? !1
            : (t &&
                  t(e.tr.setSelection(O.create(e.doc, a.pos)).scrollIntoView()),
              !0);
    };
function Er(e) {
    if (!e.parent.type.spec.isolating)
...
var Dr = (e, t) => {
        let n = e.selection,
            ...
            i;
        if (r) {
            if (n.node.isTextblock || !bn(e.doc, n.from)) return !1;
            i = n.from;
        ...
        if (t) {
            ...
            (r &&
                n.setSelection(
                    O.create(n.doc, i - e.doc.resolve(i).nodeBefore.nodeSize),
                ),
                t(n.scrollIntoView()));
        }
        return !0;
    ...
    Or = (e, t) => {
        let n = e.selection,
            r;
        if (n instanceof O) {
            if (n.node.isTextblock || !bn(e.doc, n.to)) return !1;
            r = n.to;
...
var Mr = (e, t) => {
    ...
    Nr = (e, t) => {
        let n = e.selection,
            { $from: r, $to: i } = n;
        if (n instanceof Qn || r.parent.inlineContent || i.parent.inlineContent)
            return !1;
...
function Fr(e) {
    return (t, n) => {
        ...
        if (t.selection instanceof O && t.selection.node.isBlock)
            return !r.parentOffset || !vn(t.doc, r.pos)
                ? !1
        ...
        for (let t = r.depth; ; t--)
            if (r.node(t).isBlock) {
                ((c = r.end(t) == r.pos + (r.depth - t)),
                    ...
                    (s = jr(
                        r.node(t - 1).contentMatchAt(r.indexAfter(t - 1)),
                    )));
        ...
        let u = t.tr;
        (t.selection instanceof D || t.selection instanceof Qn) &&
            u.deleteSelection();
        let d = u.mapping.map(r.pos),
            f = vn(u.doc, d, a.length, a);
        if (
            ((f ||=
                ((a[0] = s ? { type: s } : null), vn(u.doc, d, a.length, a))),
            !f)
        )
            return !1;
...
var Ir = Fr(),
    Lr = (e, t) => {
        ...
        return a == 0
            ? !1
            : ((i = n.before(a)),
              t && t(e.tr.setSelection(O.create(e.doc, i))),
              !0);
    },
    Rr = (e, t) => (t && t(e.tr.setSelection(new Qn(e.doc))), !0);
function zr(e, t, n) {
    let r = t.nodeBefore,
        i = t.nodeAfter,
        a = t.index();
...
function Br(e, t, n, r) {
    ...
    let u = a.type.spec.isolating || (r > 0 && c) ? null : E.findFrom(t, 1),
        d = u && u.$from.blockRange(u.$to),
        f = d && on(d);
    if (f != null && f >= t.depth)
        return (n && n(e.tr.lift(d, f).scrollIntoView()), !0);
    if (l && br(a, `start`, !0) && br(i, `end`)) {
        let r = i,
            o = [];
    ...
    return function (t, n) {
        ...
        return i.node(a).isTextblock
            ? (n &&
                  n(
                      t.tr.setSelection(
                          D.create(t.doc, e < 0 ? i.start(a) : i.end(a)),
                      ),
                  ),
              !0)
            : !1;
...
function Zr(e, t = null) {
    return function (n, r) {
        ...
        if (!o) return !1;
        let s = r ? n.tr : null;
        return Qr(s, o, e, t) ? (r && r(s.scrollIntoView()), !0) : !1;
    };
}
function Qr(e, t, n, r = null) {
    ...
    if (
        ...
        ((a = new Fe(e, e, t.depth)),
            t.endIndex < t.parent.childCount &&
                (t = new Fe(t.$from, o.resolve(t.$to.end(t.depth)), t.depth)),
            (i = !0));
    }
    let s = cn(a, n, r, t);
    return s ? (e && $r(e, t, s, i, n), !0) : !1;
}
function $r(e, t, n, r, i) {
    ...
    for (let n = t.startIndex, r = t.endIndex, i = !0; n < r; n++, i = !1)
        (!i && vn(e.doc, c, s) && (e.split(c, s), (c += 2 * s)),
...
function ti(e, t, n, r) {
    ...
    a < o &&
        ...
        (r = new Fe(i.doc.resolve(r.$from.pos), i.doc.resolve(o), r.depth)));
    let s = on(r);
    if (s == null) return !1;
    i.lift(r, s);
    ...
    return (
        bn(i.doc, c.pos) &&
            c.nodeBefore.type == c.nodeAfter.type &&
            i.join(c.pos),
        t(i.scrollIntoView()),
        !0
    );
...
function ni(e, t, n) {
    ...
    let s = n.startIndex == 0,
        ...
        u = a.index(-1);
    if (
        !l.canReplace(u + +!s, u + 1, o.content.append(c ? S.empty : S.from(i)))
    )
        return !1;
    let d = a.pos,
        f = d + o.nodeSize;
...
function ri(e) {
    return function (t, n) {
        ...
        if (n) {
            ...
            n(
                t.tr
                    .step(new $t(l - (r ? 3 : 1), u, l, u, o, 1, !0))
                    .scrollIntoView(),
            );
        }
        return !0;
...
var j = function (e) {
    ...
    ci = function (e, t, n, r) {
        return n && (ui(e, t, n, r, -1) || ui(e, t, n, r, 1));
    },
...
function fi(e, t) {
    for (;;) {
        ...
        if (e.nodeType == 1 && t > 0) {
            ...
            ((e = e.childNodes[t - 1]), (t = di(e)));
        } else if (e.parentNode && !hi(e)) ((t = j(e)), (e = e.parentNode));
        else return null;
    }
}
function pi(e, t) {
    for (;;) {
        ...
        } else if (e.parentNode && !hi(e)) ((t = j(e) + 1), (e = e.parentNode));
        else return null;
    }
}
function mi(e, t, n) {
    for (let r = t == 0, i = t == di(e); r || i; ) {
        if (e == n) return !0;
        let t = j(e);
...
var gi = function (e) {
    return (
        e.focusNode &&
        ci(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
    );
};
function _i(e, t) {
    ...
    if (e.caretPositionFromPoint)
        try {
            ...
            if (r)
                return {
                    node: r.offsetNode,
                    offset: Math.min(di(r.offsetNode), r.offset),
                };
        } catch {}
    if (e.caretRangeFromPoint) {
        ...
        if (r)
            return {
                ...
                offset: Math.min(di(r.startContainer), r.startOffset),
            };
    }
}
var bi = typeof navigator < `u` ? navigator : null,
    xi = typeof document < `u` ? document : null,
    Si = (bi && bi.userAgent) || ``,
    Ci = /Edge\/(\d+)/.exec(Si),
    wi = /MSIE \d/.exec(Si),
    Ti = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Si),
    Ei = !!(wi || Ti || Ci),
    Di = wi ? document.documentMode : Ti ? +Ti[1] : Ci ? +Ci[1] : 0,
    Oi = !Ei && /gecko\/(\d+)/i.test(Si);
Oi && +(/Firefox\/(\d+)/.exec(Si) || [0, 0])[1];
var ki = !Ei && /Chrome\/(\d+)/.exec(Si),
    M = !!ki,
    Ai = ki ? +ki[1] : 0,
    N = !Ei && !!bi && /Apple Computer/.test(bi.vendor),
    ji = N && (/Mobile\/\w+/.test(Si) || (!!bi && bi.maxTouchPoints > 2)),
    Mi = ji || (bi ? /Mac/.test(bi.platform) : !1),
    Ni = bi ? /Win/.test(bi.platform) : !1,
    Pi = /Android \d/.test(Si),
    Fi = !!xi && `webkitFontSmoothing` in xi.documentElement.style,
    Ii = Fi
...
function Bi(e, t, n) {
    ...
    for (let o = n || e.dom; o; ) {
        ...
        let e = o,
            ...
            l = 0;
        if (
            (t.top < s.top + Ri(r, `top`)
                ? (l = -(s.top - t.top + Ri(i, `top`)))
                : t.bottom > s.bottom - Ri(r, `bottom`) &&
                  (l =
                      t.bottom - t.top > s.bottom - s.top
                          ? t.top + Ri(i, `top`) - s.top
                          : t.bottom - s.bottom + Ri(i, `bottom`)),
            t.left < s.left + Ri(r, `left`)
                ? (c = -(s.left - t.left + Ri(i, `left`)))
                : t.right > s.right - Ri(r, `right`) &&
                  (c = t.right - s.right + Ri(i, `right`)),
            c || l)
        )
        ...
        o = u == `absolute` ? o.offsetParent : ii(o);
    }
}
function Vi(e) {
    ...
    return { refDOM: r, refTop: i, stack: Hi(e.dom) };
}
function Hi(e) {
    let t = [],
        n = e.ownerDocument;
...
function Ui({ refDOM: e, refTop: t, stack: n }) {
...
function qi(e, t) {
    ...
    for (let u = e.firstChild, d = 0; u; u = u.nextSibling, d++) {
        ...
        else if (u.nodeType == 3) e = oi(u).getClientRects();
        else continue;
        ...
        if (
            ...
            (t.node.isBlock &&
                ...
                ((!a && o.left > r.left) || o.top > r.top
                    ? (i = t.posBefore)
                    : ((!a && o.right < r.left) || o.bottom < r.top) &&
                      (i = t.posAfter),
                (a = !0)),
    ...
    if (r && n.top < n.bottom)
        for (
            let i = Math.max(
                    ...
                    Math.min(
                        r - 1,
                        Math.floor((r * (t.top - n.top)) / (n.bottom - n.top)) -
                            2,
                    ),
                ),
                a = i;
...
function ea(e, t) {
    ...
    if (!o || !e.dom.contains(o.nodeType == 1 ? o : o.parentNode)) {
        ...
        if (!Yi(t, n) || ((o = $i(e.dom, t, n)), !o)) return null;
    }
    if (N) for (let e = o; r && e; e = ii(e)) e.draggable && (r = void 0);
    if (((o = Xi(o, t)), r)) {
        if (
            Oi &&
            r.nodeType == 1 &&
...
function na(e, t) {
    ...
    return Array.prototype.find.call(n, ta) || e.getBoundingClientRect();
}
var ra = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function ia(e, t, n) {
    let {
    ...
    if (r.nodeType == 3)
        if (
            o &&
            (ra.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))
        ) {
            let e = na(oi(r, i, i), n);
            if (
                Oi &&
                ...
                let t = na(oi(r, i - 1, i - 1), -1);
                if (t.top == e.top) {
                    let n = na(oi(r, i, i + 1), -1);
                    if (n.top != e.top) return aa(n, n.left < t.left);
                }
            }
            return e;
        } else {
                ...
                n < 0 && !i
                    ...
                    : n >= 0 && i == r.nodeValue.length
                      ...
                      : n < 0
                        ? e--
                        : t++,
                aa(na(oi(r, e, t), a), a < 0)
            );
        }
    if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
        if (a == null && i && (n < 0 || i == di(r))) {
            let e = r.childNodes[i - 1];
            if (e.nodeType == 1) return oa(e.getBoundingClientRect(), !1);
        }
        if (a == null && i < di(r)) {
            let e = r.childNodes[i];
            if (e.nodeType == 1) return oa(e.getBoundingClientRect(), !0);
        }
        ...
        let t = e
            ? e.nodeType == 3
                ...
                : e.nodeType == 1
                  ...
                  : null
            : null;
        if (t) return aa(na(t, -1), !0);
    }
    return aa(na(r.nodeType == 3 ? oi(r) : r, -n), n >= 0);
}
function aa(e, t) {
    ...
    return sa(e, t, () => {
        ...
        for (let e = t.firstChild; e; e = e.nextSibling) {
            ...
            if (e.nodeType == 1) t = e.getClientRects();
                ...
                t = oi(e, 0, e.nodeValue.length).getClientRects();
            else continue;
            for (let e = 0; e < t.length; e++) {
                let i = t[e];
                if (
...
function ua(e, t, n) {
    ...
    let i = r.parentOffset,
        ...
        s = e.domSelection();
    return s
        ? !la.test(r.parent.textContent) || !s.modify
            ? n == `left` || n == `backward`
                ? a
                : o
            : sa(e, t, () => {
...
function ma(e, t, n) {
    return da == t && fa == n
        ...
        : ((da = t),
          (fa = n),
          (pa = n == `up` || n == `down` ? ca(e, t, n) : ua(e, t, n)));
}
var ha = 0,
    ga = 1,
    _a = 2,
...
`
                    ...
                    u =
                        n &&
                        (n.nodeName == `BR` || n.contentEditable == `false`);
                }
            }
            if (
                Oi &&
            ...
            if (
                !(r || (u && N)) &&
                ci(o.node, o.offset, l.anchorNode, l.anchorOffset) &&
                ci(s.node, s.offset, l.focusNode, l.focusOffset)
            )
                return;
            let d = !1;
            if ((c.extend || e == t) && !(u && Oi)) {
    ...
    ba = class extends ya {
        ...
        matchesWidget(e) {
            return this.dirty == ha && e.type.eq(this.widget.type);
        }
        parseRule() {
            return { ignore: !0 };
        }
    ...
    Sa = class e extends ya {
        ...
        parseRule() {
            return this.dirty & va || this.mark.type.spec.reparseInView
                ? null
                : {
        ...
        matchesMark(e) {
            return this.dirty != va && this.mark.eq(e);
        }
        markDirty(e, t) {
            if ((super.markDirty(e, t), this.dirty != ha)) {
                let e = this.parent;
        ...
        slice(t, n, r) {
            let i = e.create(this.parent, this.mark, !0, r),
                a = this.children,
                o = this.size;
            (n < o && (a = Ua(a, n, o, r)), t > 0 && (a = Ua(a, 0, t, r)));
    ...
    Ca = class e extends ya {
        ...
        updateChildren(e, t) {
            ...
            (Ba(
                ...
                s.destroyRest(),
                (s.changed || this.dirty == _a) &&
                    (a && this.protectLocalComposition(e, a),
                    Oa(this.contentDOM, this.children, e),
                    ji && Va(this.dom)));
        }
        localCompositionInfo(e, t) {
            ...
            if (this.node.inlineContent) {
                let e = i.nodeValue,
                    a = Ha(this.node.content, e, n - t, r - t);
        ...
        protectLocalComposition(e, { node: t, pos: n, text: r }) {
            ...
            let a = new xa(this, i, t, r);
            (e.input.compositionNodes.push(a),
                (this.children = Ua(this.children, n, n + r.length, e, a)));
        }
        update(e, t, n, r) {
            return this.dirty == va || !e.sameMarkup(this.node)
                ? !1
...
function wa(e, t, n, r, i) {
    Pa(r, t, e);
    let a = new Ca(void 0, e, t, n, r, r, r, i, 0);
    return (a.contentDOM && a.updateChildren(i, 0), a);
}
var Ta = class e extends Ca {
        ...
        update(e, t, n, r) {
            return this.dirty == va ||
                (this.dirty != ha && !this.inParent()) ||
                !e.sameMarkup(this.node)
                ? !1
                : (this.updateOuterDeco(t),
                  (this.dirty != ha || e.text != this.node.text) &&
    ...
    Ea = class extends ya {
        ...
        matchesHack(e) {
            return this.dirty == ha && this.dom.nodeName == e;
        }
        get domAtom() {
            return !0;
        }
        ...
        if (o) {
            ...
            for (let e in o) {
                ...
                a != null &&
                    (n &&
                        i.length == 1 &&
                        i.push((r = new ka(t.isInline ? `span` : `div`))),
                    e == `class`
...
function Pa(e, t, n) {
    return Ma(e, e, Aa, ja(t, n, e.nodeType != 1));
}
function Fa(e, t) {
    if (e.length != t.length) return !1;
...
var La = class {
    ...
    syncToMarks(e, t, n, r) {
        ...
        for (; a < e.length; ) {
            ...
            if (i > -1)
                ...
                let r = Sa.create(this.top, e[a], t, n);
    ...
    findNodeMatch(e, t, n, r) {
        ...
        if (
            ...
            for (
                let r = this.index,
                    a = Math.min(this.top.children.length, r + 5);
                r < a;
                r++
            ) {
    ...
    updateNodeAt(e, t, n, r, i) {
        let a = this.top.children[r];
        return (
            a.dirty == va && a.dom == a.contentDOM && (a.dirty = _a),
            a.update(e, t, n, i)
    ...
    recreateWrapper(e, t, n, r, i, a) {
        if (
            ...
            return null;
        let o = Ca.create(this.top, t, n, r, i, a);
        if (o.contentDOM) {
    ...
    addNode(e, t, n, r, i) {
        let a = Ca.create(this.top, e, t, n, r, i);
    ...
    outer: for (; i > 0; ) {
        ...
        for (;;)
            if (r) {
                ...
                if (e instanceof Sa) ((n = e), (r = e.children.length));
                else {
                    ((s = e), r--);
                    break;
                }
...
function Ba(e, t, n, r) {
    ...
    for (let l = 0; ; ) {
        ...
        if (f.isText) {
            ...
            e < m &&
                ((c = f.cut(e - a)), (f = f.cut(0, e - a)), (m = e), (p = -1));
        } else for (; o < i.length && i[o].to < m; ) o++;
        let h =
            f.isInline && !f.isLeaf ? s.filter((e) => !e.inline) : s.slice();
...
function Ha(e, t, n, r) {
    for (let i = 0, a = 0; i < e.childCount && a <= r; ) {
        ...
        if (a >= n) {
            if (a >= r && c.slice(r - t.length - s, r - s) == t)
                return r - t.length;
...
function Wa(e, t = null) {
    ...
    if (gi(n)) {
        ...
        if (
            ...
            O.isSelectable(e) &&
            i.parent &&
            !(e.isInline && mi(n.focusNode, n.focusOffset, i.dom))
        ) {
            let e = i.posBefore;
    ...
    if (!l) {
        let n =
            t == `pointer` || (e.state.selection.head < s.pos && !a) ? 1 : -1;
        l = to(e, u, s, n);
    }
    return l;
}
    ...
    if (($a(e, n), Ga(e))) {
        if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && M) {
            ...
            if (
                t.anchorNode &&
                n.anchorNode &&
                ci(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset)
            ) {
        ...
        if ((e.domObserver.disconnectSelection(), e.cursorWrapper)) Qa(e);
            ...
            (qa &&
                !(n instanceof D) &&
                (n.$from.parent.inlineContent || (a = Ja(e, n.from)),
                !n.empty && !n.$from.parent.inlineContent && (o = Ja(e, n.to))),
                ...
                n.visible
                    ...
                    : (e.dom.classList.add(`ProseMirror-hideselection`),
                      `onselectionchange` in document && Za(e)));
        }
...
function Ja(e, t) {
    ...
    if (N && i && i.contentEditable == `false`) return Ya(i);
    if (
    ...
    t.addEventListener(
        ...
        (e.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != i) &&
                ...
                setTimeout(() => {
                    (!Ga(e) || e.state.selection.visible) &&
                        e.dom.classList.remove(`ProseMirror-hideselection`);
                }, 20));
        }),
    );
...
function $a(e, t) {
    if (t instanceof O) {
        ...
        n != e.lastSelectedViewDesc &&
            (eo(e), n && n.selectNode(), (e.lastSelectedViewDesc = n));
    } else eo(e);
}
function eo(e) {
...
function no(e) {
    return e.editable && !e.hasFocus() ? !1 : ro(e);
}
function ro(e) {
    let t = e.domSelectionRange();
    ...
    try {
        return (
            e.dom.contains(
                t.anchorNode.nodeType == 3
                    ? t.anchorNode.parentNode
                    : t.anchorNode,
            ) &&
            (e.editable ||
                e.dom.contains(
                    t.focusNode.nodeType == 3
...
function io(e) {
    ...
    return ci(t.node, t.offset, n.anchorNode, n.anchorOffset);
}
function ao(e, t) {
...
function so(e, t, n) {
    ...
    if (r instanceof D) {
        if (n.indexOf(`s`) > -1) {
            ...
            return oo(e, new D(r.$anchor, a));
        } else if (!r.empty) return !1;
        else if (e.endOfTextblock(t > 0 ? `forward` : `backward`)) {
            let n = ao(e.state, t);
            return n && n instanceof O ? oo(e, n) : !1;
        } else if (!(Mi && n.indexOf(`m`) > -1)) {
            let n = r.$head,
                i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter,
                a;
            ...
            return i.isAtom || ((a = e.docView.descAt(o)) && !a.contentDOM)
                ? O.isSelectable(i)
                    ? oo(
                          ...
                          new O(
                              t < 0
                                  ? e.state.doc.resolve(n.pos - i.nodeSize)
                                  : n,
                          ),
                      )
                    : Fi
                      ? oo(
                            e,
                            new D(
                                e.state.doc.resolve(t < 0 ? o : o + i.nodeSize),
                            ),
                        )
                      : !1
                : !1;
        }
    } else if (r instanceof O && r.node.isInline)
        return oo(e, new D(t > 0 ? r.$to : r.$from));
    else {
        let n = ao(e.state, t);
        return n ? oo(e, n) : !1;
    }
...
function ho(e, t) {
    for (; e && t == e.childNodes.length && !hi(e); )
...
function go(e, t) {
    for (; e && !t && !hi(e); ) ((t = j(e)), (e = e.parentNode));
    for (; e && t; ) {
        let n = e.childNodes[t - 1];
        if (n.nodeType == 3) return n;
        if (n.nodeType == 1 && n.contentEditable == `false`) break;
...
function _o(e, t, n) {
    if (t.nodeType != 3) {
        ...
        (r = ho(t, n))
            ? ((t = r), (n = 0))
            : (e = go(t, n)) && ((t = e), (n = e.nodeValue.length));
    }
...
function vo(e, t) {
    ...
    if (!(M || Ni) && n.parent.inlineContent) {
...
function yo(e, t, n) {
    ...
    if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? `up` : `down`)) {
        let n = ao(e.state, t);
        if (n && n instanceof O) return oo(e, n);
    }
    if (!i.parent.inlineContent) {
        let n = t < 0 ? i : a,
            o = r instanceof Qn ? E.near(n, t) : E.findFrom(n, t);
        return o ? oo(e, o) : !1;
    }
    return !1;
}
...
function So(e) {
    ...
    if (
        ...
        let n = t.firstChild;
        (xo(e, n, `true`), setTimeout(() => xo(e, n, `false`), 20));
    }
    return !1;
}
function Co(e) {
...
function wo(e, t) {
    let n = t.keyCode,
        r = Co(t);
    if (n == 8 || (Mi && n == 72 && r == `c`)) return bo(e, -1) || uo(e, -1);
    if ((n == 46 && !t.shiftKey) || (Mi && n == 68 && r == `c`))
        return bo(e, 1) || uo(e, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Mi && n == 66 && r == `c`)) {
        let t =
            n == 37 ? (vo(e, e.state.selection.from) == `ltr` ? -1 : 1) : -1;
        return so(e, t, r) || uo(e, t);
    } else if (n == 39 || (Mi && n == 70 && r == `c`)) {
        let t = n == 39 ? (vo(e, e.state.selection.from) == `ltr` ? 1 : -1) : 1;
        return so(e, t, r) || uo(e, t);
    } else if (n == 38 || (Mi && n == 80 && r == `c`))
        return yo(e, -1, r) || uo(e, -1);
    else if (n == 40 || (Mi && n == 78 && r == `c`))
        return So(e) || yo(e, 1, r) || uo(e, 1);
    else if (
        r == (Mi ? `m` : `c`) &&
        (n == 66 || n == 73 || n == 89 || n == 90)
    )
...
function To(e, t) {
    ...
    let o = e.someProp(`clipboardSerializer`) || Et.fromSchema(e.state.schema),
        s = Io(),
...
`,
    ...
    if (
        ...
        s = Vo(No(s, +u[1], +u[2]), u[4]);
    else if (
        ((s = w.maxOpen(Oo(s.content, i), !0)), s.openStart || s.openEnd)
    ) {
        let e = 0,
            t = 0;
        for (
    ...
    for (let n = t.depth; n >= 0; n--) {
        ...
        if (
            (e.forEach((e) => {
                ...
                if (
                    (n =
                        a.length && i.length && Ao(t, i, e, a[a.length - 1], 0))
                )
                    a[a.length - 1] = n;
                else {
                    a.length &&
                        (a[a.length - 1] = jo(a[a.length - 1], i.length));
                    let n = ko(e, t);
...
function Ao(e, t, n, r, i) {
    if (i < e.length && i < t.length && e[i] == t[i]) {
        let a = Ao(e, t, n, r.lastChild, i + 1);
        ...
        if (
            ...
            return r.copy(r.content.append(S.from(ko(n, e, i + 1))));
    }
}
function jo(e, t) {
    if (t == 0) return e;
    let n = e.content.replaceChild(e.childCount - 1, jo(e.lastChild, t - 1)),
...
function No(e, t, n) {
    return (
        t < e.openStart &&
            (e = new w(
                Mo(e.content, -1, t, e.openStart, 0, e.openEnd),
                t,
                e.openEnd,
            )),
        n < e.openEnd &&
            (e = new w(Mo(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
        e
    );
}
var Po = {
...
function zo(e) {
    ...
    let n = Io().createElement(`div`),
        r = /<([a-z][^>\s]+)/i.exec(e),
        i;
    if (
        ((i = r && Po[r[1].toLowerCase()]) &&
            (e =
                i.map((e) => `<` + e + `>`).join(``) +
                e +
                i
...
function Bo(e) {
    let t = e.querySelectorAll(
        M ? `span:not([class]):not([style])` : `span.Apple-converted-space`,
    );
    ...
    for (let t in P) {
        ...
        e.dom.addEventListener(
            ...
            (e.input.eventHandlers[t] = (t) => {
                Yo(e, t) &&
                    !Jo(e, t) &&
                    (e.editable || !(t.type in F)) &&
                    n(e, t);
            }),
            Ho[t] ? { passive: !0 } : void 0,
        );
    }
    (N && e.dom.addEventListener(`input`, () => null), qo(e));
}
function Go(e, t) {
    ...
    e.someProp(`handleDOMEvents`, (t) => {
        for (let n in t)
            e.input.eventHandlers[n] ||
                e.dom.addEventListener(
                    n,
                    (e.input.eventHandlers[n] = (t) => Jo(e, t)),
                );
    });
}
function Jo(e, t) {
...
function Xo(e, t) {
    !Jo(e, t) && P[t.type] && (e.editable || !(t.type in F)) && P[t.type](e, t);
}
((F.keydown = (e, t) => {
    let n = t;
    if (
        ...
        if (
            ...
            ji && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
        ) {
            let t = Date.now();
            ((e.input.lastIOSEnter = t),
                (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
                    e.input.lastIOSEnter == t &&
                        (e.someProp(`handleKeyDown`, (t) =>
                            t(e, _i(13, `Enter`)),
                        ),
                        (e.input.lastIOSEnter = 0));
                }, 200)));
        } else
            e.someProp(`handleKeyDown`, (t) => t(e, n)) || wo(e, n)
                ? n.preventDefault()
                : Go(e, `key`);
}),
    (F.keyup = (e, t) => {
...
function ns(e, t) {
    ...
    return i == null ? !1 : (es(e, O.create(e.state.doc, i), `pointer`), !0);
}
function rs(e, t, n, r, i) {
    return (
        $o(e, `handleClickOn`, t, n, r) ||
...
function is(e, t, n, r) {
    return (
        $o(e, `handleDoubleClickOn`, t, n, r) ||
        e.someProp(`handleDoubleClick`, (n) => n(e, t, r))
    );
}
function as(e, t, n, r) {
    return (
        $o(e, `handleTripleClickOn`, t, n, r) ||
...
function ss(e, t, n) {
    ...
    if (t == -1)
        return r.inlineContent
            ? (es(e, D.create(r, 0, r.content.size), `pointer`), !0)
            : !1;
    let i = r.resolve(t);
    for (let t = i.depth + 1; t > 0; t--) {
        let n = t > i.depth ? i.nodeAfter : i.node(t),
            a = i.before(t);
        if (n.inlineContent)
            es(e, D.create(r, a + 1, a + 1 + n.content.size), `pointer`);
        else if (O.isSelectable(n)) es(e, O.create(r, a), `pointer`);
        else continue;
        return !0;
    }
}
...
P.mousedown = (e, t) => {
    ...
    let o = e.posAtCoords(Zo(n));
    o &&
        (a == `singleClick`
            ? (e.input.mouseDown && e.input.mouseDown.done(),
              (e.input.mouseDown = new us(e, o, n, !!r)))
            : (a == `doubleClick` ? is : as)(e, o.pos, o.inside, n)
              ? n.preventDefault()
              : Go(e, `pointer`));
};
var us = class {
    constructor(e, t, n, r) {
        ...
        (n.button == 0 &&
            ((i.type.spec.draggable && i.type.spec.selectable !== !1) ||
                (c instanceof O && c.from <= a && c.to > a)) &&
            (this.mightDrag = {
                node: i,
                pos: a,
    ...
    up(e) {
        ...
        (this.view.state.doc != this.startDoc &&
            (t = this.view.posAtCoords(Zo(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !t
                ? Go(this.view, `pointer`)
                : rs(this.view, t.pos, t.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (N &&
                          ...
                          (M &&
                              ...
                              Math.min(
                                  ...
                                  Math.abs(
                                      t.pos - this.view.state.selection.to,
                                  ),
                              ) <= 2))
                    ? (es(
                          this.view,
                          E.near(this.view.state.doc.resolve(t.pos)),
                          `pointer`,
                      ),
                      e.preventDefault())
                    : Go(this.view, `pointer`));
...
((P.touchstart = (e) => {
    ((e.input.lastTouch = Date.now()), cs(e), Go(e, `pointer`));
}),
    (P.touchmove = (e) => {
        ((e.input.lastTouch = Date.now()), Go(e, `pointer`));
    }),
    (P.contextmenu = (e) => cs(e)));
function ds(e, t) {
    return e.composing
        ? !0
...
function ms(e, t) {
    (clearTimeout(e.input.composingTimeout),
        t > -1 && (e.input.composingTimeout = setTimeout(() => vs(e), t)));
}
function hs(e) {
    for (
        e.composing &&
        ((e.input.composing = !1), (e.input.compositionEndedAt = _s()));
...
function gs(e) {
    ...
    let n = fi(t.focusNode, t.focusOffset),
        r = pi(t.focusNode, t.focusOffset);
    if (n && r && n != r) {
        let t = r.pmViewDesc,
...
var bs = (Ei && Di < 15) || (ji && Ii < 604);
P.copy = F.cut = (e, t) => {
    let n = t,
        r = e.state.selection,
        i = n.type == `cut`;
    if (r.empty) return;
    let a = bs ? null : n.clipboardData,
...
function Ss(e, t) {
    ...
    setTimeout(() => {
        (e.focus(),
            ...
            n
                ? Cs(e, r.value, null, i, t)
                : Cs(e, r.textContent, r.innerHTML, i, t));
    }, 50);
}
function Cs(e, t, n, r, i) {
    let a = Eo(e, t, n, r, e.state.selection.$from);
...
F.paste = (e, t) => {
    ...
    let r = bs ? null : n.clipboardData,
        i = e.input.shiftKey && e.input.lastKeyCode != 45;
    r && Cs(e, ws(r), r.getData(`text/html`), i, n)
        ? n.preventDefault()
        : Ss(e, n);
};
var Ts = class {
...
((P.dragstart = (e, t) => {
    ...
    let i = e.state.selection,
        a = i.empty ? null : e.posAtCoords(Zo(n)),
        o;
    if (
        !(a && a.pos >= i.from && a.pos <= (i instanceof O ? i.to - 1 : i.to))
    ) {
        if (r && r.mightDrag) o = O.create(e.state.doc, r.mightDrag.pos);
            ...
            t &&
                ...
                t != e.docView &&
                (o = O.create(e.state.doc, t.posBefore));
        }
    }
    let {
        dom: s,
        text: c,
        slice: l,
    } = To(e, (o || e.state.selection).content());
    ((!n.dataTransfer.files.length || !M || Ai > 120) &&
        n.dataTransfer.clearData(),
        n.dataTransfer.setData(bs ? `Text` : `text/html`, s.innerHTML),
        (n.dataTransfer.effectAllowed = `copyMove`),
        bs || n.dataTransfer.setData(`text/plain`, c),
        (e.dragging = new Ts(l, Ds(e, n), o)));
}),
    (P.dragend = (e) => {
        let t = e.dragging;
        window.setTimeout(() => {
    ...
    (F.dragover = F.dragenter = (e, t) => t.preventDefault()),
    (F.drop = (e, t) => {
        try {
            Os(e, t, e.dragging);
        } finally {
...
function Os(e, t, n) {
    ...
    a
        ...
        : (a = Eo(
              e,
              ws(t.dataTransfer),
              bs ? null : t.dataTransfer.getData(`text/html`),
              !1,
              i,
          ));
    let o = !!(n && Ds(e, t));
    ...
    if (
        u &&
        O.isSelectable(a.content.firstChild) &&
        f.nodeAfter &&
        ...
        (c.mapping.maps[c.mapping.maps.length - 1].forEach(
            ...
            c.setSelection(to(e, f, c.doc.resolve(t))));
    }
...
((P.focus = (e) => {
    ...
    (P.beforeinput = (e, t) => {
        if (M && Pi && t.inputType == `deleteContentBackward`) {
...
var As = class e {
        ...
        map(e, t, n, r) {
            ...
            return a ? null : new Ns(i - n, i - n, this);
        }
        valid() {
            return !0;
        }
            ...
            return (
                ...
                (t instanceof e &&
                    ((this.spec.key && this.spec.key == t.spec.key) ||
                        (this.toDOM == t.toDOM && ks(this.spec, t.spec))))
            );
        }
        destroy(e) {
    ...
    js = class e {
        ...
        map(e, t, n, r) {
            ...
            return i >= a ? null : new Ns(i, a, this);
        }
        valid(e, t) {
            return t.from < t.to;
        }
    ...
    I = class e {
        constructor(e, t) {
            ((this.local = e.length ? e : Ps),
                (this.children = t.length ? t : Ps));
        }
        static create(e, t) {
            return t.length ? Hs(t, e, 0, Fs) : L;
        }
        find(e, t, n) {
            let r = [];
        ...
        map(e, t, n) {
            return this == L || e.maps.length == 0
                ? this
                : this.mapInner(e, t, 0, 0, n || Fs);
        }
        mapInner(t, n, r, i, a) {
            let o;
        ...
        addInner(t, n, r) {
            ...
            return new e(
                o.length ? this.local.concat(o).sort(Us) : this.local,
                i || this.children,
            );
        }
        remove(e) {
        ...
        forChild(t, n) {
            ...
            for (let e = 0; e < this.local.length; e++) {
                let t = this.local[e];
                if (t.from < o && t.to > a && t.type instanceof js) {
            ...
            if (i) {
                let t = new e(i.sort(Us), Ps);
                return r ? new Is([t, r]) : t;
            }
            return r || L;
        }
        eq(t) {
        ...
        localsInner(e) {
            if (this == L) return Ps;
            if (e.inlineContent || !this.local.some(js.is)) return this.local;
            let t = [];
            for (let e = 0; e < this.local.length; e++)
                this.local[e].type instanceof js || t.push(this.local[e]);
            return t;
        }
        forEachSet(e) {
            e(this);
...
((I.empty = new I([], [])), (I.removeOverlap = Ws));
var L = I.empty,
    Is = class e {
        constructor(e) {
            this.members = e;
        ...
        forChild(t, n) {
            ...
            for (let i = 0; i < this.members.length; i++) {
                ...
                a != L &&
                    (a instanceof e ? (r = r.concat(a.members)) : r.push(a));
            }
            return e.from(r);
        }
        eq(t) {
        ...
        static from(t) {
            switch (t.length) {
                ...
                default:
                    return new e(
                        t.every((e) => e instanceof I)
                            ? t
                            : t.reduce(
                                  (e, t) =>
                                      e.concat(t instanceof I ? t : t.members),
                                  [],
                              ),
                    );
            }
...
function Ls(e, t, n, r, i, a, o) {
    ...
    if (c) {
        let c = Hs(zs(s, e, t, n, i, a, o), r, 0, o);
        t = c.local;
...
function Rs(e, t) {
    ...
    for (let r = 0; r < e.length; r++) {
        let i = e[r];
        n.push(new Ns(i.from + t, i.to + t, i.type));
    }
    return n;
}
...
function Hs(e, t, n, r) {
    ...
    t.forEach((t, o) => {
        ...
        if (s) {
            a = !0;
            let e = Hs(s, t, n + o + 1, r);
            e != L && i.push(o, o + t.nodeSize, e);
        }
    });
    let o = Rs(a ? Vs(e) : e, -n).sort(Us);
    for (let e = 0; e < o.length; e++)
            ...
            for (let i = n + 1; i < t.length; i++) {
                ...
                if (a.from == r.from) {
                    a.to != r.to &&
                        ...
                        Gs(t, i + 1, a.copy(r.to, a.to)));
                    continue;
                } else {
                    a.from < r.to &&
                        (t == e && (t = e.slice()),
                        (t[n] = r.copy(r.from, a.from)),
                        Gs(t, i, r.copy(a.from, r.to)));
                    break;
                }
            }
    }
...
function Ks(e) {
    ...
    return (
        ...
        e.cursorWrapper &&
            t.push(I.create(e.state.doc, [e.cursorWrapper.deco])),
        Is.from(t)
    );
}
var qs = {
    ...
    Xs = class {
                    ...
                    new window.MutationObserver((t) => {
                        ...
                        t.some(
                            ...
                            : N &&
                              ...
                              ? ((e.input.badSafariComposition = !0),
                                this.flushSoon())
                              : this.flush();
                    })),
                Js &&
        ...
        start() {
            (this.observer &&
                ...
                this.observer.observe(this.view.dom, qs)),
                this.onCharData &&
        ...
        onSelectionChange() {
            if (no(this.view)) {
                if (this.suppressingSelectionUpdates) return Ka(this.view);
                if (Ei && Di <= 11 && !this.view.state.selection.empty) {
        ...
        ignoreSelectionChange(e) {
            ...
            let t = new Set(),
                n;
            for (let n = e.focusNode; n; n = ii(n)) t.add(n);
            for (let r = e.anchorNode; r; r = ii(r))
                if (t.has(r)) {
                    n = r;
                    break;
                }
        ...
        flush() {
            ...
            c.eq(E.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  ...
                  e.scrollToSelection())
                : (i > -1 || r) &&
                  (i > -1 && (e.docView.markDirty(i, a), $s(e)),
                  e.input.badSafariComposition &&
                      ((e.input.badSafariComposition = !1), rc(e, s)),
                  this.handleDOMChange(i, a, o, s),
                  e.docView && e.docView.dirty
                      ? e.updateState(e.state)
                      : this.currentSelection.eq(n) || Ka(e),
                  this.currentSelection.set(n));
        }
        registerMutation(e, t) {
            ...
            if (e.type == `childList`) {
                for (let n = 0; n < e.addedNodes.length; n++) {
                    ...
                    (t.push(r),
                        r.nodeType == 3 && (this.lastChangedTextNode = r));
                }
                if (
                    n.contentDOM &&
                    n.contentDOM != n.dom &&
                ...
                let r = e.previousSibling,
                    i = e.nextSibling;
                if (Ei && Di <= 11 && e.addedNodes.length)
                    for (let t = 0; t < e.addedNodes.length; t++) {
                        let { previousSibling: n, nextSibling: a } =
                            e.addedNodes[t];
                        ((!n ||
                            Array.prototype.indexOf.call(e.addedNodes, n) <
                                0) &&
                            (r = n),
                            (!a ||
                                Array.prototype.indexOf.call(e.addedNodes, a) <
                                    0) &&
                                (i = a));
                    }
...
function $s(e) {
    if (
        ...
        if (((e.requiresGeckoHackNode = Oi), Qs)) return;
        (console.warn(
...
function ec(e, t) {
    ...
    return (
        ci(o.node, o.offset, i, a) && ([n, r, i, a] = [i, a, n, r]),
...
function ic(e, t, n) {
    ...
    if (
        (u &&
            ...
            gi(c) || l.push({ node: c.focusNode, offset: c.focusOffset })),
        M && e.input.lastKeyCode === 8)
    )
        for (let e = a; e > i; e--) {
    ...
    let d = e.state.doc,
        f = e.someProp(`domParser`) || ft.fromSchema(e.state.schema),
        p = d.resolve(o),
        m = null,
        h = f.parse(r, {
            topNode: p.parent,
...
function sc(e, t, n, r, i) {
    ...
    if (((e.input.compositionPendingChanges = 0), t < 0)) {
        ...
        if (n && !e.state.selection.eq(n)) {
            if (
                ...
                e.someProp(`handleKeyDown`, (t) => t(e, _i(13, `Enter`)))
            )
                return;
    ...
    let m = fc(d.content, l.doc.content, l.from, f, p);
    if (
        (m && e.input.domChangeCount++,
        ((ji && e.input.lastIOSEnter > Date.now() - 225) || Pi) &&
            i.some((e) => e.nodeType == 1 && !oc.test(e.nodeName)) &&
            (!m || m.endA >= m.endB) &&
            e.someProp(`handleKeyDown`, (t) => t(e, _i(13, `Enter`))))
    ) {
        e.input.lastIOSEnter = 0;
    ...
    if (
        ...
        uc(u, m.start, m.endA, h, g) &&
        e.someProp(`handleKeyDown`, (t) => t(e, _i(8, `Backspace`)))
    ) {
        Pi && M && e.domObserver.suppressSelectionUpdates();
        return;
    }
    (M && m.endB == m.start && (e.input.lastChromeDelete = Date.now()),
        Pi &&
            !v &&
            h.start() != g.start() &&
            g.parentOffset == 0 &&
    ...
    if (v)
        if (h.pos == g.pos) {
            Ei &&
                ...
                setTimeout(() => Ka(e), 20));
            let t = ee(e.state.tr.delete(y, b)),
            ...
            let t = ee(e.state.tr);
            (te.type == `add`
                ? t.addMark(y, b, te.mark)
                : t.removeMark(y, b, te.mark),
                e.dispatch(t));
        } else if (
            ...
            let t = h.parent.textBetween(h.parentOffset, g.parentOffset),
                n = () => ee(e.state.tr.insertText(t, y, b));
            e.someProp(`handleTextInput`, (r) => r(e, y, b, t, n)) ||
                e.dispatch(n());
        } else e.dispatch(ee());
    else e.dispatch(ee());
}
...
function lc(e, t) {
    ...
    if (i.length == 1 && a.length == 0)
        ...
        ((s = a[0]),
            (o = `remove`),
            (c = (e) => e.mark(s.removeFromSet(e.marks))));
    else return null;
    let l = [];
...
function uc(e, t, n, r, i) {
    if (n - t <= i.pos - r.pos || dc(r, !0, !1) < i.pos) return !1;
    let a = e.resolve(t);
    if (!r.parent.isTextblock) {
        let e = a.nodeAfter;
    ...
    if (a.parentOffset < a.parent.content.size || !a.parent.isTextblock)
        return !1;
    let o = e.resolve(dc(a, !0, !0));
    return !o.parent.isTextblock || o.pos > n || dc(o, !0, !1) < n
        ? !1
...
var mc = class {
    constructor(e, t) {
        ((this._root = null),
            ...
            (this.editable = _c(this)),
            gc(this),
            (this.nodeViews = yc(this)),
            (this.docView = wa(
                this.state.doc,
                hc(this),
                Ks(this),
            ...
            (this.domObserver = new Xs(this, (e, t, n, r) =>
                sc(this, e, t, n, r),
            )),
    ...
    update(e) {
        e.handleDOMEvents != this._props.handleDOMEvents && qo(this);
        let t = this._props;
        ((this._props = e),
            e.plugins &&
    ...
    updateStateInner(e, t) {
        let n = this.state,
            r = !1,
            i = !1;
        (e.storedMarks && this.composing && (hs(this), (i = !0)),
            (this.state = e));
        ...
        if (
            ...
            let e = yc(this);
            bc(e, this.nodeViews) && ((this.nodeViews = e), (r = !0));
        }
        ((a || t.handleDOMEvents != this._props.handleDOMEvents) && qo(this),
            (this.editable = _c(this)),
            gc(this));
        let o = Ks(this),
            s = hc(this),
        ...
        if (i) {
            ...
            !(
                ...
                ? Ka(this, t)
                : ($a(this, e.selection), this.domObserver.setCurSelection()),
                this.domObserver.start());
        }
    ...
    updateDraggedNode(e, t) {
        ...
        this.dragging = new Ts(
            e.slice,
            e.move,
            r < 0 ? void 0 : O.create(this.state.doc, r),
        );
    }
    someProp(e, t) {
    ...
    pasteHTML(e, t) {
        return Cs(this, ``, e, !1, t || new ClipboardEvent(`paste`));
    }
    pasteText(e, t) {
        return Cs(this, e, null, !0, t || new ClipboardEvent(`paste`));
    }
    ...
    destroy() {
        this.docView &&
            ...
            this.destroyPluginViews(),
            this.mounted
                ? (this.docView.update(this.state.doc, [], Ks(this), this),
    ...
    domSelectionRange() {
        ...
        return e
            ? (N &&
                  ...
                  vi(this.dom.ownerDocument) == this.dom &&
                  tc(this, e)) ||
                  e
            : {
                  focusNode: null,
...
mc.prototype.dispatch = function (e) {
...
function hc(e) {
    ...
    return (
        ...
        (t.translate ||= `no`),
        [Ns.node(0, e.state.doc.content.size, t)]
    );
}
function gc(e) {
    if (e.markCursor) {
        ...
        ((t.className = `ProseMirror-separator`),
            ...
            (e.cursorWrapper = {
                dom: t,
                deco: Ns.widget(e.state.selection.from, t, {
                    raw: !0,
                    marks: e.markCursor,
                }),
            }));
...
for (
    var Sc = {
        ...
        wc = typeof navigator < `u` && /Mac/.test(navigator.platform),
        Tc =
            typeof navigator < `u` &&
    ...
    Sc[48 + R] = Sc[96 + R] = String(R);
for (var R = 1; R <= 24; R++) Sc[R + 111] = `F` + R;
for (var R = 65; R <= 90; R++)
    ((Sc[R] = String.fromCharCode(R + 32)), (Cc[R] = String.fromCharCode(R)));
for (var Ec in Sc) Cc.hasOwnProperty(Ec) || (Cc[Ec] = Sc[Ec]);
function Dc(e) {
    var t =
        (!(
            (wc && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
            (Tc && e.shiftKey && e.key && e.key.length == 1) ||
            e.key == `Unidentified`
        ) &&
            e.key) ||
        (e.shiftKey ? Cc : Sc)[e.keyCode] ||
        e.key ||
        `Unidentified`;
    return (
        t == `Esc` && (t = `Escape`),
...
var Oc =
    ...
    kc = typeof navigator < `u` && /Win/.test(navigator.platform);
function Ac(e) {
    let t = e.split(/-(?!$)/),
        n = t[t.length - 1];
    n == `Space` && (n = ` `);
...
function Nc(e) {
    return new k({ props: { handleKeyDown: Pc(e) } });
}
function Pc(e) {
    let t = jc(e);
    return function (e, n) {
        ...
        buildProps(e, t = !0) {
            let { rawCommands: n, editor: r, state: i } = this,
                ...
                o = {
                    ...
                    editor: r,
                    view: a,
                    state: Lc({ state: i, transaction: e }),
...
var qc =
    ...
    Yc = (e) => (e.content ? /^text(\*|\+)/.test(e.content) : !1),
    Xc = (e, t, n) => {
        if (
            !e.parent.isInline ||
    ...
    Zc = (e, t, n) => ({ from: Xc(e, n, `left`), to: Xc(t, n, `right`) }),
    Qc =
        () =>
        ({ state: e, dispatch: t }) => {
            let { $from: n, $to: r } = e.selection;
            if (e.selection.empty) return !1;
            let { from: i, to: a } = Zc(n, r, e.schema);
            return (
                t && (e.tr.deleteRange(i, a).scrollIntoView(), t(e.tr)),
                !0
            );
        },
    $c =
...
function rl(e, t, n = {}) {
    return e.find(
        (e) =>
            e.type === t &&
            nl(
                Object.fromEntries(Object.keys(n).map((t) => [t, e.attrs[t]])),
                n,
            ),
    );
}
...
function al(e, t, n) {
    ...
    let i = r.index,
        ...
        o = i + 1,
        s = a + r.node.nodeSize;
    for (; i > 0 && il([...e.parent.child(i - 1).marks], t, n); )
        (--i, (a -= e.parent.child(i).nodeSize));
    for (; o < e.parent.childCount && il([...e.parent.child(o).marks], t, n); )
...
function dl(e, t = null) {
    ...
    let i = n.from,
        a = r.to;
    return t === `all`
        ? D.create(e, ul(0, i, a), ul(e.content.size, i, a))
        : D.create(e, ul(t, i, a), ul(t, i, a));
}
function fl() {
    return (
...
var hl =
        ...
        ({ editor: n, view: r, tr: i, dispatch: a }) => {
            ...
            let o = () => {
                ((pl() || fl()) && r.dom.focus(),
                    ...
                    requestAnimationFrame(() => {
                        n.isDestroyed ||
                            (r.focus(),
                            t?.scrollIntoView && n.commands.scrollIntoView());
                    }));
            };
            try {
            ...
            let s = dl(i.doc, e) || n.state.selection,
    ...
    gl = (e, t) => (n) => e.every((e, r) => t(e, { ...n, index: r })),
    _l =
        (e, t) =>
        ({ tr: n, commands: r }) =>
            r.insertContentAt(
...
function bl(e, t, n) {
    if (e instanceof Le || e instanceof S) return e;
    ...
    if (r)
        try {
            ...
            if (n.errorOnInvalidContent)
                throw Error(`[tiptap error]: Invalid JSON content`, {
                    cause: r,
                });
            return (
                console.warn(
    ...
    if (i) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? ft.fromSchema(a).parseSlice(yl(e), n.parseOptions)
                    : ft.fromSchema(a).parse(yl(e), n.parseOptions),
        ...
        let r = ft.fromSchema(t);
        return n.slice
            ? r.parseSlice(yl(e), n.parseOptions).content
            : r.parse(yl(e), n.parseOptions);
    }
    return bl(``, t, n);
}
function xl(e, t, n) {
    ...
    Cl =
        ...
        ({ tr: r, dispatch: i, editor: a }) => {
            if (i) {
                        ...
                        a.emit(`contentError`, {
                            ...
                            disableCollaboration: () => {
                                `collaboration` in a.storage &&
                                    typeof a.storage.collaboration ==
                                        `object` &&
                ...
                (n.updateSelection && xl(r, r.steps.length - 1, -1),
                    n.applyInputRules &&
...
function Nl(e) {
    ...
    for (let e = 0; e < t.length - 1; e += 1) {
        ...
        else if (/^mod$/i.test(n)) pl() || Ml() ? (o = !0) : (i = !0);
        else throw Error(`Unrecognized modifier name: ${n}`);
    }
    return (
        r && (n = `Alt-${n}`),
...
function Fl(e, t, n = {}) {
    ...
    let c = i - r,
        l = s
            ...
            .filter((e) => nl(e.node.attrs, n, { strict: !1 }));
    return a ? !!l.length : l.reduce((e, t) => e + t.to - t.from, 0) >= c;
}
var Il =
        (e, t = {}) =>
        ({ state: n, dispatch: r }) =>
            Fl(n, B(e, n.schema), t) ? kr(n, r) : !1,
    Ll =
        () =>
        ({ state: e, dispatch: t }) =>
            Pr(e, t),
...
var Hl =
        ...
        ({ tr: n, state: r, dispatch: i }) => {
            let a = null,
                o = null,
                s = Bl(typeof e == `string` ? e : e.name, r.schema);
            if (!s) return !1;
            (s === `node` && (a = B(e, r.schema)),
                s === `mark` && (o = ol(e, r.schema)));
            let c = !1;
            return (
                n.selection.ranges.forEach((e) => {
                    r.doc.nodesBetween(e.$from.pos, e.$to.pos, (e, r) => {
                        (a &&
                            a === e.type &&
                            ((c = !0),
                            i && n.setNodeMarkup(r, void 0, Vl(e.attrs, t))),
                            o &&
                                e.marks.length &&
                                e.marks.forEach((a) => {
                                    o === a.type &&
...
function au(e, t) {
    let n = Et.fromSchema(t).serializeFragment(e),
...
function H(e, t = void 0, ...n) {
    return ou(e) ? (t ? e.bind(t)(...n) : e(...n)) : e;
}
function su(e = {}) {
...
function lu(e) {
    let t = [],
        { nodeExtensions: n, markExtensions: r } = cu(e),
        i = [...n, ...r],
        a = {
            default: null,
            validate: void 0,
...
function gu(e) {
    ...
    return (
        ...
        e?.attribute?.validate !== void 0 &&
            (t.validate = e.attribute.validate),
        [e.name, t]
    );
}
function _u(e, t) {
    let n = lu(e),
        { nodeExtensions: r, markExtensions: i } = cu(e);
    return new ct({
                ...
                let i = n.filter((e) => e.type === r.name),
                    ...
                    o = hu({
                        ...
                        linebreakReplacement: H(
                            V(r, `linebreakReplacement`, a),
                        ),
                        defining: H(V(r, `defining`, a)),
                        isolating: H(V(r, `isolating`, a)),
                        attrs: Object.fromEntries(i.map(gu)),
                    }),
                    s = H(V(r, `parseHTML`, a));
                s && (o.parseDOM = s.map((e) => mu(e, i)));
                let c = V(r, `renderHTML`, a);
                c &&
                    (o.toDOM = (e) => c({ node: e, HTMLAttributes: fu(e, i) }));
        ...
        marks: Object.fromEntries(
            i.map((r) => {
                ...
                return (
                    c &&
                        (o.toDOM = (e) =>
                            c({ mark: e, HTMLAttributes: fu(e, i) })),
                    [r.name, o]
                );
            }),
        ),
...
function Su(e, t) {
    return xu(e, { from: 0, to: e.content.size }, t);
}
function Cu(e) {
    return Object.fromEntries(
...
function Tu(e, t) {
    ...
    return n === `node` ? wu(e, t) : n === `mark` ? Ql(e, t) : {};
}
function Eu(e, t = JSON.stringify) {
    let n = {};
    return e.filter((e) => {
        let r = t(e);
...
function Pu(e, t, n = {}) {
    ...
    if (
        (i.forEach(({ $from: t, $to: n }) => {
            let r = t.pos,
                i = n.pos;
            e.doc.nodesBetween(r, i, (e, t) => {
                if (a && e.inlineContent && !e.type.allowsMarkType(a))
                    return !1;
                ...
                ((o += l),
                    s.push(
                        ...e.marks.map((e) => ({ mark: e, from: n, to: c })),
                    ));
            });
        }),
        o === 0)
    ...
    let c = s
            ...
            .filter((e) => nl(e.mark.attrs, n, { strict: !1 }))
            .reduce((e, t) => e + t.to - t.from, 0),
        l = s
            .filter((e) =>
                a ? e.mark.type !== a && e.mark.type.excludes(a) : !0,
            )
            .reduce((e, t) => e + t.to - t.from, 0);
    return (c > 0 ? c + l : c) >= o;
}
function Fu(e, t, n = {}) {
    if (!t) return Fl(e, null, n) || Pu(e, null, n);
    let r = Bl(t, e.schema);
    return r === `node` ? Fl(e, t, n) : r === `mark` ? Pu(e, t, n) : !1;
}
var Iu = (e, t) => {
        let { $from: n, $to: r, $anchor: i } = e.selection;
        if (t) {
            let n = ru((e) => e.type.name === t)(e.selection);
            if (!n) return !1;
...
function zu(e, t) {
    let { nodeExtensions: n } = cu(t),
        r = n.find((t) => t.name === e);
    if (!r) return !1;
    let i = H(
        V(r, `group`, { name: r.name, options: r.options, storage: r.storage }),
    );
    return typeof i == `string` ? i.split(` `).includes(`list`) : !1;
}
function Bu(e, { checkChildren: t = !0, ignoreWhitespace: n = !1 } = {}) {
    if (n) {
    ...
    if (t) {
        ...
        return (
            e.content.forEach((e) => {
                r !== !1 &&
                    (Bu(e, { ignoreWhitespace: n, checkChildren: t }) ||
                        (r = !1));
            }),
            r
        );
...
function Uu(e, t) {
    ...
    return { position: new Hu(n.pos), mapResult: n };
}
function Wu(e) {
    return new Hu(e);
}
function Gu(e, t, n) {
    ...
    return a.some(({ $from: t, $to: r }) => {
        let i =
            t.depth === 0
                ? e.doc.inlineContent && e.doc.type.allowsMarkType(n)
                : !1;
        return (
            ...
            return (
                ...
                i &&
                    n.doc.nodesBetween(o, s, (t, r) => {
                        t.isText ||
                            n.setNodeMarkup(r, void 0, { ...t.attrs, dir: e });
                    }),
                !0
            );
        },
...
var ed =
        ...
        ({ tr: t, state: n, dispatch: r, editor: i }) => {
            let { selection: a, doc: o } = t,
                ...
                u = Mu(l, s.node().type.name, s.node().attrs);
            if (a instanceof O && a.node.isBlock)
                return !s.parentOffset || !vn(o, s.pos)
                    ? !1
                    : (r &&
                          (e && $u(n, i.extensionManager.splittableMarks),
            ...
            let d = c.parentOffset === c.parent.content.size,
                f =
                    s.depth === 0
                        ? void 0
                        : eu(s.node(-1).contentMatchAt(s.indexAfter(-1))),
                p = d && f ? [{ type: f, attrs: u }] : void 0,
                m = vn(t.doc, t.mapping.map(s.pos), 1, p);
            if (
                (!p &&
                    !m &&
                    vn(
                ...
                if (
                    m &&
                    (a instanceof D && t.deleteSelection(),
            ...
            if (
                ...
                if (i) {
                    ...
                    let i =
                        ...
                        c =
                            o.contentMatch.defaultType?.createAndFill(a) ||
                            void 0;
                    ...
                    (n.doc.nodesBetween(l, n.doc.content.size, (e, t) => {
                        ...
                        u > -1 && n.setSelection(D.near(n.doc.resolve(u))),
                        n.scrollIntoView());
                }
                return !0;
            }
            let f = c.pos === s.end() ? u.contentMatchAt(0).defaultType : null,
                p = { ...Mu(d, u.type.name, u.attrs), ...t },
                m = { ...Mu(d, s.node().type.name, s.node().attrs), ...t };
    ...
    nd = (e, t) => {
        let n = ru((e) => e.type === t)(e.selection);
        if (!n) return !0;
        let r = e.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
        if (r === void 0) return !0;
        let i = e.doc.nodeAt(r);
        return (
            n.node.type === i?.type && bn(e.doc, n.pos) && e.join(n.pos),
            !0
        );
    },
    rd = (e, t) => {
        ...
        if (r === void 0) return !0;
        let i = e.doc.nodeAt(r);
        return (n.node.type === i?.type && bn(e.doc, r) && e.join(r), !0);
    };
function id(e) {
    let t = e.doc,
        n = t.firstChild;
...
var ad =
        ...
        ({
            ...
            let { extensions: d, splittableMarks: f } = i.extensionManager,
                ...
                { $from: _, $to: v } = h,
                y = _.blockRange(v),
                b = g || (h.$to.parentOffset && h.$from.marks());
            if (!y) return !1;
            let ee = ru((e) => zu(e.type.name, d))(h),
                te = h.from === 0 && h.to === o.doc.content.size,
                ne = o.doc.content.content,
                re = ne.length === 1 ? ne[0] : null,
                ie =
                    te && re && zu(re.type.name, d)
                        ? { node: re, pos: 0, depth: 0 }
                        : null,
                ae = ee ?? ie,
                oe = !!ee && y.depth >= 1 && y.depth - ee.depth <= 1,
                se = !!ie;
            if ((oe || se) && ae) {
                if (ae.node.type === p)
                    return te && se
                        ? c()
                              .command(({ tr: e, dispatch: t }) => {
                                  let n = id(e);
                                  return n
                                      ? (e.setSelection(n), t && t(e), !0)
                                      : !1;
                              })
                              .liftListItem(m)
                              .run()
                        : l.liftListItem(m);
                if (zu(ae.node.type.name, d) && p.validContent(ae.node.content))
                    return c()
                        .command(() => (a.setNodeMarkup(ae.pos, p), !0))
                        .command(() => nd(a, p))
                        .command(() => rd(a, p))
                        .run();
            }
            return !n || !b || !s
                ? c()
                      .command(() =>
                          u().wrapInList(p, r) ? !0 : l.clearNodes(),
                      )
                      .wrapInList(p, r)
                      .command(() => nd(a, p))
                      .command(() => rd(a, p))
                ...
                : c()
                      .command(() => {
                          let e = u().wrapInList(p, r),
                              t = b.filter((e) => f.includes(e.type.name));
    ...
    cd =
        ...
        ({ state: n, commands: r }) => {
            let i = B(e, n.schema);
            return Fl(n, i, t) ? r.lift(i) : r.wrapIn(i, t);
        },
    ld =
        () =>
        ({ state: e, dispatch: t }) => {
    ...
    dd =
        ...
        ({ tr: n, state: r, dispatch: i }) => {
            ...
            if (l && a) {
                let { from: e, to: t } = o,
                    r = al(c, s, c.marks().find((e) => e.type === s)?.attrs);
    ...
    md =
        (e, t = {}) =>
        ({ state: n, dispatch: r }) =>
            Wr(B(e, n.schema), t)(n, r),
    hd =
        (e, t = {}) =>
        ({ state: n, dispatch: r }) =>
            Zr(B(e, n.schema), t)(n, r),
    gd = class {
        constructor() {
            this.callbacks = {};
        }
...
function yd(e) {
    ...
    return (
        a.forEach((e) => {
            ...
            if (!a) return;
            let c = s.state.tr,
                d = Lc({ state: s.state, transaction: c }),
                f = { from: n - (a[0].length - i.length), to: r },
                {
                    commands: p,
                    chain: m,
                    can: h,
                } = new Rc({ editor: t, state: d });
            e.handler({
                state: d,
                range: f,
                match: a,
                ...
                !c.steps.length ||
                (e.undoable &&
                    c.setMeta(o, { transform: c, from: n, to: r, text: i }),
                s.dispatch(c),
                (l = !0));
        }),
        l
    ...
    return (
        Sd(e) &&
            ...
            Object.keys(t).forEach((r) => {
                Sd(t[r]) && Sd(e[r]) ? (n[r] = Cd(e[r], t[r])) : (n[r] = t[r]);
            }),
        n
    );
}
...
function kd(e) {
    let {
        ...
        { commands: c, chain: l, can: u } = new Rc({ editor: t, state: n }),
        d = [];
    return (
    ...
    let c = ({ state: e, from: n, to: r, rule: i, pasteEvt: a }) => {
        ...
        if (
            !(
                !kd({
                    editor: t,
                    state: Lc({ state: e, transaction: c }),
                    from: Math.max(n - 1, 0),
                    to: r.b - 1,
                    rule: i,
                    pasteEvent: a,
        ...
        (e) =>
            new k({
                ...
                appendTransaction: (t, n, r) => {
                    ...
                    if (f) {
                        let { text: t } = d;
                        t = typeof t == `string` ? t : au(S.from(t), r.schema);
                        let { from: n } = d,
                            i = n + t.length,
                            a = jd(t);
                        return c({
...
var Nd = class {
    constructor(e, t) {
        ((this.splittableMarks = []),
            ...
            (this.extensions = bu(e)),
            (this.schema = _u(this.extensions, t)),
    ...
    get plugins() {
        let { editor: e } = this;
        return yu([...this.extensions].reverse()).flatMap((t) => {
            let n = {
                    name: t.name,
                    options: t.options,
                    storage: this.editor.extensionStorage[t.name],
                ...
                r = [],
                i = V(t, `addKeyboardShortcuts`, n),
                a = {};
            if (
                (t.type === `mark` &&
                    V(t, `exitable`, n) &&
                    (a.ArrowRight = () =>
                        Td.handleExit({ editor: e, mark: t })),
                i)
            ) {
                let t = Object.fromEntries(
                    Object.entries(i()).map(([t, n]) => [
                        t,
                        () => n({ editor: e }),
                    ]),
                );
            ...
            if (Ru(t, e.options.enableInputRules) && s) {
                let t = s();
                if (t && t.length) {
                    let n = bd({ editor: e, rules: t }),
                        i = Array.isArray(n) ? n : [n];
                    r.push(...i);
                }
            }
            let c = V(t, `addPasteRules`, n);
            if (Ru(t, e.options.enablePasteRules) && c) {
                let t = c();
                if (t && t.length) {
                    let n = Md({ editor: e, rules: t });
                    r.push(...n);
                }
            }
    ...
    get nodeViews() {
        let { editor: e } = this,
            { nodeExtensions: t } = cu(this.extensions);
        return Object.fromEntries(
            t
                .filter((e) => !!V(e, `addNodeView`))
                .map((t) => {
    ...
    dispatchTransaction(e) {
        let { editor: t } = this;
        return yu([...this.extensions].reverse()).reduceRight((e, n) => {
            let r = {
                    name: n.name,
                    options: n.options,
                    storage: this.editor.extensionStorage[n.name],
                    editor: t,
                    type: ju(n.name, this.schema),
                },
    ...
    transformPastedHTML(e) {
        let { editor: t } = this;
        return yu([...this.extensions]).reduce(
            (e, n) => {
                let r = {
                        name: n.name,
                        options: n.options,
    ...
    get markViews() {
        let { editor: e } = this,
            { markExtensions: t } = cu(this.extensions);
        return Object.fromEntries(
            t
                .filter((e) => !!V(e, `addMarkView`))
                .map((t) => {
                    let n = this.attributes.filter((e) => e.type === t.name),
                        r = V(t, `addMarkView`, {
                            name: t.name,
        ...
        ((this.editor.extensionStorage = Object.fromEntries(
            ...
            e.forEach((e) => {
                let t = {
                    ...
                    editor: this.editor,
                    type: ju(e.name, this.schema),
                };
                e.type === `mark` &&
                    (H(V(e, `keepOnSplit`, t)) ?? !0) &&
                    this.splittableMarks.push(e.name);
                let n = V(e, `onBeforeCreate`, t),
                    r = V(e, `onCreate`, t),
                    i = V(e, `onUpdate`, t),
                    a = V(e, `onSelectionUpdate`, t),
                    o = V(e, `onTransaction`, t),
                    s = V(e, `onFocus`, t),
                    c = V(e, `onBlur`, t),
                    l = V(e, `onDestroy`, t);
...
((Nd.resolve = bu),
    ...
    Ic(
        {},
        {
            ...
            Tabindex: () => Ud,
            TextDirection: () => Wd,
            focusEventsPluginKey: () => zd,
        },
    ));
var W = class e extends wd {
        constructor() {
                    ...
                    props: {
                        clipboardTextSerializer: () => {
                            let { editor: e } = this,
                                ...
                                { doc: r, selection: i } = t,
                                { ranges: a } = i,
                                o = Math.min(...a.map((e) => e.$from.pos)),
                                s = Math.max(...a.map((e) => e.$to.pos)),
                                c = Cu(n);
                            return xu(
                                r,
                                { from: o, to: s },
                ...
                new k({
                    ...
                    appendTransaction: (e, t, n) => {
                        ...
                        let r = e.some((e) => e.docChanged) && !t.doc.eq(n.doc),
                            i = e.some((e) =>
                                e.getMeta(`preventClearDocument`),
                            );
                        if (!r || i) return;
                        let { empty: a, from: o, to: s } = t.selection,
                            c = E.atStart(t.doc).from,
                            l = E.atEnd(t.doc).to;
                        if (a || !(o === c && s === l) || !Bu(n.doc)) return;
                        let u = n.tr,
                            d = Lc({ state: n, transaction: u }),
                            { commands: f } = new Rc({
                                editor: this.editor,
                                state: d,
                            });
    ...
    Wd = W.create({
        ...
        addGlobalAttributes() {
            ...
            let { nodeExtensions: e } = cu(this.extensions);
            return [
                {
                    types: e
...
var Jd = class extends gd {
    constructor(e = {}) {
        (super(),
            ...
            (this.utils = {
                getUpdatedPosition: Uu,
                createMappablePosition: Wu,
            }),
            this.setOptions(e),
        ...
        let t = this.createDoc(),
            n = dl(t, this.options.autofocus);
        ((this.editorState = ur.create({
            doc: t,
            schema: this.schema,
            selection: n || void 0,
        })),
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < `u` &&
            (this.css = qd(Kd, this.options.injectNonce));
    }
    setOptions(e = {}) {
    ...
    createExtensionManager() {
        let e = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      Pd.configure({
                          blockSeparator:
                              this.options.coreExtensionOptions
                      ...
                      Vd,
                      Ud.configure({
                          value: this.options.coreExtensionOptions?.tabindex
                              ?.value,
                      }),
                      Ld,
                      Hd,
                      Id,
                      Wd.configure({ direction: this.options.textDirection }),
                  ].filter((e) =>
        ...
        this.extensionManager = new Nd(e, this);
    }
    ...
    dispatchTransaction(e) {
        ...
        (this.view.updateState(t),
            ...
            r &&
                this.emit(`selectionUpdate`, { editor: this, transaction: e }));
    ...
    isActive(e, t) {
        ...
        return Fu(this.state, n, r);
    }
    getJSON() {
        return this.state.doc.toJSON();
    }
    getHTML() {
        return au(this.state.doc.content, this.schema);
    }
    getText(e) {
        let {
            blockSeparator: t = `
...
`,
        ...
        return Su(this.state.doc, {
            blockSeparator: t,
            textSerializers: { ...Cu(this.schema), ...n },
        });
    }
    get isEmpty() {
    ...
    $pos(e) {
        let t = this.state.doc.resolve(e),
            n =
                e > 0 && t.nodeAfter && !t.nodeAfter.isText
                    ? t.nodeAfter
                    : null;
        return new Gd(t, this, !1, n);
    }
    get $doc() {
        return this.$pos(0);
    }
        ...
        handler: ({ state: t, range: n, match: r }) => {
            ...
            if (o) {
                ...
                if (
                    ...
                    return null;
                (l < n.to && a.delete(l, n.to),
                    c > n.from && a.delete(n.from + r, c));
    ...
    return new _d({
        ...
        handler: ({ state: t, range: n, match: r }) => {
            let i = t.doc.resolve(n.from),
                a = H(e.getAttributes, void 0, r) || {};
            if (
                !i
                    .node(-1)
                    .canReplaceWith(i.index(-1), i.indexAfter(-1), e.type)
            )
                return null;
...
function Qd(e) {
    return new _d({
        ...
        handler: ({ state: t, range: n, match: r, chain: i }) => {
            let a = H(e.getAttributes, void 0, r) || {},
            ...
            if (e.keepAttributes) {
                let t =
                    e.type.name === `bulletList` ||
                    e.type.name === `orderedList`
                        ? `listItem`
                        : `taskList`;
...
Ic(
    {},
    {
        createAtomBlockMarkdownSpec: () => nf,
        createBlockMarkdownSpec: () => rf,
        createInlineMarkdownSpec: () => sf,
        parseAttributes: () => ef,
        parseIndentedBlocks: () => cf,
        renderNestedMarkdownContent: () => lf,
        serializeAttributes: () => tf,
    },
);
function ef(e) {
    if (!e?.trim()) return {};
...
function nf(e) {
    let {
            nodeName: t,
            name: n,
            parseAttributes: r = ef,
            serializeAttributes: i = tf,
            defaultAttributes: a = {},
...
function rf(e) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: i = ef,
            serializeAttributes: a = tf,
            defaultAttributes: o = {},
            content: s = `block`,
            allowedAttributes: c,
        } = e,
...
function sf(e) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: i = af,
            serializeAttributes: a = of,
            defaultAttributes: o = {},
            selfClosing: s = !1,
            allowedAttributes: c,
        } = e,
...
`);
            e.trim() &&
                (p = t.customNestedParser
                    ? t.customNestedParser(e)
                    : n.blockTokens(e));
        }
...
function lf(e, t, n, r) {
    ...
    return (
        o &&
            ...
            o.forEach((e, n) => {
                let r =
                    t.renderChild?.call(t, e, n + 1) ?? t.renderChildren([e]);
                if (r != null) {
                    let n = r
                        .split(
                            `
...
var pf = `ö`,
...
((Of.groups = {}),
    (Of.prototype = {
        ...
        tr(e, t, n, r) {
            ...
            let i;
            return (
                t && t.j ? (i = t) : ((i = new Of(t)), n && r && Ef(t, n, r)),
                this.jr.push([e, i]),
                i
            );
        },
                ...
                a &&
                    (r &&
                        (o.t && typeof o.t == `string`
                            ? Ef(a, Object.assign(Df(o.t, r), n), r)
                            : n && Ef(a, n, r)),
                    (o.t = a)),
                (i.j[e] = o),
                o
...
var G = (e, t, n, r, i) => e.ta(t, n, r, i),
    K = (e, t, n, r, i) => e.tr(t, n, r, i),
    kf = (e, t, n, r, i) => e.ts(t, n, r, i),
    q = (e, t, n, r, i) => e.tt(t, n, r, i),
    Af = `WORD`,
    jf = `UWORD`,
    Mf = `ASCIINUMERICAL`,
    Nf = `ALPHANUMERICAL`,
    ...
    qf = `CLOSEPAREN`,
    Jf = `OPENANGLEBRACKET`,
    Yf = `CLOSEANGLEBRACKET`,
    Xf = `FULLWIDTHLEFTPAREN`,
    Zf = `FULLWIDTHRIGHTPAREN`,
    Qf = `LEFTCORNERBRACKET`,
    $f = `RIGHTCORNERBRACKET`,
    ep = `LEFTWHITECORNERBRACKET`,
    tp = `RIGHTWHITECORNERBRACKET`,
    np = `FULLWIDTHLESSTHAN`,
    rp = `FULLWIDTHGREATERTHAN`,
    ip = `AMPERSAND`,
    ap = `APOSTROPHE`,
    op = `ASTERISK`,
    sp = `AT`,
    ...
    jp = Object.freeze({
        ...
        EQUALS: hp,
        EXCLAMATION: gp,
        FULLWIDTHGREATERTHAN: rp,
        FULLWIDTHLEFTPAREN: Xf,
        FULLWIDTHLESSTHAN: np,
        FULLWIDTHMIDDLEDOT: wp,
        FULLWIDTHRIGHTPAREN: Zf,
        HYPHEN: _p,
        LEFTCORNERBRACKET: Qf,
        LEFTWHITECORNERBRACKET: ep,
        LOCALHOST: Pf,
        NL: Vf,
        NUM: zf,
        OPENANGLEBRACKET: Jf,
...
function Wp(e = []) {
    ...
    ((Hp ??= Jp(pf)),
        ...
        q(n, `\\`, cp),
        q(n, `・`, wp));
    let r = K(n, Fp, zf, { [hf]: !0 });
    K(r, Fp, r);
    let i = K(r, Mp, Mf, { [vf]: !0 }),
        a = K(r, Np, Nf, { [yf]: !0 }),
        o = K(n, Mp, Af, { [gf]: !0 });
    (K(o, Fp, i), K(o, Mp, o), K(i, Fp, i), K(i, Mp, i));
    let s = K(n, Np, jf, { [_f]: !0 });
    (K(s, Mp), K(s, Fp, a), K(s, Np, s), K(a, Fp, a), K(a, Mp), K(a, Np, a));
    let c = q(n, Rp, Vf, { [wf]: !0 }),
        l = q(n, Lp, Bf, { [wf]: !0 }),
        u = K(n, Ip, Bf, { [wf]: !0 });
    (q(n, Vp, u),
        q(l, Rp, c),
        ...
        K(u, Ip, u),
        q(u, Vp, u));
    let d = K(n, Pp, kp, { [xf]: !0 });
    (q(d, `#`), K(d, Pp, d), q(d, zp, d));
    let f = q(d, Bp);
    (q(f, `#`), K(f, Pp, d));
    let p = [
            [Mp, o],
    ...
    for (let e = 0; e < Hp.length; e++) qp(n, Hp[e], Ff, Af, p);
    for (let e = 0; e < Up.length; e++) qp(n, Up[e], If, jf, m);
    (Ef(Ff, { tld: !0, ascii: !0 }, t),
        Ef(If, { utld: !0, alpha: !0 }, t),
        qp(n, `file`, Lf, Af, p),
        qp(n, `mailto`, Lf, Af, p),
        qp(n, `http`, Rf, Af, p),
        qp(n, `https`, Rf, Af, p),
        qp(n, `ftp`, Rf, Af, p),
        qp(n, `ftps`, Rf, Af, p),
        Ef(Lf, { scheme: !0, ascii: !0 }, t),
        Ef(Rf, { slashscheme: !0, ascii: !0 }, t),
    ...
    return (
        kf(n, `localhost`, Pf, { ascii: !0 }),
        (n.jd = new Of(Ap)),
        { start: n, tokens: Object.assign({ groups: t }, jp) }
    );
}
function Gp(e, t) {
    let n = Kp(t.replace(/[A-Z]/g, (e) => e.toLowerCase())),
        r = n.length,
        i = [],
        a = 0,
        o = 0;
...
function qp(e, t, n, r, i) {
    ...
    for (let n = 0; n < o - 1; n++) {
        ...
        (e.j[o]
            ? (a = e.j[o])
            : ((a = new Of(r)), (a.jr = i.slice()), (e.j[o] = a)),
            (e = a));
    }
    return ((a = new Of(n)), (a.jr = i.slice()), (e.j[t[o - 1]] = a), a);
}
function Jp(e) {
    let t = [],
        n = [],
...
function Xp(e, t = null) {
    let n = Object.assign({}, Yp);
    e && (n = Object.assign(n, e instanceof Xp ? e.o : e));
    let r = n.ignoreTags,
        i = [];
...
var em = $p(`email`, {
    ...
    rm = $p(`url`, {
        isLink: !0,
        toHref(e = Yp.defaultProtocol) {
            return this.hasProtocol() ? this.v : `${e}://${this.v}`;
        },
        hasProtocol() {
            let e = this.tk;
            return e.length >= 2 && e[0].t !== Pf && e[1].t === dp;
        },
    }),
    im = (e) => new Of(e);
function am({ groups: e }) {
    ...
    G(f, e.domain, d);
    let p = im(em);
    (G(f, e.tld, p), G(f, e.utld, p), q(l, Pf, p));
    let m = q(d, _p);
    (q(m, _p, m),
        G(m, e.domain, d),
        G(p, e.domain, d),
    ...
    let h = q(o, _p),
        g = q(o, mp);
    (q(h, _p, h), G(h, e.domain, o), G(g, r, a), G(g, e.domain, o));
    let _ = im(rm);
    (G(g, e.tld, _),
        G(g, e.utld, _),
        G(_, e.domain, o),
    ...
    return (q(i, Pf, _), q(i, Vf, nm), { start: i, tokens: jp });
}
function om(e, t, n) {
    let r = n.length,
        i = 0,
    ...
    return (o.length > 0 && a.push(sm(tm, t, o)), a);
}
function sm(e, t, n) {
    let r = n[0].s,
        i = n[n.length - 1].e;
...
var cm = (typeof console < `u` && console && console.warn) || (() => {}),
    lm = `until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.`,
    J = {
        scanner: null,
        parser: null,
        tokenQueue: [],
...
function dm(e, t = !1) {
    if (
        (J.initialized &&
            cm(
                `linkifyjs: already initialized - will not register custom scheme "${e}" ${lm}`,
            ),
...
function fm() {
    J.scanner = Wp(J.customSchemes);
    for (let e = 0; e < J.tokenQueue.length; e++)
        J.tokenQueue[e][1]({ scanner: J.scanner });
    J.parser = am(J.scanner.tokens);
    for (let e = 0; e < J.pluginQueue.length; e++)
        J.pluginQueue[e][1]({ scanner: J.scanner, parser: J.parser });
    return ((J.initialized = !0), J);
}
function pm(e) {
    return (
        J.initialized || fm(),
        om(J.parser.start, e, Gp(J.scanner.start, e))
    );
}
pm.scan = Gp;
...
function bm(e) {
    return new k({
        ...
        appendTransaction: (t, n, r) => {
            ...
            let { tr: o } = r;
            if (
                (Ou($l(n.doc, [...t])).forEach(({ newRange: t }) => {
                    let n = tu(r.doc, t, (e) => e.isTextblock),
                        i,
                        a;
                    if (n.length > 1)
                        ((i = n[0]),
                        ...
                        if (!_m.test(e)) return;
                        ((i = n[0]),
                            (a = r.doc.textBetween(i.pos, t.to, void 0, ` `)));
                    }
                    if (i && a) {
                        let t = a.split(gm).filter(Boolean);
                        if (t.length <= 0) return !1;
                        let n = t[t.length - 1],
                            s = i.pos + a.lastIndexOf(n);
                        if (!n) return !1;
                        let c = pm(n).map((t) => t.toObject(e.defaultProtocol));
                        if (!ym(c)) return !1;
                        c.filter((e) => e.isLink)
                            .map((e) => ({
                                ...e,
                            ...
                            .forEach((t) => {
                                ku(t.from, t.to, r.doc).some(
                                    (t) => t.mark.type === e.type,
                                ) ||
                                    o.addMark(
                                        t.from,
                                        t.to,
    ...
    return new k({
        ...
        props: {
            handlePaste: (t, n, r) => {
                ...
                let l = mm(c, { defaultProtocol: e.defaultProtocol }).find(
...
var wm = Td.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return this.options.isAllowedUri(e.href, {
                defaultValidate: (e) => !!Cm(e, this.options.protocols),
                protocols: this.options.protocols,
                defaultProtocol: this.options.defaultProtocol,
            })
                ? [`a`, U(this.options.HTMLAttributes, e), 0]
                : [`a`, U(this.options.HTMLAttributes, { ...e, href: `` }), 0];
        },
...
var Dm = class {
        ...
        updateOverlay() {
            ...
            if (
                ...
                ((c = e.left - s.scrollLeft * t),
                    (l = e.top - s.scrollTop * n));
            }
    ...
    Om = class e extends E {
        ...
        static valid(e) {
            let t = e.parent;
            if (t.inlineContent || !jm(e) || !Mm(e)) return !1;
        ...
        static findGapCursorFrom(t, n, r = !1) {
            search: for (;;) {
                ...
                for (let r = t.depth; ; r--) {
                    let o = t.node(r);
                    if (
                        n > 0 ? t.indexAfter(r) < o.childCount : t.index(r) > 0
                    ) {
...
((Om.prototype.visible = !1),
    (Om.findFrom = Om.findGapCursorFrom),
    E.jsonID(`gapcursor`, Om));
var km = class e {
    constructor(e) {
        this.pos = e;
    }
    ...
    resolve(e) {
        ...
        return Om.valid(t) ? new Om(t) : E.near(t);
    }
};
function Am(e) {
...
function jm(e) {
    for (let t = e.depth; t >= 0; t--) {
        ...
        for (let e = r.child(n - 1); ; e = e.lastChild) {
            if ((e.childCount == 0 && !e.inlineContent) || Am(e.type))
                return !0;
    ...
    return new k({
        props: {
            ...
            createSelectionBetween(e, t, n) {
                return t.pos == n.pos && Om.valid(n) ? new Om(n) : null;
            },
            handleClick: Im,
            handleKeyDown: Pm,
...
var Pm = Pc({
    ArrowLeft: Fm(`horiz`, -1),
    ArrowRight: Fm(`horiz`, 1),
    ArrowUp: Fm(`vert`, -1),
    ArrowDown: Fm(`vert`, 1),
});
function Fm(e, t) {
    ...
    return function (e, r, i) {
        ...
        let c = Om.findGapCursorFrom(o, t, s);
        return c ? (r && r(e.tr.setSelection(new Om(c))), !0) : !1;
    };
}
function Im(e, t, n) {
    if (!e || !e.editable) return !1;
    let r = e.state.doc.resolve(t);
    if (!Om.valid(r)) return !1;
    let i = e.posAtCoords({ left: n.clientX, top: n.clientY });
    return i && i.inside > -1 && O.isSelectable(e.state.doc.nodeAt(i.inside))
        ? !1
        : (e.dispatch(e.state.tr.setSelection(new Om(r))), !0);
}
function Lm(e, t) {
    if (
        t.inputType != `insertCompositionText` ||
        !(e.state.selection instanceof Om)
    )
        return !1;
    ...
    return (
        a.setSelection(D.near(a.doc.resolve(n.pos + 1))),
        e.dispatch(a),
        !1
    );
}
function Rm(e) {
    if (!(e.selection instanceof Om)) return null;
    let t = document.createElement(`div`);
    return (
        (t.className = `ProseMirror-gapcursor`),
        I.create(e.doc, [Ns.widget(e.selection.head, t, { key: `gapcursor` })])
    );
}
var zm = 200,
    Y = function () {};
((Y.prototype.append = function (e) {
    return e.length
        ? ((e = Y.from(e)),
          (!this.length && e) ||
              (e.length < zm && this.leafAppend(e)) ||
              (this.length < zm && e.leafPrepend(this)) ||
              this.appendInner(e))
        : this;
}),
    ...
    (Y.from = function (e) {
        return e instanceof Y ? e : e && e.length ? new Bm(e) : Y.empty;
    }));
var Bm = (function (e) {
    function t(t) {
...
var Vm = (function (e) {
        ...
        return (
            ...
            (t.prototype.forEachInner = function (e, t, n, r) {
                ...
                if (
                    (t < i &&
                        this.left.forEachInner(e, t, Math.min(n, i), r) ===
                            !1) ||
                    (n > i &&
    ...
    Um = class e {
        ...
        popEvent(t, n) {
            ...
            let i, a;
            n &&
                ((i = this.remapping(r, this.items.length)),
                (a = i.maps.length));
            let o = t.tr,
                s,
                c,
                    ...
                    (t, n) => {
                        ...
                        if (i) {
                            ...
                            (e &&
                                o.maybeStep(e).doc &&
                                ((n =
                                    o.mapping.maps[o.mapping.maps.length - 1]),
                                l.push(
                                    new Gm(
                                        n,
                                        void 0,
                        ...
                        if (t.selection)
                            return (
                                (s = i
                                    ? t.selection.map(i.slice(a))
                                    : t.selection),
                                (c = new e(
                                    this.items
                                        .slice(0, r)
                                        .append(u.reverse().concat(l)),
                                    this.eventCount - 1,
                                )),
                                !1
                            );
        ...
        addMaps(t) {
            return this.eventCount == 0
                ? this
                : new e(
                      this.items.append(t.map((e) => new Gm(e))),
                      this.eventCount,
                  );
        }
        rebased(t, n) {
            ...
            this.items.forEach((e) => {
                ...
                if (e.step) {
                    ...
                    (l && s++, r.push(new Gm(i, o, l)));
                } else r.push(new Gm(i));
            }, i);
            let l = [];
            for (let e = n; e < o; e++) l.push(new Gm(a.maps[e]));
        ...
        compress(t = this.items.length) {
            ...
            return (
                    ...
                    (e, o) => {
                        if (o >= t) (i.push(e), e.selection && a++);
                            ...
                            if ((r--, o && n.appendMap(o, r), t)) {
                                ...
                                s && a++;
                                let c = new Gm(o.invert(), t, s),
                                    l,
                                    u = i.length - 1;
                                (l = i.length && i[u].merge(c))
                                    ? (i[u] = l)
                                    : i.push(c);
                            }
                        } else e.map && r--;
                ...
                new e(Y.from(i.reverse()), a)
            );
        }
    };
Um.empty = new Um(Y.empty, 0);
function Wm(e, t) {
    let n;
    return (
        e.forEach((e, r) => {
...
function Jm(e, t, n, r) {
    ...
    n.getMeta(rh) && (e = new Km(e.done, e.undone, null, 0, -1));
    let o = n.getMeta(`appendedTransaction`);
    if (n.steps.length == 0) return e;
    if (o && o.getMeta(nh))
        return o.getMeta(nh).redo
            ? new Km(
                  e.done.addTransform(n, void 0, r, th(t)),
                  e.undone,
                  Xm(n.mapping.maps),
                  e.prevTime,
                  e.prevComposition,
            ...
            : new Km(
                  e.done,
                  e.undone.addTransform(n, void 0, r, th(t)),
                  null,
                  e.prevTime,
                  e.prevComposition,
              );
            ...
            a =
                ...
                (!o &&
                    ...
                    (e.prevTime < (n.time || 0) - r.newGroupDelay ||
                        !Ym(n, e.prevRanges))),
            s = o ? Zm(e.prevRanges, n.mapping) : Xm(n.mapping.maps);
        return new Km(
            e.done.addTransform(
                n,
...
function Qm(e, t, n) {
    ...
    let o = a.selection.resolve(a.transform.doc),
        ...
        c = new Km(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
    return a.transform
        .setSelection(o)
        .setMeta(nh, { redo: n, historyState: c });
}
var $m = !1,
    eh = null;
function th(e) {
...
var nh = new A(`history`),
    rh = new A(`closeHistory`);
function ih(e = {}) {
    return (
        ...
        new k({
            ...
            state: {
                init() {
                    return new Km(Um.empty, Um.empty, null, 0, -1);
                },
                apply(t, n, r) {
                    return Jm(n, r, t, e);
                },
...
function mh({ doc: e, view: t, scrollContainer: n }) {
    let r = t.dom.getBoundingClientRect(),
        i = n ? ph(n) : { top: 0, bottom: window.innerHeight },
        a = Math.max(r.top, i.top),
        o = Math.min(r.bottom, i.bottom);
...
var vh = new A(`tiptap__placeholder`),
    yh = W.create({
        name: `placeholder`,
        addOptions() {
            return {
        ...
        addProseMirrorPlugins() {
            let e = this.options.dataAttribute
                ? `data-${_h(this.options.dataAttribute)}`
                : `data-${gh}`;
            return [
                new k({
                    state: {
                                ...
                                : e.docChanged
                                  ? {
                                        topPos:
                                            t.topPos === null
                                                ? null
                                                : e.mapping.map(t.topPos),
                                        bottomPos:
                                            t.bottomPos === null
                                                ? null
                                                : e.mapping.map(t.bottomPos),
                                    }
                                  : t;
                        },
                    },
                        ...
                        let t = fh(e.dom),
                            n = () => {
                                let n = mh({
                                    ...
                                    r = vh.getState(e.state);
                                if (
                                    r.topPos === n.top &&
                                    r.bottomPos === n.bottom
                                )
                                    return;
                                let i = e.state.tr
                                    .setMeta(vh, { positions: n })
                                    .setMeta(`tiptap__viewportUpdate`, !0);
                                e.dispatch(i);
                            },
                            { call: r, cancel: i } = hh(n, 250),
                            a = t;
                        return (
                    ...
                    props: {
                        decorations: ({ doc: t, selection: n }) => {
                            ...
                            if (
                                ...
                                let n = vh.getState(this.editor.state),
                                    o = n.topPos ?? 0,
                                    s = n.bottomPos ?? t.content.size;
                                t.nodesBetween(o, s, (t, n) => {
                                    let o = r >= n && r <= n + t.nodeSize,
                                        s = !t.isLeaf && Bu(t);
                                    if (!t.type.isTextblock)
                                        return this.options.includeChildren;
                                    if (
                                        (o || !this.options.showOnlyCurrent) &&
                                        s
                                    ) {
                                        let r = uh({
                                            classes: {
                ...
                props: {
                    decorations(n) {
                        return n.selection.empty ||
                            ...
                            ? null
                            : I.create(n.doc, [
                                  Ns.inline(n.selection.from, n.selection.to, {
                                      class: t.className,
                                  }),
                              ]);
                    },
...
var xh = W.create({
                ...
                new k({
                    ...
                    state: {
                        init: (e, t) => {
                            ...
                            return !bh({ node: r, types: n });
                        },
                        apply: (e, t) => {
                            if (
                                !e.docChanged ||
                                e.getMeta(`__uniqueIDTransaction`)
                            )
                                return t;
    ...
    wh = Td.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`u`, U(this.options.HTMLAttributes, e), 0];
        },
        parseMarkdown(e, t) {
            return t.applyMark(
                this.name || `underline`,
    ...
    X = i(),
    Dh = a(),
    { getOwnPropertyNames: Oh, getOwnPropertySymbols: kh } = Object,
...
function Ph(e) {
    return Oh(e).concat(kh(e));
}
var Fh = Object.hasOwn || ((e, t) => Ah.call(e, t));
function Ih(e, t) {
...
var Lh = `__v`,
    Rh = `__o`,
    zh = `_owner`,
    { getOwnPropertyDescriptor: Bh, keys: Vh } = Object;
function Hh(e, t) {
    return (
        e.byteLength === t.byteLength &&
        tg(new Uint8Array(e), new Uint8Array(t))
    );
}
function Uh(e, t, n) {
    let r = e.length;
...
function Xh(e, t, n) {
    let r = Vh(e),
        i = r.length;
    if (Vh(t).length !== i) return !1;
    for (; i-- > 0; ) if (!rg(e, t, n, r[i])) return !1;
    return !0;
}
function Zh(e, t, n) {
    let r = Ph(e),
        i = r.length;
    if (Ph(t).length !== i) return !1;
    let a, o, s;
    for (; i-- > 0; )
        if (
            ((a = r[i]),
...
function eg(e, t, n) {
    ...
    for (; (o = a.next()) && !o.done; ) {
        ...
        for (; (s = r.next()) && !s.done; ) {
            if (
                !i[c] &&
                n.equals(o.value, s.value, o.value, s.value, e, t, n)
            ) {
                a = i[c] = !0;
                break;
            }
...
function rg(e, t, n, r) {
    return (r === zh || r === Rh || r === Lh) && (e.$$typeof || t.$$typeof)
        ? !0
        : Fh(t, r) && n.equals(e[r], t[r], r, r, e, t, n);
}
var ig = `[object ArrayBuffer]`,
    ag = `[object Arguments]`,
    og = `[object Boolean]`,
    sg = `[object DataView]`,
    cg = `[object Date]`,
...
function yg({
    ...
    return function (h, g, _) {
        ...
        let b = vg.call(h);
        if (b === cg) return r(h, g, _);
        if (b === pg) return u(h, g, _);
        if (b === ug) return o(h, g, _);
        if (b === mg) return d(h, g, _);
        if (b === fg)
            return (
        ...
        if (b === _g) return p(h, g, _);
        if (b === lg) return i(h, g, _);
        if (b === ag) return c(h, g, _);
        if (gg[b]) return f(h, g, _);
        if (b === ig) return e(h, g, _);
        if (b === sg) return n(h, g, _);
        if (b === og || b === dg || b === hg) return l(h, g, _);
        if (m) {
            let e = m[b];
            if (!e) {
                let t = Nh(h);
...
function bg({ circular: e, createCustomConfig: t, strict: n }) {
    let r = {
        areArrayBuffersEqual: Hh,
        areArraysEqual: n ? Zh : Uh,
        areDataViewsEqual: Wh,
        areDatesEqual: Gh,
        areErrorsEqual: Kh,
        areFunctionsEqual: qh,
        areMapsEqual: n ? jh(Jh, Zh) : Jh,
        areNumbersEqual: Yh,
        areObjectsEqual: n ? Zh : Xh,
        arePrimitiveWrappersEqual: Qh,
        areRegExpsEqual: $h,
        areSetsEqual: n ? jh(eg, Zh) : eg,
        areTypedArraysEqual: n ? jh(tg, Zh) : tg,
        areUrlsEqual: ng,
        unknownTagComparators: void 0,
    };
    if ((t && (r = Object.assign({}, r, t(r))), e)) {
        let e = Mh(r.areArraysEqual),
            t = Mh(r.areMapsEqual),
            n = Mh(r.areObjectsEqual),
            i = Mh(r.areSetsEqual);
        r = Object.assign({}, r, {
            areArraysEqual: e,
            areMapsEqual: t,
...
(wg({ strict: !0 }),
    wg({ circular: !0 }),
    wg({ circular: !0, strict: !0 }),
    wg({ createInternalComparator: () => Ih }),
    wg({ strict: !0, createInternalComparator: () => Ih }),
    wg({ circular: !0, createInternalComparator: () => Ih }),
    wg({ circular: !0, createInternalComparator: () => Ih, strict: !0 }));
function wg(e = {}) {
    let {
            circular: t = !1,
...
var Tg = t((e) => {
    ...
    Og = ({ contentComponent: e }) => {
        let t = (0, Dh.useSyncExternalStore)(
            e.subscribe,
            e.getSnapshot,
            e.getServerSnapshot,
        );
        return (0, X.jsx)(X.Fragment, { children: Object.values(t) });
    };
function kg() {
    let e = new Set(),
        t = {};
    return {
        ...
        setRenderer(n, r) {
            ((t = { ...t, [n]: Eh.createPortal(r.reactElement, r.element, n) }),
                e.forEach((e) => e()));
        },
        removeRenderer(n) {
            let r = { ...t };
...
var Ag = class extends z.Component {
        constructor(e) {
            (super(e), (this.editorContentRef = z.createRef()));
        }
        componentDidMount() {
            this.init();
        }
        ...
        render() {
            ...
            return (0, X.jsxs)(X.Fragment, {
                children: [
                    (0, X.jsx)(`div`, {
                        ref: Dg(t, this.editorContentRef),
                        ...n,
                    }),
                    e?.contentComponent &&
                        (0, X.jsx)(Og, {
    ...
    jg = (0, z.forwardRef)((e, t) => {
        let n = z.useMemo(
            () => Math.floor(Math.random() * 4294967295).toString(),
            [e.editor],
        );
        return z.createElement(Ag, { key: n, innerRef: t, ...e });
    }),
    Mg = z.memo(jg),
    Ng = typeof window < `u` ? z.useLayoutEffect : z.useEffect,
    Pg = class {
        constructor(e) {
...
function Fg(e) {
    let [t] = (0, z.useState)(() => new Pg(e.editor)),
        n = (0, Eg.useSyncExternalStoreWithSelector)(
            t.subscribe,
            t.getSnapshot,
            t.getServerSnapshot,
            e.selector,
    ...
    return (
        Ng(() => t.watch(e.editor), [e.editor, t]),
        (0, z.useDebugValue)(n),
        n
    );
}
var Ig = !1,
    Lg = typeof window > `u`,
    Rg = Lg || !!(typeof window < `u` && window.next),
    zg = class e {
        constructor(e) {
            ((this.editor = null),
        ...
        createEditor() {
            return new Jd({
                ...
                onBeforeCreate: (...e) => {
                    var t;
                    return (t = this.options.current).onBeforeCreate?.call(
                        t,
                        ...e,
                    );
                },
                ...
                onSelectionUpdate: (...e) => {
                    var t;
                    return (t = this.options.current).onSelectionUpdate?.call(
                        t,
                        ...e,
                    );
                },
                onTransaction: (...e) => {
                    var t;
                    return (t = this.options.current).onTransaction?.call(
                        t,
                        ...e,
                    );
                },
                ...
                onContentError: (...e) => {
                    var t;
                    return (t = this.options.current).onContentError?.call(
                        t,
                        ...e,
                    );
                },
...
function Bg(e = {}, t = []) {
    let n = (0, z.useRef)(e);
    n.current = e;
    let [r] = (0, z.useState)(() => new zg(n)),
        i = (0, Dh.useSyncExternalStore)(
            r.subscribe,
            r.getEditor,
            r.getServerSnapshot,
        );
...
var Vg = (0, z.createContext)({ editor: null });
Vg.Consumer;
var Hg = (0, z.createContext)({
        onDragStart: () => {},
        nodeViewContentChildren: void 0,
        nodeViewContentRef: () => {},
    }),
    Ug = () => (0, z.useContext)(Hg);
(z.forwardRef((e, t) => {
    let { onDragStart: n } = Ug();
    return (0, X.jsx)(e.as || `div`, {
        ...e,
        ref: t,
    ...
    z.createContext({ markViewContentRef: () => {} }));
var Wg = (0, z.createContext)({
    get editor() {
        throw Error(`useTiptap must be used within a <Tiptap> provider`);
    },
});
Wg.displayName = `TiptapContext`;
var Gg = () => (0, z.useContext)(Wg);
function Kg({ editor: e, instance: t, children: n }) {
    let r = e ?? t;
    if (!r)
        throw Error(
            'Tiptap: An editor instance is required. Pass a non-null `editor` prop.',
        );
    let i = (0, z.useMemo)(() => ({ editor: r }), [r]),
        a = (0, z.useMemo)(() => ({ editor: r }), [r]);
    return (0, X.jsx)(Vg.Provider, {
        value: a,
        children: (0, X.jsx)(Wg.Provider, { value: i, children: n }),
    });
}
Kg.displayName = `Tiptap`;
function qg({ ...e }) {
    let { editor: t } = Gg();
    return (0, X.jsx)(Mg, { editor: t, ...e });
}
((qg.displayName = `Tiptap.Content`), Object.assign(Kg, { Content: qg }));
var Jg = (e, t) => {
        if (e === `slot`) return 0;
        ...
        renderMarkdown: (e, t) => {
            ...
            return (
                e.content.forEach((e, r) => {
                    let i = (
                        t.renderChild?.call(t, e, r) ?? t.renderChildren([e])
                    )
                        .split(
                            `
`,
...
`)
        ...
        addInputRules() {
            return [Qd({ find: Yg, type: this.type })];
        },
    }),
    Zg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    Qg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    $g = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    e_ = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    t_ = Td.create({
        name: `bold`,
        addOptions() {
            return { HTMLAttributes: {} };
        ...
        parseMarkdown: (e, t) =>
            t.applyMark(`bold`, t.parseInline(e.tokens || [])),
        markdownOptions: {
            htmlReopen: { open: `<strong>`, close: `</strong>` },
        },
        ...
        addInputRules() {
            return [
                Yd({ find: Zg, type: this.type }),
                Yd({ find: $g, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                ff({ find: Qg, type: this.type }),
                ff({ find: e_, type: this.type }),
            ];
        },
    }),
    n_ = /(^|[^`])`([^`]+)`(?!`)$/,
    ...
    i_ = Td.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`code`, U(this.options.HTMLAttributes, e), 0];
        },
        ...
        addInputRules() {
            return [Yd({ find: n_, type: this.type })];
        },
        addPasteRules() {
            return [ff({ find: r_, type: this.type })];
        },
    }),
    a_ = 4,
    o_ = /^```([a-z]+)?[\s\n]$/,
...
`);
                              return (
                                  e.replaceWith(t, i, n.schema.text(a)),
                                  !0
                              );
                          });
                },
...
`),
                                  ...
                                  return (
                                      e.delete(p, p + f),
                                      r - p <= f &&
                                          e.setSelection(D.create(e.doc, p)),
                                      !0
                                  );
                              })
                            : e.commands.command(({ tr: e }) => {
...
`);
                                  return (
                                      e.replaceWith(i, a, n.schema.text(o)),
                                      !0
                                  );
                              })
                        : !1;
                ...
                ArrowDown: ({ editor: e }) => {
                    ...
                    return o === void 0
                        ...
                        : r.nodeAt(o)
                          ? e.commands.command(
                                ({ tr: e }) => (
                                    e.setSelection(E.near(r.resolve(o))),
                                    !0
                                ),
                            )
                          : e.commands.exitCode();
...
`,
    ...
    f_ = df.create({
        ...
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: e, state: t }) => {
                        if (!$d(t, t.schema.nodes[this.name])) return !1;
                        let { selection: n } = t,
                            { $to: r } = n,
                            i = e();
                        return (
                                    ...
                                    if (n) {
                                        ...
                                        if (n.nodeAfter)
                                            n.nodeAfter.isTextblock
                                                ...
                                                : n.nodeAfter.isBlock
                                                  ? t.setSelection(
                                                        O.create(t.doc, n.pos),
                                                    )
                                                  : t.setSelection(
                                                        D.create(t.doc, n.pos),
                                                    );
                                        else {
                                            let i = (
                                                e.schema.nodes[
        ...
        addInputRules() {
            return [
                Xd({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ];
        },
    }),
    p_ = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    __ = Td.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`em`, U(this.options.HTMLAttributes, e), 0];
        },
        addCommands() {
            return {
                setItalic:
        ...
        addInputRules() {
            return [
                Yd({ find: p_, type: this.type }),
                Yd({ find: h_, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                ff({ find: m_, type: this.type }),
                ff({ find: g_, type: this.type }),
            ];
        },
    }),
    v_ = Object.defineProperty,
    y_ = (e, t) => {
        for (var n in t) v_(e, n, { get: t[n], enumerable: !0 });
    },
    b_ = `listItem`,
    x_ = `textStyle`,
    S_ = /^\s*([-+*])\s$/,
    C_ = df.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`ul`, U(this.options.HTMLAttributes, e), 0];
        },
...
`,
        ...
        addInputRules() {
            let e = Qd({ find: S_, type: this.type });
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (e = Qd({
                        ...
                        getAttributes: () => this.editor.getAttributes(x_),
                        editor: this.editor,
                    })),
                [e]
            );
...
var E_ = df.create({
    ...
    renderHTML({ HTMLAttributes: e }) {
        return [`li`, U(this.options.HTMLAttributes, e), 0];
    },
        ...
        if (e.tokens && e.tokens.length > 0) {
            if (w_(e))
                return {
                    type: `listItem`,
                    content: [
                        { type: `paragraph`, content: T_(e.text || ``, t) },
                    ],
                };
...
var D_ = (e, t) => {
    ...
    M_ = (e, t, n) => {
        ...
        if (!Fl(e.state, t) && k_(e.state, t, n)) {
        ...
        if (!Fl(e.state, t) || !Lu(e.state)) return !1;
        let r = D_(t, e.state);
        if (!r) return !1;
        let i = e.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            a = j_(t, e.state, i);
        return A_(t, e.state) && !a
            ? e.commands.joinItemBackward()
    ...
    F_ = (e, t) => {
        if (!Fl(e.state, t) || !Iu(e.state, t)) return !1;
...
function H_(e) {
    ...
    for (; n < e.length; ) {
        ...
        for (; d < e.length; ) {
            ...
            else if (t.match(z_)) (f.push(t), u.push(t.slice(l + 2)), (d += 1));
            else {
                if (p) break;
...
function U_(e, t, n) {
    ...
    for (; i < e.length; ) {
        let a = e[i];
        if (a.indent === t) {
            let { paragraphLines: o, blockLines: s } = V_(a.contentLines),
                c = o
                    .join(
                        `
`,
...
`,
            ...
            if (f.length > 0) {
                let e = U_(f, Math.min(...f.map((e) => e.indent)), n);
                l.push({
                    type: `list`,
                    ordered: !0,
                    start: f[0].number,
...
var G_ = `listItem`,
    ...
    J_ = df.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            let { start: t, ...n } = e;
            return t === 1
                ? [`ol`, U(this.options.HTMLAttributes, n), 0]
                : [`ol`, U(this.options.HTMLAttributes, e), 0];
        },
        markdownTokenName: `list`,
        parseMarkdown: (e, t) => {
            if (e.type !== `list` || !e.ordered) return [];
            let n = e.start || 1,
                r = e.items ? W_(e.items, t) : [];
            return n === 1
            ...
            return ({ node: e, HTMLAttributes: t, getPos: n, editor: r }) => {
                let i = document.createElement(`li`),
                    ...
                    l = (e) => {
                        var t;
                        s.ariaLabel =
                            (t = this.options.a11y)?.checkboxLabel?.call(
                                t,
                                e,
                                s.checked,
                            ) ||
    ...
    addExtensions() {
        ...
        return (
            this.options.bulletList !== !1 &&
                e.push(C_.configure(this.options.bulletList)),
            this.options.listItem !== !1 &&
                e.push(E_.configure(this.options.listItem)),
            this.options.listKeymap !== !1 &&
                e.push(L_.configure(this.options.listKeymap)),
            this.options.orderedList !== !1 &&
                e.push(J_.configure(this.options.orderedList)),
            this.options.taskItem !== !1 &&
                e.push(X_.configure(this.options.taskItem)),
            this.options.taskList !== !1 &&
                e.push(Z_.configure(this.options.taskList)),
            e
        );
    },
});
var Q_ = `&nbsp;`,
    ...
    ev = df.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`p`, U(this.options.HTMLAttributes, e), 0];
        },
        parseMarkdown: (e, t) => {
            let n = e.tokens || [];
    ...
    rv = Td.create({
        ...
        renderHTML({ HTMLAttributes: e }) {
            return [`s`, U(this.options.HTMLAttributes, e), 0];
        },
        ...
        addInputRules() {
            return [Yd({ find: tv, type: this.type })];
        },
        addPasteRules() {
            return [ff({ find: nv, type: this.type })];
        },
    }),
    iv = df.create({
        name: `text`,
    ...
    av = W.create({
        ...
        addExtensions() {
            ...
            return (
                this.options.bold !== !1 &&
                    e.push(t_.configure(this.options.bold)),
                this.options.blockquote !== !1 &&
                    e.push(Xg.configure(this.options.blockquote)),
                this.options.bulletList !== !1 &&
                    e.push(C_.configure(this.options.bulletList)),
                this.options.code !== !1 &&
                    e.push(i_.configure(this.options.code)),
                this.options.codeBlock !== !1 &&
                    e.push(c_.configure(this.options.codeBlock)),
                this.options.document !== !1 &&
                    e.push(l_.configure(this.options.document)),
                this.options.dropcursor !== !1 &&
                    e.push(ch.configure(this.options.dropcursor)),
                this.options.gapcursor !== !1 &&
                    e.push(lh.configure(this.options.gapcursor)),
                this.options.hardBreak !== !1 &&
                    e.push(u_.configure(this.options.hardBreak)),
                this.options.heading !== !1 &&
                    e.push(d_.configure(this.options.heading)),
                this.options.undoRedo !== !1 &&
                    e.push(Sh.configure(this.options.undoRedo)),
                this.options.horizontalRule !== !1 &&
                    e.push(f_.configure(this.options.horizontalRule)),
                this.options.italic !== !1 &&
                    e.push(__.configure(this.options.italic)),
                this.options.listItem !== !1 &&
                    e.push(E_.configure(this.options.listItem)),
                this.options.listKeymap !== !1 &&
                    e.push(L_.configure(this.options?.listKeymap)),
                this.options.link !== !1 &&
                    e.push(wm.configure(this.options?.link)),
                this.options.orderedList !== !1 &&
                    e.push(J_.configure(this.options.orderedList)),
                this.options.paragraph !== !1 &&
                    e.push(ev.configure(this.options.paragraph)),
                this.options.strike !== !1 &&
                    e.push(rv.configure(this.options.strike)),
                this.options.text !== !1 &&
                    e.push(iv.configure(this.options.text)),
                this.options.underline !== !1 &&
                    e.push(wh.configure(this.options?.underline)),
                this.options.trailingNode !== !1 &&
                    e.push(xh.configure(this.options?.trailingNode)),
                e
            );
        },
    });
...
var dv = ((e = ``) => {
    ...
    Q = {
        ...
        fencesBeginRegex: uv((e) => RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),
        headingBeginRegex: uv((e) => RegExp(`^ {0,${e}}#`)),
        htmlBeginRegex: uv((e) => RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`, `i`)),
        blockquoteBeginRegex: uv((e) => RegExp(`^ {0,${e}}>`)),
    },
    fv = /^(?:[ \t]*(?:\n|$))+/,
    pv = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,
    mv =
    ...
    Tv = Z(/^(bull)([ \t][^\n]+?)?(?:\n|$)/)
        .replace(/bull/g, _v)
        .getRegex(),
    Ev = `address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,
    Dv = /<!--(?:-?>|[\s\S]*?(?:-->|$))/,
    Ov = Z(
    ...
    Bv = /[^\s\p{P}\p{S}]/u,
    Vv = Z(/^((?![*_])punctSpace)/, `u`)
        .replace(/punctSpace/g, zv)
        .getRegex(),
    Hv = /(?!~)[\p{P}\p{S}]/u,
    Uv = /(?!~)[\s\p{P}\p{S}]/u,
    Wv = /(?:[^\s\p{P}\p{S}]|~)/u,
    Gv = Z(/link|precode-code|html/, `g`)
        .replace(
            `link`,
            /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
        )
        ...
        .replace(`html`, /<(?! )[^<>]*?>/)
        .getRegex(),
    Kv = /^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,
    qv = Z(Kv, `u`).replace(/punct/g, Rv).getRegex(),
    Jv = Z(Kv, `u`).replace(/punct/g, Hv).getRegex(),
    Yv = `^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,
    Xv = Z(Yv, `gu`)
        ...
        .getRegex(),
    Zv = Z(Yv, `gu`)
        .replace(/notPunctSpace/g, Wv)
        .replace(/punctSpace/g, Uv)
        .replace(/punct/g, Hv)
        .getRegex(),
    Qv = Z(
    ...
    cy = Z(/^!?\[(ref)\](?:\[\])?/)
        .replace(`ref`, Cv)
        .getRegex(),
    ly = Z(`reflink|nolink(?!\\()`, `g`)
        .replace(`reflink`, sy)
        .replace(`nolink`, cy)
        .getRegex(),
    uy = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
    dy = {
        _backpedal: lv,
        anyPunctuation: ty,
        autolink: ny,
    ...
    my = {
        ...py,
        br: Z(Iv).replace(`{2,}`, `*`).getRegex(),
        text: Z(py.text)
            .replace(`\\b_`, `\\b_| {2,}\\n`)
            .replace(/\{2,\}/g, `*`)
            .getRegex(),
    },
    hy = { normal: Av, gfm: Mv, pedantic: Nv },
    gy = { normal: dy, gfm: py, breaks: my, pedantic: fy },
    _y = {
        '&': `&amp;`,
        '<': `&lt;`,
        '>': `&gt;`,
...
function yy(e, t) {
    if (t) {
        if (Q.escapeTest.test(e)) return e.replace(Q.escapeReplace, vy);
    } else if (Q.escapeTestNoEncode.test(e))
        return e.replace(Q.escapeReplaceNoEncode, vy);
    return e;
}
function by(e) {
    try {
...
var Oy = class {
        ...
        code(e) {
            ...
            if (t) {
                let e = this.options.pedantic ? t[0] : Cy(t[0]);
                return {
                    type: `code`,
                    raw: e,
...
`),
                        ...
                        ((i[i.length - 1] = o),
                            (n =
                                n.substring(0, n.length - u.raw.length) +
                                o.raw),
                            (r =
...
`,
                            ...
                            if (
                                ...
                                break;
                            if (
                                m.search(this.rules.other.nonSpaceChar) >= d ||
                                !l.trim()
                            )
                                s +=
                                    `
...
`),
                    ...
                    (i.loose ||
                        ...
                        i.items.push({
                            ...
                            task:
                                !!this.options.gfm &&
                                this.rules.other.listIsTask.test(s),
                            loose: !1,
                            text: s,
                            tokens: [],
                        }),
                ...
                for (let e of i.items) {
                    ...
                    if (
                        ...
                        for (
                            let e = this.lexer.inlineQueue.length - 1;
                            e >= 0;
                            e--
                        )
                            if (
                                ...
                                this.lexer.inlineQueue[e].src =
                                    this.lexer.inlineQueue[e].src.replace(
                                        this.rules.other.listReplaceTask,
                                        ``,
                                    );
                                break;
                            ...
                            ((e.checked = t.checked),
                                i.loose
                                    ? e.tokens[0] &&
                                      ...
                                      e.tokens[0].tokens
                                        ? ((e.tokens[0].raw =
                                              t.raw + e.tokens[0].raw),
                                          (e.tokens[0].text =
                                              t.raw + e.tokens[0].text),
...
`
        ...
        link(e) {
            ...
            if (t) {
                ...
                if (
                    ...
                    if (e > -1) {
                        let n =
                            (t[0].indexOf(`!`) === 0 ? 5 : 4) + t[1].length + e;
        ...
        reflink(e, t) {
            ...
            if (
                ...
                return Ey(n, e, n[0], this.lexer, this.rules);
            }
        }
        emStrong(e, t, n = ``) {
    ...
    ky = class e {
        ...
        constructor(e) {
            ((this.tokens = []),
                ...
                (this.options = e || sv),
                (this.options.tokenizer = this.options.tokenizer || new Oy()),
                (this.tokenizer = this.options.tokenizer),
                (this.tokenizer.options = this.options),
                (this.tokenizer.lexer = this),
                (this.inlineQueue = []),
                (this.state = { inLink: !1, inRawBlock: !1, top: !0 }));
            let t = { other: Q, block: hy.normal, inline: gy.normal };
            (this.options.pedantic
                ? ((t.block = hy.pedantic), (t.inline = gy.pedantic))
                : this.options.gfm &&
                  ((t.block = hy.gfm),
                  this.options.breaks
                      ? (t.inline = gy.breaks)
...
`
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
            ...
            let i = by(e);
            if (i === null) return yy(n);
            e = i;
            let a = `<img src="${e}" alt="${yy(n)}"`;
            return (t && (a += ` title="${yy(t)}"`), (a += `>`), a);
        }
        text(e) {
    ...
    My = class e {
        ...
        constructor(e) {
            ((this.options = e || sv),
                (this.options.renderer = this.options.renderer || new Ay()),
                (this.renderer = this.options.renderer),
                (this.renderer.options = this.options),
                (this.renderer.parser = this),
                (this.textRenderer = new jy()));
        }
        static parse(t, n) {
    ...
    Ny = class {
        ...
        provideLexer(e = this.block) {
            return e ? ky.lex : ky.lexInline;
        }
        provideParser(e = this.block) {
            return e ? My.parse : My.parseInline;
        }
    },
    Py = new (class {
        defaults = ov();
            ...
            return (
                e.forEach((e) => {
                    ...
                    if (
                        ...
                        let t = this.defaults.renderer || new Ay(this.defaults);
                    ...
                    if (e.tokenizer) {
                        let t =
                            this.defaults.tokenizer || new Oy(this.defaults);
                    ...
                    if (e.hooks) {
                        ...
                        for (let n in e.hooks) {
                            ...
                            let r = n,
                                i = e.hooks[r],
                                a = t[r];
                            Ny.passThroughHooks.has(n)
                                ? (t[r] = (e) => {
                                      if (
                                          this.defaults.async &&
                                          Ny.passThroughHooksRespectAsync.has(n)
                                      )
                                          return (async () => {
        ...
        lexer(e, t) {
            return ky.lex(e, t ?? this.defaults);
        }
        parser(e, t) {
            return My.parse(e, t ?? this.defaults);
        }
        parseMarkdown(e) {
            return (t, n) => {
                let r = { ...n },
                ...
                if (
                    ...
                    return (async () => {
                        ...
                        i.walkTokens &&
                            (await Promise.all(
                                this.walkTokens(a, i.walkTokens),
                            ));
                        let o = await (
                            i.hooks
...
(($.options = $.setOptions =
    ...
    ($.defaults = sv),
    ($.use = function (...e) {
        return (Py.use(...e), ($.defaults = Py.defaults), cv($.defaults), $);
    }),
    ($.walkTokens = function (e, t) {
        return Py.walkTokens(e, t);
    }),
    ($.parseInline = Py.parseInline),
    ($.Parser = My),
    ($.parser = My.parse),
    ($.Renderer = Ay),
    ($.TextRenderer = jy),
...
function Iy({ className: e, variant: t, size: n, ...r }) {
    return (0, X.jsx)(o, {
        'data-slot': `toggle`,
        className: s(Fy({ variant: t, size: n, className: e })),
        ...r,
    });
}
function Ly({ onClick: e, active: t, title: n, children: r }) {
    return (0, X.jsx)(Iy, {
        size: `sm`,
        pressed: t,
        onPressedChange: e,
...
function Ry({
    ...
    defaultValue: t,
    error: n,
    placeholder: r = `Write your post…`,
}) {
    let i = (0, z.useRef)(null),
        a = (0, z.useRef)(null),
        o = (e) => {
            i.current && e && (i.current.value = e.isEmpty ? `` : e.getHTML());
        },
        s = Bg({
            extensions: [
                av,
                Th,
                Tm.configure({ openOnClick: !1 }),
                Ch.configure({ placeholder: r }),
            ],
            content: t ?? ``,
            onCreate: ({ editor: e }) => o(e),
            onUpdate: ({ editor: e }) => o(e),
        });
    function c(e) {
    ...
    function u() {
        if (!s) return;
        let e = s.getAttributes(`link`).href,
            t = window.prompt(`URL`, e ?? ``);
        t !== null &&
            (t === ``
                ? s.chain().focus().extendMarkRange(`link`).unsetLink().run()
                : s
                      .chain()
                      .focus()
    ...
    return (0, X.jsxs)(`div`, {
        ...
        children: [
            (0, X.jsx)(`input`, { type: `hidden`, name: e, ref: i }),
            (0, X.jsxs)(`div`, {
                className: `rounded-md border border-input bg-transparent shadow-sm focus-within:ring-1 focus-within:ring-ring`,
                children: [
                    (0, X.jsxs)(`div`, {
                        ...
                        children: [
                            ...
                            (0, X.jsx)(Ly, {
                                ...
                                onClick: () =>
                                    s?.chain().focus().toggleItalic().run(),
                                children: (0, X.jsx)(ae, {
                                    className: `size-3.5`,
                                }),
                            }),
                            (0, X.jsx)(Ly, {
                                ...
                                onClick: () =>
                                    s?.chain().focus().toggleUnderline().run(),
                                children: (0, X.jsx)(de, {
                                    className: `size-3.5`,
                                }),
                            }),
                            ...
                            (0, X.jsx)(Ly, {
                                ...
                                onClick: () =>
                                    s?.chain().focus().toggleBlockquote().run(),
                                children: (0, X.jsx)(le, {
                                    className: `size-3.5`,
                                }),
                            }),
...
function zy({ name: e, currentImage: t, label: n, error: r }) {
    ...
    return (0, X.jsxs)(`div`, {
        className: `grid gap-2`,
        children: [
            (0, X.jsx)(b, { htmlFor: e, children: n }),
            a &&
                (0, X.jsx)(`img`, {
                    src: a,
                    alt: `Preview`,
...
function By({ post: e, categories: t, errors: n, processing: r, onCancel: i }) {
    let a = `__none__`,
        [o, s] = (0, z.useState)(e?.status ?? `draft`),
        [c, u] = (0, z.useState)(e?.category?.id?.toString() ?? a);
    return (0, X.jsxs)(`div`, {
        className: `space-y-6`,
        children: [
            (0, X.jsx)(`input`, { type: `hidden`, name: `status`, value: o }),
            (0, X.jsx)(`input`, {
                type: `hidden`,
                name: `category_id`,
                value: c === a ? `` : c,
            ...
            (0, X.jsxs)(`div`, {
                className: `grid gap-2`,
                children: [
                    (0, X.jsx)(b, { htmlFor: `title`, children: `Title` }),
                    (0, X.jsx)(_, {
                        id: `title`,
                        name: `title`,
                    ...
                    (0, X.jsx)(y, { message: n.title }),
                ],
            }),
            (0, X.jsxs)(`div`, {
                className: `grid gap-2`,
                children: [
                    (0, X.jsx)(b, { htmlFor: `excerpt`, children: `Excerpt` }),
                    (0, X.jsx)(_, {
                        id: `excerpt`,
                        name: `excerpt`,
                        defaultValue: e?.excerpt ?? ``,
                        placeholder: `Short description…`,
                    }),
                    (0, X.jsx)(y, { message: n.excerpt }),
                ],
            }),
            (0, X.jsxs)(`div`, {
                className: `grid gap-2`,
                children: [
                    (0, X.jsx)(b, { children: `Content` }),
                    (0, X.jsx)(Ry, {
                        name: `content`,
                ...
                children: [
                    (0, X.jsxs)(`div`, {
                        ...
                        children: [
                            ...
                            (0, X.jsx)(y, { message: n.category_id }),
                        ],
                    }),
                    (0, X.jsxs)(`div`, {
                        className: `grid gap-2`,
                        children: [
                            (0, X.jsx)(b, { children: `Status` }),
                            (0, X.jsxs)(h, {
                                value: o,
                                onValueChange: s,
                                children: [
