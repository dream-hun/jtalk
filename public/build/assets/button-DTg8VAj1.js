...
import { et as t, q as n } from './vendor-radix-C92RFvrB.js';
import { r, t as i } from './utils-DDQLTkD9.js';
...
function u({ className: e, variant: t, size: r, asChild: a = !1, ...o }) {
    return (0, c.jsx)(a ? n : `button`, {
        'data-slot': `button`,
        className: i(l({ variant: t, size: r, className: e })),
        ...o,
    });
}
