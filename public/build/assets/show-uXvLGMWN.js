...
import { n, r } from './vendor-inertia-C-ctYATJ.js';
import { r as i } from './vendor-react-gF8_I9RY.js';
import { et as a } from './vendor-radix-C92RFvrB.js';
import { t as o } from './chevron-left-DXrVgh6h.js';
import { t as s } from './chevron-right-BYoOqPwK.js';
import { n as c, r as l } from './blog-DQ8ZM9pB.js';
var u = e(
    t((e, t) => {
        function n(e) {
            return (
        ...
        var w = /\b\B/,
            ...
            R = I(`/\\*`, `\\*/`),
            z = I(`#`, `$`),
            B = { scope: `number`, begin: D, relevance: 0 },
            V = { scope: `number`, begin: O, relevance: 0 },
            H = { scope: `number`, begin: k, relevance: 0 },
            U = {
                scope: `regexp`,
                begin: /\/(?=[^/\n]*\/)/,
                end: /\/[gimuy]*/,
            ...
            ee = { scope: `title`, begin: T, relevance: 0 },
            W = { scope: `title`, begin: E, relevance: 0 },
            G = { begin: `\\.\\s*` + E, relevance: 0 },
            K = Object.freeze({
                __proto__: null,
                APOS_STRING_MODE: N,
                BACKSLASH_ESCAPE: M,
        ...
        function me(e) {
            if (Array.isArray(e.begin)) {
                ...
                (pe(e, e.begin, { key: `beginScope` }),
                    (e.begin = C(e.begin, { joinWith: `` })));
            }
        }
        function he(e) {
            if (Array.isArray(e.end)) {
                ...
                (pe(e, e.end, { key: `endScope` }),
                    (e.end = C(e.end, { joinWith: `` })));
            }
        }
        function ge(e) {
            e.scope &&
        ...
        function ve(e) {
            ...
            class n {
                ...
                compile() {
                    ...
                    ((this.matcherRe = t(C(e, { joinWith: `|` }), !0)),
                        (this.lastIndex = 0));
                }
                exec(e) {
            ...
            function o(n, r) {
                ...
                return (
                    ...
                    (s ||= /\w+/),
                    (n.keywords &&= le(n.keywords, e.case_insensitive)),
...
https://github.com/highlightjs/highlight.js/issues/2277`,
                ...
                function v(e, n, i, a) {
                    ...
                    function d() {
                        ...
                        let t = A.keywordPatternRe.exec(P),
                            n = ``;
                        for (; t; ) {
                            n += P.substring(e, t.index);
                            let r = D.case_insensitive
                                    ? t[0].toLowerCase()
                                    : t[0],
                                i = u(A, r);
                            if (i) {
                    ...
                    function f() {
                        ...
                        if (typeof A.subLanguage == `string`) {
                            ...
                            ((e = v(A.subLanguage, P, !0, j[A.subLanguage])),
                                (j[A.subLanguage] = e._top));
                        } else
                            e = S(
                                P,
                                A.subLanguage.length ? A.subLanguage : null,
                            );
                        (A.relevance > 0 && (F += e.relevance),
                    ...
                    function m(e, t) {
                        e !== `` &&
                            (M.startScope(t), M.addText(e), M.endScope());
                    }
                    function h(e, t) {
                        let n = 1,
                            r = t.length - 1;
                    ...
                    function g(e, t) {
                        return (
                            e.scope &&
                                ...
                                M.openNode(
                                    D.classNameAliases[e.scope] || e.scope,
                                ),
                            e.beginScope &&
                                (e.beginScope._wrap
                                    ? (m(
                    ...
                    function b(e) {
                        ...
                        for (let n of a)
                            if (n && (n(e, i), i.isMatchIgnored)) return y(t);
                        return (
                            n.skip
                                ? (P += t)
                                : (n.excludeBegin && (P += t),
                    ...
                    function C(e) {
                        ...
                        A.endScope && A.endScope._wrap
                            ...
                            : A.endScope && A.endScope._multi
                              ...
                              : a.skip
                                ? (P += t)
                                : (a.returnEnd || a.excludeEnd || (P += t),
                                  p(),
                                  a.excludeEnd && (P = t));
                        do
                            (A.scope && M.closeNode(),
                                !A.skip && !A.subLanguage && (F += A.relevance),
                                (A = A.parent));
                        while (A !== i.parent);
                        return (
                            i.starts && g(i.starts, e),
                            a.returnEnd ? 0 : t.length
                        );
                    }
                    function w() {
                        let e = [];
                        for (let t = A; t !== D; t = t.parent)
...
`),
                    ...
                    try {
                        if (D.__emitTokens) D.__emitTokens(n, M);
                            ...
                            for (A.matcher.considerAll(); ; ) {
                                (L++,
                                    R ? (R = !1) : A.matcher.considerAll(),
                                    (A.matcher.lastIndex = I));
                ...
                function w(e) {
                    ...
                    if (u(n)) return;
                    if (
                        (z(`before:highlightElement`, { el: e, language: n }),
                    ...
                    let r = t.textContent,
                        i = n
                            ? p(r, { language: n, ignoreIllegals: !0 })
                            : S(r);
                    ((e.innerHTML = i.value),
                ...
                function A(n, r) {
                    ...
                    ((i.name ||= n),
                        ...
                        i.aliases && P(i.aliases, { languageName: n }));
                }
                function j(e) {
                    delete t[e];
                ...
                for (let e in K) typeof K[e] == `object` && n(K[e]);
...
function b(e) {
    ...
    return {
        ...
        contains: [
            ...
            n.CSS_VARIABLE,
            { className: `attribute`, begin: `\\b(` + y.join(`|`) + `)\\b` },
            {
                begin: /:/,
                end: /[;}{]/,
                contains: [
            ...
            { className: `selector-tag`, begin: `\\b(` + h.join(`|`) + `)\\b` },
        ],
    };
}
function x(e) {
...
function A(e) {
    ...
    return {
        ...
        keywords: s,
        exports: { PARAMS_CONTAINS: b, CLASS_REFERENCE: j },
        illegal: /#(?![$_A-z])/,
        contains: [
    ...
    return {
        ...
        contains: [
            ...
            { className: `tag`, begin: /<>|<\/>/ },
            {
                ...
                contains: [
                    { className: `name`, begin: n, relevance: 0, starts: l },
                ],
            },
            {
                className: `tag`,
...
var K = e(i(), 1),
    q = a();
(u.registerLanguage(`bash`, d),
    u.registerLanguage(`sh`, d),
    u.registerLanguage(`shell`, d),
    u.registerLanguage(`css`, b),
    u.registerLanguage(`go`, x),
    u.registerLanguage(`javascript`, A),
    u.registerLanguage(`js`, A),
    u.registerLanguage(`json`, j),
    u.registerLanguage(`php`, M),
    u.registerLanguage(`python`, N),
    u.registerLanguage(`py`, N),
    u.registerLanguage(`rust`, P),
    u.registerLanguage(`sql`, F),
    u.registerLanguage(`typescript`, W),
    u.registerLanguage(`ts`, W),
    u.registerLanguage(`html`, G),
    u.registerLanguage(`xml`, G));
        ...
        (0, K.useEffect)(() => {
            ...
            return (
                e.querySelectorAll(`pre`).forEach((e) => {
                    ...
                    ((t.textContent = `Copy`),
                        t.setAttribute(`aria-label`, `Copy code`),
                        (t.className = `absolute top-2 right-2 rounded px-2 py-1 text-xs font-mono bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-600 transition-colors cursor-pointer select-none opacity-0 group-hover:opacity-100`),
...
function ne({
    ...
    let f = e.excerpt ?? ``,
        ...
        m = {
            ...
            image: p,
            url: u,
            ...(a && { author: { '@type': `Person`, name: a } }),
        };
    return (0, q.jsxs)(q.Fragment, {
        children: [
            (0, q.jsxs)(n, {
                children: [
                    (0, q.jsx)(`title`, { children: e.title }),
                    (0, q.jsx)(`meta`, {
                    ...
                    e.published_at &&
                        (0, q.jsx)(`meta`, {
                            ...
                            content: e.published_at,
                        }),
                    (0, q.jsx)(`meta`, {
                        'head-key': `twitter:card`,
                        name: `twitter:card`,
                        content: e.cover_image
                            ? `summary_large_image`
                            : `summary`,
                    }),
                    (0, q.jsx)(`meta`, {
            ...
            (0, q.jsx)(`div`, {
                ...
                children: (0, q.jsxs)(`div`, {
                    className: `mx-auto max-w-2xl px-6 py-12 pb-24`,
                    children: [
                        (0, q.jsxs)(`div`, {
                                    ...
                                    t
                                        ? (0, q.jsxs)(r, {
                                              ...
                                              children: [
                                                  ...
                                                  (0, q.jsx)(`span`, {
                                                      className: `text-sm font-medium group-hover:text-foreground transition-colors whitespace-normal break-words`,
                                                      children: t.title,
                                                  }),
                                              ],
                                          })
