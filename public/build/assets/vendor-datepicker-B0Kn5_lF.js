import { a as e, r as t } from './rolldown-runtime-C-57s9n3.js';
import { r as n } from './vendor-react-gF8_I9RY.js';
var r = 365.2425,
    i = 6048e5,
    a = 864e5,
    o = 3600 * 24;
...
function d(e, t, n) {
    let r = l(e, n?.in);
    if (isNaN(t)) return c(n?.in || e, NaN);
    if (!t) return r;
    let i = r.getDate(),
        a = c(n?.in || e, r.getTime());
    return (
        a.setMonth(r.getMonth() + t + 1, 0),
        i >= a.getDate()
            ? a
            : (r.setFullYear(a.getFullYear(), a.getMonth(), i), r)
    );
}
var f = {};
function p() {
...
function te(e, t) {
    ...
    return (
        e.forEach((e) => {
            !r && typeof e == `object` && (r = c.bind(null, e));
            let t = l(e, r);
            (!n || n < t || isNaN(+t)) && (n = t);
        }),
        c(r, n || NaN)
...
function ie(e) {
    return !((!re(e) && typeof e != `number`) || isNaN(+l(e)));
}
function ae(e, t, n) {
    let [r, i] = v(n?.in, e, t),
...
function se(e, t) {
    let [n, r] = v(e, t.start, t.end);
    return { start: n, end: r };
}
function ce(e, t) {
    let { start: n, end: r } = se(t?.in, e),
        i = +n > +r,
        a = i ? +n : +r,
        o = i ? r : n;
    ...
    s < 0 && ((s = -s), (i = !i));
    let l = [];
    for (; +o <= a; ) (l.push(c(n, o)), o.setMonth(o.getMonth() + s));
...
function T(e, t) {
    ...
    s < 0 && ((s = -s), (i = !i));
    let l = [];
    for (; +o <= a; ) (l.push(c(n, o)), o.setFullYear(o.getFullYear() + s));
    return i ? l.reverse() : l;
}
function E(e, t) {
    let n = p(),
...
function Ee(e, t) {
    return e % 60 == 0 ? (e > 0 ? `-` : `+`) + j(Math.abs(e) / 60, 2) : I(e, t);
}
function I(e, t = ``) {
    let n = e > 0 ? `-` : `+`,
        r = Math.abs(e),
        i = j(Math.trunc(r / 60), 2),
        a = j(r % 60, 2);
    return n + i + t + a;
}
var De = (e, t) => {
...
function L(e, t, n) {
    ...
    let c = t
        ...
        .map((e) => {
            ...
            let t = e[0];
            if (t === `'`) return { isToken: !1, value: He(e) };
    ...
    let u = { firstWeekContainsDate: a, weekStartsOn: o, locale: i };
    return c
        .map((r) => {
            if (!r.isToken) return r.value;
            let a = r.value;
            ((!n?.useAdditionalWeekYearTokens && Pe(a)) ||
                (!n?.useAdditionalDayOfYearTokens && Ne(a))) &&
                Fe(a, t, String(e));
            let o = P[a[0]];
...
function Ze(e, t, n) {
    let r = l(e, n?.in);
    return isNaN(+r) ? c(n?.in || e, NaN) : (r.setFullYear(t), r);
}
function Qe(e, t, n = `long`) {
...
function z(e, t) {
    try {
        let n = ($e[e] ||= new Intl.DateTimeFormat(`en-US`, {
            timeZone: e,
            timeZoneName: `longOffset`,
        }).format)(t).split(`GMT`)[1];
        return n in R ? R[n] : tt(n, n.split(`:`));
    } catch {
        if (e in R) return R[e];
        let t = e?.match(et);
        return t ? tt(e, t.slice(1)) : NaN;
    }
}
var et = /([+-]\d\d):?(\d\d)?/;
function tt(e, t) {
    let n = +(t[0] || 0),
        r = +(t[1] || 0),
        i = (t[2] || 0) / 60;
    return (R[e] = n * 60 + r > 0 ? n * 60 + r + i : n * 60 - r - i);
}
var nt = class e extends Date {
        constructor(...e) {
            (super(),
                e.length > 1 &&
                      ...
                      ? typeof e[0] == `number` &&
                        (e.length === 1 ||
                          ...
                          : typeof e[0] == `string`
                            ...
                            : e[0] instanceof Date
                              ? this.setTime(+e[0])
                              : (this.setTime(+new Date(...e)), ot(this, e))
...
function it(e) {
    (e.internal.setTime(+e),
        e.internal.setUTCSeconds(
            e.internal.getUTCSeconds() - Math.round(-z(e.timeZone, e) * 60),
        ));
}
function at(e) {
...
function ot(e, t) {
    let n = Array.isArray(t) ? st(t) : +e.internal,
        r = z(e.timeZone, e),
    ...
    let m = z(e.timeZone, e),
        ...
        y = h - i,
        b = n - h * 60 * 1e3,
        x = y > 0 && ct(e) - n === y * 60 * 1e3 && ct(e, b) !== n;
    if (_ && v && !x) {
        Date.prototype.setUTCMinutes.call(
            e,
            Date.prototype.getUTCMinutes.call(e) + v,
        );
        let t = z(e.timeZone, e),
    ...
    S &&
        Math.abs(S) < 1800 * 1e3 &&
        (Date.prototype.setTime.call(e, +e + S), it(e));
}
function st(e) {
    return Date.UTC(
        e[0],
...
function ct(e, t) {
    let n = new Date(t ?? +e);
    return (
        n.setUTCSeconds(n.getUTCSeconds() - Math.round(-z(e.timeZone, n) * 60)),
        +n
    );
}
var B = class e extends nt {
        static tz(t, ...n) {
            return n.length ? new e(...n, t) : new e(Date.now(), t);
        }
        toISOString() {
        ...
        toTimeString() {
            ...
            return `${e} GMT${t}${n}${r} (${Qe(this.timeZone, this)})`;
        }
        toLocaleString(e, t) {
...
function dt(e, t) {
    let n = t.startOfMonth(e),
        ...
        i = t.addDays(e, -r + 1),
        a = t.addDays(i, lt * 7 - 1);
    return t.getMonth(e) === t.getMonth(a) ? lt : ut;
}
function ft(e, t) {
    let n = t.startOfMonth(e),
        r = n.getDay();
...
var mt = {
    ...
    V = class e {
            ...
            ((this.today = () =>
                ...
                (this.isBefore = (e, t) =>
                    this.overrides?.isBefore
                        ...
                        : qe(e, t)),
                (this.isDate = (e) =>
                    this.overrides?.isDate ? this.overrides.isDate(e) : re(e)),
                (this.isSameDay = (e, t) =>
                ...
                (this.isSameYear = (e, t) =>
                    this.overrides?.isSameYear
                        ...
                        : Ye(e, t)),
                (this.max = (e) =>
                    this.overrides?.max ? this.overrides.max(e) : te(e)),
                (this.min = (e) =>
                    this.overrides?.min ? this.overrides.min(e) : C(e)),
                (this.setMonth = (e, t) =>
        ...
        getMonthYearOrder() {
            ...
            return t && e.yearFirstLocales.has(t)
                ? `year-first`
                : `month-first`;
        }
        formatMonthYear(t) {
...
var St = (0, U.createContext)(void 0);
function Ct() {
    let e = (0, U.useContext)(St);
    if (e === void 0)
...
function wt(e) {
    let { options: t, className: n, ...r } = e,
        { classNames: i, components: a, styles: o } = Ct(),
...
function Y(e, t, n = H) {
    ...
    return r.some((t) => {
        ...
        if (Zt(t, n)) return t.some((t) => i(e, t));
        if (qt(t)) return J(t, e, !1, n);
        if (Xt(t))
...
var dn = t({
    formatCaption: () => rn,
    formatDay: () => an,
    formatMonthDropdown: () => on,
    formatWeekNumber: () => cn,
    formatWeekNumberHeader: () => ln,
    formatWeekdayName: () => sn,
...
function En(e, t) {
    ...
    return {
        ...Tn,
        ...(e ?? {}),
        labelDayButton: X(pn, e?.labelDayButton, n.labelDayButton),
        labelMonthDropdown: X(gn, e?.labelMonthDropdown, n.labelMonthDropdown),
        labelNext: X(yn, e?.labelNext, n.labelNext),
        labelPrevious: X(bn, e?.labelPrevious, n.labelPrevious),
        labelWeekNumber: X(Sn, e?.labelWeekNumber, n.labelWeekNumber),
        labelYearDropdown: X(wn, e?.labelYearDropdown, n.labelYearDropdown),
        labelGrid: X(mn, e?.labelGrid, n.labelGrid),
        labelGridcell: X(hn, e?.labelGridcell, n.labelGridcell),
        labelNav: X(_n, e?.labelNav, n.labelNav),
        labelWeekNumberHeader: X(
            Cn,
            e?.labelWeekNumberHeader,
            n.labelWeekNumberHeader,
        ),
        labelWeekday: X(xn, e?.labelWeekday, n.labelWeekday),
    };
}
...
function jn(e, t = {}) {
    let { weekStartsOn: n, locale: r } = t,
        ...
        a = (t) => {
            let n =
                typeof t == `number` || typeof t == `string` ? new Date(t) : t;
            return new B(
                n.getFullYear(),
                n.getMonth(),
                n.getDate(),
    ...
    return {
        today: () => a(B.tz(e)),
        newDate: (t, n, r) => new B(t, n, r, 12, 0, 0, e),
        startOfDay: (e) => a(e),
        startOfWeek: (e, t) => {
            let n = a(e),
                r = t?.weekStartsOn ?? i,
        ...
        eachMonthOfInterval: (t) => {
            let n = a(t.start),
                r = a(t.end),
                i = [],
                o = new B(n.getFullYear(), n.getMonth(), 1, 12, 0, 0, e),
                s = r.getFullYear() * 12 + r.getMonth();
            for (; o.getFullYear() * 12 + o.getMonth() <= s; )
                (i.push(new B(o, e)), o.setMonth(o.getMonth() + 1, 1));
            return i;
        },
        addDays: (e, t) => {
            let n = a(e);
        ...
        eachYearOfInterval: (t) => {
            let n = a(t.start),
                r = a(t.end),
                i = [],
                o = new B(n.getFullYear(), 0, 1, 12, 0, 0, e);
            for (; o.getFullYear() <= r.getFullYear(); )
                (i.push(new B(o, e)), o.setFullYear(o.getFullYear() + 1, 0, 1));
            return i;
        },
        getWeek: (e, t) =>
            Te(o(e), {
        ...
        getISOWeek: (e) => Se(o(e)),
        differenceInCalendarDays: (e, t) => b(o(e), o(t)),
        differenceInCalendarMonths: (e, t) => ae(o(e), o(t)),
    };
}
var Mn = (e) => (e instanceof HTMLElement ? e : null),
    Nn = (e) => [...(e.querySelectorAll(`[data-animated-month]`) ?? [])],
    Pn = (e) => Mn(e.querySelector(`[data-animated-month]`)),
    Fn = (e) => Mn(e.querySelector(`[data-animated-caption]`)),
    In = (e) => Mn(e.querySelector(`[data-animated-weeks]`)),
    Ln = (e) => Mn(e.querySelector(`[data-animated-nav]`)),
    Rn = (e) => Mn(e.querySelector(`[data-animated-weekdays]`));
function zn(e, t, { classNames: n, months: r, focused: i, dateLib: a }) {
    ...
    (0, U.useLayoutEffect)(() => {
        ...
        if (
            ...
            return;
        let g = m instanceof HTMLElement ? Nn(m) : [],
            _ = Nn(e.current);
        if (
            ...
            (r && (r.style.zIndex = `1`),
                _.forEach((i, a) => {
                    ...
                    h &&
                        (h.classList.add(
                            d
                                ? n[q.caption_before_exit]
                                : n[q.caption_after_exit],
                        ),
                        h.addEventListener(`animationend`, u));
                    let _ = In(o);
                    (_ &&
                        _.classList.add(
                            d ? n[q.weeks_before_exit] : n[q.weeks_after_exit],
                        ),
            ...
            let y = new gt(
                ...
                _.reduce((e, t) => {
                    let i = n.ISOWeek ? l(t) : u(t),
                        ...
                        o = new ht(t, m, r);
                    return (a ? a.days.push(o) : e.push(new _t(i, [o])), e);
                }, []),
            );
            return (e.push(y), e);
        }, []);
...
function Gn(e, t) {
    let { startMonth: n, endMonth: r } = e,
        ...
        d =
            e.captionLayout === `dropdown` ||
            e.captionLayout === `dropdown-years`;
    return (
...
function Xn(e, t) {
    ...
    let {
            ...
            let i = Hn(s, r, { numberOfMonths: e.numberOfMonths }, t),
                o = Wn(
                    i,
                    Bn(
                        i,
            ...
            return {
                ...
                weeks: Jn(o),
                days: Vn(o),
                previousMonth: qn(s, n, e, t),
                nextMonth: Kn(s, r, e, t),
            };
        }, [
            t,
            s.getTime(),
...
function er(e, t, n, r, i, a, o, s = 0) {
    if (s > 365) return;
    let c = $n(e, t, n.date, r, i, a, o),
        l = !!(a.disabled && Y(c, a.disabled, o)),
        u = !!(a.hidden && Y(c, a.hidden, o)),
        d = new ht(c, c, o);
    return !l && !u ? d : er(e, t, d, r, i, a, o, s + 1);
}
function tr(e, t, n, r, i) {
    ...
    return {
        ...
        moveFocus: (n, r) => {
            if (!l) return;
            let a = er(n, r, l, t.navStart, t.navEnd, e, i);
            a &&
...
function rr(e, t, n = 0, r = 0, i = !1, a = H) {
    let { from: o, to: s } = t || {},
...
function Q(e, t) {
    return e instanceof B && e.timeZone === t ? e : new B(e, t);
}
function $(e, t, n) {
    if (!n) return Q(e, t);
    let r = Q(e, t),
        i = new B(r.getFullYear(), r.getMonth(), r.getDate(), 12, 0, 0, t);
...
function ur(e, t, n) {
    return typeof e == `boolean` || typeof e == `function`
        ...
        : e instanceof Date
          ? $(e, t, n)
          : Array.isArray(e)
            ? e.map((e) => (e instanceof Date ? $(e, t, n) : e))
            : qt(e)
              ? {
                    ...e,
              ...
              : Kt(e)
                ? { before: $(e.before, t, n), after: $(e.after, t, n) }
                : Jt(e)
                  ? { after: $(e.after, t, n) }
                  : Yt(e)
                    ? { before: $(e.before, t, n) }
...
function dr(e, t, n) {
    return e && (Array.isArray(e) ? e.map((e) => ur(e, t, n)) : ur(e, t, n));
}
function fr(e) {
    let t = e,
        n = t.timeZone;
    if (
        ...
        t.disabled !== void 0 && (t.disabled = dr(t.disabled, n)),
        t.hidden !== void 0 && (t.hidden = dr(t.hidden, n)),
        t.modifiers)
    ) {
        let e = {};
        (Object.keys(t.modifiers).forEach((r) => {
            e[r] = dr(t.modifiers?.[r], n);
        }),
            (t.modifiers = e));
    }
    let {
        ...
        let e = { ...mt, ...t.locale },
            ...
            r =
                t.noonSafe && t.timeZone
                    ? jn(t.timeZone, { weekStartsOn: n, locale: e })
                    : void 0,
        ...
        return {
            dateLib: a,
            components: en(t.components),
            formatters: fn(t.formatters),
            labels: En(t.labels, a.options),
            locale: e,
            classNames: { ...nn(), ...t.classNames },
        };
    }, [
        t.locale,
        t.broadcastCalendar,
    ...
    let {
        ...
        } = t,
        {
            ...
            formatWeekNumber: ne,
            formatWeekNumberHeader: re,
            formatWeekdayName: ie,
            formatYearDropdown: ae,
        } = i,
        oe = Xn(t, o),
        {
            days: se,
        ...
        de = Qt(se, t, le, ue, o),
        { isSelected: fe, select: pe, selected: D } = lr(t, o) ?? {},
        {
            blur: me,
            focused: he,
            isFocusTarget: ge,
        ...
        } = tr(t, oe, de, fe ?? (() => !1), o),
        {
            ...
            labelGridcell: ve,
            labelGrid: ye,
            labelMonthDropdown: be,
            labelNav: A,
            labelPrevious: xe,
            labelNext: Se,
            labelWeekday: Ce,
            labelWeekNumber: we,
            labelWeekNumberHeader: Te,
            labelYearDropdown: j,
        } = a,
        M = (0, U.useMemo)(
            () => kn(o, t.ISOWeek, t.broadcastCalendar, t.today),
        ...
        Ee = (0, U.useCallback)(
            (e, t) => (n) => {
                (n.preventDefault(),
                    n.stopPropagation(),
                    _e(e),
                    !t.disabled && (pe?.(e.date, t, n), m?.(e.date, t, n)));
            },
            [pe, m, _e],
        ),
        I = (0, U.useCallback)(
        ...
        { className: Ne, style: Pe } = (0, U.useMemo)(
            () => ({
        ...
        Le = (0, U.useRef)(null);
    zn(Le, !!t.animate, { classNames: c, months: ce, focused: he, dateLib: o });
    let Re = {
        dayPickerProps: t,
        selected: D,
        select: pe,
    ...
    return U.createElement(
        ...
        U.createElement(
            ...
            U.createElement(
                ...
                ce.map((e, n) => {
                    let a = t.reverseMonths ? ce.length - 1 - n : n;
                    return U.createElement(
                        r.Month,
                        {
                        ...
                        d === `around` &&
                            ...
                            U.createElement(
                                r.PreviousMonthButton,
                                {
                                    ...
                                    tabIndex: w ? void 0 : -1,
                                    'aria-disabled': w ? void 0 : !0,
                                    'aria-label': xe(w),
                                    onClick: P,
                                    'data-animated-button': t.animate
                                        ? `true`
                                        : void 0,
                                },
                        ...
                        U.createElement(
                            r.MonthCaption,
                            {
                                'data-animated-caption': t.animate
                                    ? `true`
                                    : void 0,
                        ...
                        U.createElement(
                            ...
                            !t.hideWeekdays &&
                                U.createElement(
                                    r.Weekdays,
                                    {
                                        'data-animated-weekdays': t.animate
                                            ? `true`
                                            : void 0,
                                    ...
                                    x &&
                                        U.createElement(
                                            r.WeekNumberHeader,
                                            {
                                                'aria-label': Te(o.options),
                                                className:
                                                    c[W.WeekNumberHeader],
                                ...
                                e.weeks.map((e) =>
                                    U.createElement(
                                        ...
                                        e.days.map((e) => {
                                            ...
                                            let a = On(i, S, t.modifiersStyles),
                                                s = $t(
                                                    i,
                                                    c,
                                                    t.modifiersClassNames,
                                                ),
                                                l =
                                                    !N && !i.hidden
                                                        ? ve(n, i, o.options, o)
