...
((n.definition = { methods: [`get`, `head`], url: `/posts` }),
...
((i.definition = { methods: [`get`, `head`], url: `/posts/create` }),
...
((o.definition = { methods: [`post`], url: `/posts` }),
...
((c.definition = { methods: [`get`, `head`], url: `/posts/{post}` }),
    (c.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { post: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
                `uuid` in n &&
                (n = { post: n.uuid }),
            Array.isArray(n) && (n = { post: n[0] }),
            (n = t(n)));
        let i = { post: typeof n.post == `object` ? n.post.uuid : n.post };
        return (
            c.definition.url
                .replace(`{post}`, i.post.toString())
                .replace(/\/+$/, ``) + e(r)
        );
    }),
...
((u.definition = { methods: [`get`, `head`], url: `/posts/{post}/edit` }),
    (u.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { post: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
...
((f.definition = { methods: [`put`, `patch`], url: `/posts/{post}` }),
    (f.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { post: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
...
((m.definition = { methods: [`delete`], url: `/posts/{post}` }),
    (m.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { post: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
