...
((n.definition = { methods: [`get`, `head`], url: `/works` }),
...
((i.definition = { methods: [`get`, `head`], url: `/works/create` }),
...
((o.definition = { methods: [`post`], url: `/works` }),
...
((c.definition = { methods: [`get`, `head`], url: `/works/{work}` }),
    (c.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { work: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
                `uuid` in n &&
                (n = { work: n.uuid }),
            Array.isArray(n) && (n = { work: n[0] }),
            (n = t(n)));
        let i = { work: typeof n.work == `object` ? n.work.uuid : n.work };
        return (
            c.definition.url
                .replace(`{work}`, i.work.toString())
                .replace(/\/+$/, ``) + e(r)
        );
    }),
...
((u.definition = { methods: [`get`, `head`], url: `/works/{work}/edit` }),
    (u.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { work: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
...
((f.definition = { methods: [`put`, `patch`], url: `/works/{work}` }),
    (f.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { work: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
...
((m.definition = { methods: [`delete`], url: `/works/{work}` }),
    (m.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) && (n = { work: n }),
            typeof n == `object` &&
                !Array.isArray(n) &&
