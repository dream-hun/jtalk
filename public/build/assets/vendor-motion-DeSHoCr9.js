...
function b(e, t, n, r, i) {
    let a,
        o,
        s = 0;
    do ((o = t + (n - t) / 2), (a = _(o, r, i) - e), a > 0 ? (n = o) : (t = o));
...
function x(e, t, n, r) {
    if (e === t && n === r) return l;
    let i = (t) => b(t, 0, 1, e, n);
    return (e) => (e === 0 || e === 1 ? e : _(i(e), t, r));
}
var S = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
    C = (e) => (t) => 1 - e(1 - t),
    w = x(0.33, 1.53, 0.69, 0.99),
    ee = C(w),
    T = S(ee),
    E = (e) =>
        e >= 1
    ...
    ae = x(0, 0, 0.58, 1),
    oe = x(0.42, 0, 0.58, 1),
    se = (e) => Array.isArray(e) && typeof e[0] != `number`,
    ...
    let u = {
        ...
        process: (e) => {
            ...
            ((n = r),
                (r = o),
                n.forEach(l),
                t && D.value && D.value.frameloop[t].push(c),
                (c = 0),
                n.clear(),
                (i = !1),
                a && ((a = !1), u.process(e)));
...
function he(e, t) {
    let n = !1,
        ...
        o = () => (n = !0),
        s = fe.reduce((e, n) => ((e[n] = pe(o, t ? n : void 0)), e), {}),
        {
            setup: c,
            read: l,
            resolveKeyframes: u,
        ...
        g = () => {
            let o = i.useManualTiming,
                s = o ? a.timestamp : performance.now();
            ((n = !1),
                o ||
                    (a.delta = r
                        ? 1e3 / 60
                        : Math.max(Math.min(s - a.timestamp, me), 1)),
                (a.timestamp = s),
                (a.isProcessing = !0),
                c.process(a),
                l.process(a),
    ...
    return {
        ...
        cancel: (e) => {
            for (let t = 0; t < fe.length; t++) s[fe[t]].cancel(e);
        },
        state: a,
        steps: s,
    };
...
var {
        ...
        state: A,
        steps: ge,
    } = he(typeof requestAnimationFrame < `u` ? requestAnimationFrame : l, !0),
    _e;
function ve() {
    _e = void 0;
}
var j = {
        now: () => (
            _e === void 0 &&
                j.set(
                    A.isProcessing || i.useManualTiming
                        ? A.timestamp
                        : performance.now(),
                ),
            _e
    ...
    M = { layout: 0, mainThread: 0, waapi: 0 },
    ye = (e) => (t) => typeof t == `string` && t.startsWith(e),
    be = ye(`--`),
    xe = ye(`var(--`),
    Se = (e) => (xe(e) ? Ce.test(e.split(`/*`)[0].trim()) : !1),
    Ce =
...
var je =
    ...
    Me = (e, t) => (n) =>
        !!(
            (typeof n == `string` && je.test(n) && n.startsWith(e)) ||
            (t && !Ae(n) && Object.prototype.hasOwnProperty.call(n, t))
        ),
    Ne = (e, t, n) => (r) => {
    ...
    Pe = (e) => n(0, 255, e),
    Fe = { ...Te, transform: (e) => Math.round(Pe(e)) },
    N = {
        test: Me(`rgb`, `red`),
        parse: Ne(`red`, `green`, `blue`),
...
var Le = { test: Me(`#`), parse: Ie, transform: N.transform },
    Re = (e) => ({
        test: (t) =>
    ...
    He = {
        test: Me(`hsl`, `hue`),
        parse: Ne(`hue`, `saturation`, `lightness`),
    ...
    L = {
        test: (e) => N.test(e) || Le.test(e) || He.test(e),
        parse: (e) =>
            N.test(e) ? N.parse(e) : He.test(e) ? He.parse(e) : Le.parse(e),
        transform: (e) =>
            typeof e == `string`
                ? e
...
function We(e) {
    return (
        isNaN(e) &&
        typeof e == `string` &&
        (e.match(ke)?.length || 0) + (e.match(Ue)?.length || 0) > 0
    );
}
var Ge = `number`,
    Ke = `color`,
    ...
    return {
        ...
        split: t
            .replace(
                ...
                (e) => (
                    L.test(e)
                        ? (r.color.push(a), i.push(Ke), n.push(L.parse(e)))
                        : e.startsWith(Je)
                          ? (r.var.push(a), i.push(qe), n.push(e))
                          : (r.number.push(a),
                            i.push(Ge),
                            n.push(parseFloat(e))),
                    ++a,
...
var tt = (e) =>
        typeof e == `number` ? 0 : L.test(e) ? L.getAnimatableNone(e) : e,
    nt = (e, t) =>
        typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : tt(e);
function rt(e) {
    let t = Ze(e);
    return $e(t)(t.values.map((e, n) => nt(e, t.split[n])));
}
var R = { test: We, parse: Qe, createTransformer: et, getAnimatableNone: rt };
function it(e, t, n) {
    return (
        n < 0 && (n += 1),
        n > 1 && --n,
...
function at({ hue: e, saturation: t, lightness: n, alpha: r }) {
    ((e /= 360), (t /= 100), (n /= 100));
    let i = 0,
        a = 0,
        o = 0;
...
var z = (e, t, n) => e + (t - e) * n,
    ...
    ct = [Le, N, He],
    lt = (e) => ct.find((t) => t.test(e));
function ut(e) {
    let t = lt(e);
    if ((`${e}`, !t)) return !1;
    let n = t.parse(e);
    return (t === He && (n = at(n)), n);
}
var dt = (e, t) => {
        let n = ut(e),
            r = ut(t);
        ...
        let i = { ...n };
        return (e) => (
            (i.red = st(n.red, r.red, e)),
            (i.green = st(n.green, r.green, e)),
            (i.blue = st(n.blue, r.blue, e)),
...
var yt = (e, t) => {
    ...
    return r.indexes.var.length === i.indexes.var.length &&
        ...
        ? (ft.has(e) && !i.values.length) || (ft.has(t) && !r.values.length)
            ? pt(e, t)
            : d(gt(vt(r, i), i.values), n)
        : (`${e}${t}`, ot(e, t));
};
function bt(e, t, n) {
...
function At({
    ...
    bounce: t = B.bounce,
    velocity: r = B.velocity,
    mass: i = B.mass,
}) {
    let a, o;
    B.maxDuration;
    let s = 1 - t;
    ((s = n(B.minDamping, B.maxDamping, s)),
        (e = n(B.minDuration, B.maxDuration, h(e))),
        s < 1
            ? ((a = (t) => {
                  let n = t * s,
                      i = n * e,
            ...
            : ((a = (t) => {
              ...
              (o = (t) => Math.exp(-t * e) * ((r - t) * (e * e)))));
    let c = 5 / e,
        l = Ot(a, o, c);
    if (((e = m(e)), isNaN(l)))
        return { stiffness: B.stiffness, damping: B.damping, duration: e };
    {
        let t = l ** 2 * i;
        return { stiffness: t, damping: s * 2 * Math.sqrt(i * t), duration: e };
    }
}
    ...
    if (!Nt(e, Mt) && Nt(e, jt))
        if (((t.velocity = 0), e.visualDuration)) {
            let r = e.visualDuration,
                i = (2 * Math.PI) / (r * 1.2),
                a = i * i,
                o = 2 * n(0.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(a);
            t = { ...t, mass: B.mass, stiffness: a, damping: o };
        } else {
            let n = At({ ...e, velocity: 0 });
            ((t = { ...t, ...n, mass: B.mass }),
                (t.isResolvedFromDuration = !0));
        }
    return t;
}
function Ft(e = B.visualDuration, t = B.bounce) {
    let n =
            typeof e == `object`
                ? e
        ...
        } = Pt({ ...n, velocity: -h(n.velocity || 0) }),
        g = f || 0,
        _ = l / (2 * Math.sqrt(c * u)),
        v = o - a,
        y = h(Math.sqrt(c / u)),
        b = Math.abs(v) < 5;
    ((r ||= b ? B.restSpeed.granular : B.restSpeed.default),
        (i ||= b ? B.restDelta.granular : B.restDelta.default));
    let x, S, C, w, ee, T;
    if (_ < 1)
        ((C = Et(y, _)),
            (w = (g + _ * y * v) / C),
            (x = (e) =>
                o -
                Math.exp(-_ * y * e) *
                    (w * Math.sin(C * e) + v * Math.cos(C * e))),
            (ee = _ * y * w + v * C),
            (T = _ * y * v - w * C),
            (S = (e) =>
                Math.exp(-_ * y * e) *
                (ee * Math.sin(C * e) + T * Math.cos(C * e))));
    else if (_ === 1) {
        x = (e) => o - Math.exp(-y * e) * (v + (g + y * v) * e);
        let e = g + y * v;
        S = (t) => Math.exp(-y * t) * (y * e * t - g);
    } else {
        let e = y * Math.sqrt(_ * _ - 1);
        x = (t) => {
            let n = Math.exp(-_ * y * t),
                r = Math.min(e * t, 300);
            return (
                o -
                (n * ((g + _ * y * v) * Math.sinh(r) + e * v * Math.cosh(r))) /
                    e
            );
        };
        let t = (g + _ * y * v) / e,
    ...
    let E = {
        ...
        toString: () => {
            let e = Math.min(wt(E), Ct),
                t = St((t) => E.next(e * t).value, e, 30);
            return e + `ms ` + t;
        },
        toTransition: () => {},
    };
...
function zt(e, t, n) {
    ...
    for (let n = 0; n < o; n++) {
        let i = a(e[n], e[n + 1]);
        (t && (i = d(Array.isArray(t) ? t[n] || l : t, i)), r.push(i));
    }
    return r;
}
function Bt(e, t, { clamp: r = !0, ease: i, mixer: a } = {}) {
    let o = e.length;
    if ((t.length, o === 1)) return () => t[0];
...
function Gt({
    ...
    let i = se(r) ? r.map(de) : de(r),
        a = { done: !1, value: t[0] },
        o = Bt(Ut(n && n.length === t.length ? n : Ht(t), e), t, {
...
var Kt = (e) => e !== null;
function qt(e, { repeat: t, repeatType: n = `loop` }, r, i = 1) {
    let a = e.filter(Kt),
        o = i < 0 || (t && n !== `loop` && t % 2 == 1) ? 0 : a.length - 1;
    return !o || r === void 0 ? a[o] : r;
}
var Jt = { decay: Rt, inertia: Rt, tween: Gt, keyframes: Gt, spring: Ft };
function Yt(e) {
    typeof e.type == `string` && (e.type = Jt[e.type]);
}
var Xt = class {
        constructor() {
            this.updateFinished();
    ...
    Qt = class extends Xt {
        ...
        initAnimation() {
            ...
            s !== Gt &&
                typeof o[0] != `number` &&
                ((this.mixKeyframes = d(Zt, bt(o[0], o[1]))), (o = [0, 100]));
            ...
            (i === `mirror` &&
                ...
                c.calculatedDuration === null &&
                    (c.calculatedDuration = wt(c)));
        ...
        tick(e, t = !1) {
            ...
            let _ = this.currentTime - l * (this.playbackSpeed >= 0 ? 1 : -1),
                v = this.playbackSpeed >= 0 ? _ < 0 : _ > i;
            ...
            let y = this.currentTime,
                b = r;
            if (d) {
                let e = Math.min(this.currentTime, i) / s,
                    t = Math.floor(e),
                    r = e % 1;
                (!r && e >= 1 && (r = 1),
                    r === 1 && t--,
            ...
            let x;
            (v
                ? ((this.delayState.value = u[0]), (x = this.delayState))
                : (x = b.next(y)),
                a && !v && (x.value = a(x.value)));
            let { done: S } = x;
            !v &&
                c !== null &&
                (S =
            ...
            return (
                C && m !== Rt && (x.value = qt(u, this.options, g, this.speed)),
                h && h(x.value),
                C && this.finish(),
                x
            );
        ...
        getGeneratorVelocity() {
            ...
            return Lt((e) => this.generator.next(e).value, e, t);
        }
        get speed() {
        ...
        set speed(e) {
            ...
            (t && this.driver && this.updateTime(j.now()),
                ...
                t && this.driver && (this.time = h(this.currentTime)));
        }
        play() {
            if (this.isStopped) return;
            let { driver: e = xt, startTime: t } = this.options;
...
var V = (e) => (e * 180) / Math.PI,
    ...
    rn = en,
    an = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]),
    on = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]),
    sn = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: on,
        scale: (e) => (an(e) + on(e)) / 2,
        rotateX: (e) => nn(V(Math.atan2(e[6], e[5]))),
        rotateY: (e) => nn(V(Math.atan2(-e[2], e[0]))),
        rotateZ: rn,
        rotate: rn,
...
var H = {
    ...
    x: (e, { transform: t }) => ln(t, `x`),
    y: (e, { transform: t }) => ln(t, `y`),
};
...
function xn() {
    ...
    ((yn = !1), (vn = !1), U.forEach((e) => e.complete(bn)), U.clear());
}
function Sn() {
    U.forEach((e) => {
...
var wn = class {
        ...
        scheduleResolve() {
            ((this.state = `scheduled`),
                this.isAsync
                    ? (U.add(this),
                      vn || ((vn = !0), O.read(Sn), O.resolveKeyframes(xn)))
        ...
        cancel() {
            this.state === `scheduled` &&
                (U.delete(this), (this.state = `pending`));
        }
        resume() {
...
var kn = On(() => window.ScrollTimeline !== void 0, `scrollTimeline`),
    An = On(() => {
        try {
            document
                .createElement(`div`)
    ...
    jn = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`,
    Mn = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
...
var Ln = class extends Xt {
        constructor(e) {
            ...
            ((this.isPseudoElement = !!i),
                ...
                e.type);
            let c = In(e);
            ((this.animation = Pn(t, n, r, c, i)),
                c.autoplay === !1 && this.animation.pause(),
                (this.animation.onfinish = () => {
                    if (((this.finishedTime = this.time), !i)) {
                        let e = qt(r, this.options, o, this.speed);
        ...
        set time(e) {
            ...
            ((this.manualStartTime = null),
                (this.finishedTime = null),
                (this.animation.currentTime = m(e)),
    ...
    Rn = { anticipate: E, backInOut: T, circInOut: re };
function zn(e) {
    return e in Rn;
}
function Bn(e) {
...
var Vn = 10,
    Hn = class extends Ln {
        ...
        updateMotionValue(e) {
            ...
            let s = new Qt({ ...o, autoplay: !1 }),
                c = Math.max(Vn, j.now() - this.startTime),
                l = n(0, Vn, c - Vn),
                u = s.sample(c).value,
                { name: d } = this.options;
            (a && d && En(a, d, u),
                t.setWithVelocity(s.sample(Math.max(0, c - l)).value, u, l),
                s.stop());
        }
    },
    Un = (e, t) =>
...
function Gn(e, t, n, r) {
    ...
    return (
        `${t}${i}${a}${o ? a : i}`,
        !o || !s ? !1 : Wn(e) || ((n === `spring` || Fn(n)) && r)
    );
}
function Kn(e) {
    ((e.duration = 0), (e.type = `keyframes`));
}
var qn = new Set([`opacity`, `clipPath`, `filter`, `transform`]),
    Jn = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function Yn(e) {
    for (let t = 0; t < e.length; t++)
        if (typeof e[t] == `string` && Jn.test(e[t])) return !0;
    return !1;
}
var Xn = new Set([
        `color`,
    ...
    Zn = c(() => Object.hasOwnProperty.call(Element.prototype, `animate`));
function Qn(e) {
    let {
        motionValue: t,
        name: n,
...
var $n = 40,
    er = class extends Xt {
        ...
        onKeyframesResolved(e, t, n, r) {
            ...
            Gn(e, a, o, s) ||
                ((f = !1),
                (i.instantAnimations || !c) && d?.(qt(e, n, t)),
                (e[0] = e[e.length - 1]),
                Kn(n),
                (n.repeat = 0));
            let p = {
                    startTime: r
                        ? this.resolvedAt &&
                          this.resolvedAt - this.createdAt > $n
                            ? this.resolvedAt
                            : this.createdAt
                        : void 0,
                    finalKeyframe: t,
            ...
            (g.finished
                ...
                (this.pendingTimeline &&=
                    ((this.stopTimeline = g.attachTimeline(
                        this.pendingTimeline,
                    )),
                    void 0)),
                (this._animation = g));
...
var ar = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 },
    ...
    sr = { type: `keyframes`, duration: 0.8 },
    cr = { type: `keyframes`, ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
    lr = (e, { keyframes: t }) =>
        t.length > 2
            ? sr
            : pn.has(e)
...
var mr =
    ...
    (s) => {
        ...
        (pr(c) || Object.assign(d, lr(e, d)),
            (d.duration &&= m(d.duration)),
            (d.repeatDelay &&= m(d.repeatDelay)),
        ...
        if (
            ...
            (i.instantAnimations ||
                i.skipAnimations ||
                a?.shouldSkipAnimations) &&
                ((f = !0), Kn(d), (d.delay = 0)),
            (d.allowFlatten = !c.type && !c.ease),
            f && !o && t.get() !== void 0)
        ) {
            let e = qt(d.keyframes, c);
            if (e !== void 0) {
                O.update(() => {
        ...
        return c.isSync ? new Qt(d) : new er(d);
    };
function hr(e) {
    let t = [{}, {}];
    return (
...
var _r = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...fn]),
    vr = 30,
    yr = (e) => !isNaN(parseFloat(e)),
    br = { current: void 0 },
    xr = class {
        constructor(e, t = {}) {
        ...
        setCurrent(e) {
            ((this.current = e),
                ...
                this.canTrackVelocity === null &&
                    e !== void 0 &&
                    (this.canTrackVelocity = yr(this.current)));
        }
...
function Pr(e, t, n = 0, r = 0, i = 0, a = 1, o) {
    let s = [];
...
function Fr(e, t, n = {}) {
    ...
    let r;
    if (Array.isArray(t)) {
        let i = t.map((t) => Nr(e, t, n));
        r = Promise.all(i);
    } else if (typeof t == `string`) r = Nr(e, t, n);
    else {
...
var Ir = { test: (e) => e === `auto`, parse: (e) => e },
    Lr = (e) => (t) => t.test(e),
    Rr = [Te, I, F, P, Be, ze, Ir],
    zr = (e) => Rr.find(Lr(e));
function Br(e) {
    return typeof e == `number`
        ? e === 0
...
var Vr = new Set([`brightness`, `contrast`, `saturate`, `opacity`]);
function Hr(e) {
...
function ri(e) {
    return o(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
var { schedule: ii, cancel: ai } = he(queueMicrotask, !1),
    q = { x: !1, y: !1 };
function oi() {
    return q.x || q.y;
}
...
var di = (e, t) => (t ? (e === t ? !0 : di(e, t.parentElement)) : !1),
    fi = (e) =>
        e.pointerType === `mouse`
...
var bi = (e, t) => {
    ...
    let r = vi(() => {
        ...
        (n.addEventListener(`keyup`, e, t),
            n.addEventListener(`blur`, () => yi(n, `cancel`), t));
    });
...
function Ci(e, t, n = {}) {
    let [r, i, a] = ci(e, n),
        o = (e) => {
            ...
            if (!xi(e) || Si.has(e)) return;
            (_i.add(r), n.stopPropagation && Si.add(e));
            let a = t(r, e),
                o = (e, t) => {
                    (window.removeEventListener(`pointerup`, s),
                        window.removeEventListener(`pointercancel`, c),
                        _i.has(r) && _i.delete(r),
                        xi(e) &&
                            typeof a == `function` &&
                            a(e, { success: t }));
                },
    ...
    return (
        r.forEach((e) => {
            ((n.useGlobalTarget ? window : e).addEventListener(
                ...
                ri(e) &&
                    (e.addEventListener(`focus`, (e) => bi(e, i)),
                    !mi(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0)));
        }),
        a
    );
}
function wi(e) {
    return o(e) && `ownerSVGElement` in e;
}
var Ti = new WeakMap(),
    Ei,
    Di = (e, t, n) => (r, i) =>
        i && i[0]
            ...
            : wi(r) && `getBBox` in r
              ? r.getBBox()[t]
              : r[n],
    Oi = Di(`inline`, `width`, `offsetWidth`),
    ki = Di(`block`, `height`, `offsetHeight`);
    ...
    return (
        ...
        () => {
            (Pi.delete(e),
                !Pi.size &&
                    typeof Fi == `function` &&
                    (window.removeEventListener(`resize`, Fi), (Fi = void 0)));
        }
    );
}
function Ri(e, t) {
    return typeof e == `function` ? Li(e) : Ni(e, t);
}
function zi(e) {
...
function Vi(e, t, n = {}) {
    ...
    if (
        (e.attach((e, t) => {
            ((a = e), (o = (e) => t(Hi(e, s))), O.postRender(u));
        }, c),
        K(t))
    ) {
        let r = n.skipInitialAnimation === !0,
            i = t.on(`change`, (t) => {
                r ? ((r = !1), e.jump(Hi(t, s), !1)) : e.set(Hi(t, s));
            }),
            a = e.on(`destroy`, i);
        return () => {
            (i(), a());
...
var Wi = [...Rr, L, R],
    Gi = (e) => Wi.find(Lr(e)),
    Ki = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
    qi = () => ({ x: Ki(), y: Ki() }),
    Ji = () => ({ min: 0, max: 0 }),
    J = () => ({ x: Ji(), y: Ji() }),
    Yi = new WeakMap();
...
var Qi = [
    ...
    $i = [`initial`, ...Qi];
function ea(e) {
    return Xi(e.animate) || $i.some((t) => Zi(e[t]));
}
function ta(e) {
...
function na(e, t, n) {
    for (let r in t) {
        ...
        else if (K(a)) e.addValue(r, G(i, { owner: e }));
        else if (a !== i)
            if (e.hasValue(r)) {
                let t = e.getValue(r);
                ...
                e.addValue(r, G(t === void 0 ? i : t, { owner: e }));
            }
    }
...
var da = class {
        ...
        constructor(
            ...
            ((this.latestValues = c),
                ...
                (this.isControllingVariants = ea(t)),
            ...
            ((this.current = e),
                ...
                this.reducedMotionConfig === `never`
                    ...
                    : this.reducedMotionConfig === `always`
                      ...
                      : (ia.current || oa(),
                        (this.shouldReduceMotion = ra.current)),
        ...
        getValue(e, t) {
            ...
            return (
                n === void 0 &&
                    t !== void 0 &&
                    ((n = G(t === null ? void 0 : t, { owner: this })),
                    this.addValue(e, n)),
                n
            );
        }
        readValue(e, t) {
            ...
            return (
                n != null &&
                    (typeof n == `string` && (a(n) || s(n))
                        ? (n = parseFloat(n))
                        : !Gi(n) && R.test(t) && (n = Zr(e, t)),
...
function Sa(e, t, n, r, i) {
    return (i !== void 0 && (e = xa(e, i, r)), xa(e, n, r) + t);
}
    ...
    for (let s = 0; s < i; s++) {
        ...
        (i && i.props.style && i.props.style.display === `contents`) ||
            (r &&
                ...
                a.scroll &&
                a !== a.root &&
                (X(e.x, -a.scroll.offset.x), X(e.y, -a.scroll.offset.y)),
            o && ((t.x *= o.x.scale), (t.y *= o.y.scale), wa(e, o)),
            r &&
                Y(a.latestValues) &&
                Aa(e, a.latestValues, a.layout?.layoutBox));
    }
    (t.x < Ea && t.x > Ta && (t.x = 1), t.y < Ea && t.y > Ta && (t.y = 1));
}
function X(e, t) {
    ((e.min += t), (e.max += t));
}
function Oa(e, t, n, r, i = 0.5) {
    Ca(e, t, n, z(e.min, e.max, i), r);
}
function ka(e, t) {
...
function Aa(e, t, n) {
    let r = n ?? e;
    (Oa(e.x, ka(t.x, r.x), t.scaleX, t.scale, t.originX),
        Oa(e.y, ka(t.y, r.y), t.scaleY, t.scale, t.originY));
}
function ja(e, t) {
    return ma(ga(e.getBoundingClientRect(), t));
}
function Ma(e, t, n) {
    let r = ja(e, n),
        { scroll: i } = t;
...
function Ia(e, t, n) {
    ...
    if (
        (t.transform ||
            (o || n
                ? (r.transform = Fa(t, e.transform, n))
                : (r.transform &&= `none`)),
        s)
    ) {
...
function La(e, { style: t, vars: n }, r, i) {
    let a = e.style,
        o;
    for (o in t) a[o] = t[o];
...
function Ha(e, { layout: t, layoutId: n }) {
    return (
        pn.has(e) ||
        e.startsWith(`origin`) ||
        ((t || n !== void 0) && (!!Va[e] || e === `opacity`))
    );
}
function Ua(e, t, n) {
    let r = e.style,
...
var Ga = class extends fa {
        constructor() {
            (super(...arguments),
                (this.type = `html`),
                (this.renderInstance = La));
        }
        readValueFromInstance(e, t) {
            if (pn.has(t))
                return this.projection?.isProjecting ? cn(t) : un(e, t);
            {
                let n = Wa(e),
                    r = (be(t) ? n.getPropertyValue(t) : n[t]) || 0;
        ...
        build(e, t, n) {
            Ia(e, t, n.transformTemplate);
        }
        scrapeMotionValuesFromProps(e, t, n) {
            return Ua(e, t, n);
        }
    },
    Ka = { offset: `stroke-dashoffset`, array: `stroke-dasharray` },
    qa = { offset: `strokeDashoffset`, array: `strokeDasharray` };
function Ja(e, t, n = 1, r = 0, i = !0) {
    e.pathLength = 1;
    let a = i ? Ka : qa;
    ((e[a.offset] = `${-r}`), (e[a.array] = `${t} ${n}`));
}
var Ya = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`];
function Xa(
    e,
    {
        attrX: t,
    ...
    for (let e of Ya) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
    (t !== void 0 && (d.x = t),
        n !== void 0 && (d.y = n),
        r !== void 0 && (d.scale = r),
        i !== void 0 && Ja(d, i, a, o, !1));
}
var Za = new Set([
        `baseFrequency`,
        `diffuseConstant`,
...
function $a(e, t, n, r) {
    La(e, t, void 0, r);
    for (let n in t.attrs) e.setAttribute(Za.has(n) ? n : Or(n), t.attrs[n]);
}
function eo(e, t, n) {
    let r = Ua(e, t, n);
    for (let n in e)
...
var to = class extends fa {
        ...
        readValueFromInstance(e, t) {
            ...
            return ((t = Za.has(t) ? t : Or(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
            return eo(e, t, n);
        }
...
function so(e) {
    return (t) =>
        Promise.all(t.map(({ animation: t, options: n }) => Fr(e, t, n)));
}
function co(e) {
    let t = so(e),
        n = uo(),
...
function xo(e, t, n, r = 0.5) {
    ((e.origin = r),
        (e.originPoint = z(t.min, t.max, e.origin)),
        (e.scale = $(n) / $(t)),
        (e.translate = z(n.min, n.max, e.origin) - e.originPoint),
        ((e.scale >= ho && e.scale <= go) || isNaN(e.scale)) && (e.scale = 1),
        ((e.translate >= vo && e.translate <= yo) || isNaN(e.translate)) &&
            (e.translate = 0));
}
function So(e, t, n, r) {
    (xo(e.x, t.x, n.x, r ? r.originX : void 0),
        xo(e.y, t.y, n.y, r ? r.originY : void 0));
}
...
function wo(e, t, n, r) {
    (Co(e.x, t.x, n.x, r?.x), Co(e.y, t.y, n.y, r?.y));
}
...
function Eo(e, t, n, r) {
    (To(e.x, t.x, n.x, r?.x), To(e.y, t.y, n.y, r?.y));
}
...
function Oo(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
    if (
        (F.test(t) &&
    ...
    (e === a && (s -= t),
        (e.min = Do(e.min, t, n, s, i)),
        (e.max = Do(e.max, t, n, s, i)));
}
function ko(e, t, [n, r, i], a, o) {
    Oo(e, t[n], t[r], t[i], t.scale, a, o);
}
var Ao = [`x`, `scaleX`, `originX`],
    jo = [`y`, `scaleY`, `originY`];
function Mo(e, t, n, r) {
    (ko(e.x, t, Ao, n ? n.x : void 0, r ? r.x : void 0),
        ko(e.y, t, jo, n ? n.y : void 0, r ? r.y : void 0));
}
function No(e) {
...
var Uo = [
    ...
    Wo = Uo.length,
    Go = (e) => (typeof e == `string` ? parseFloat(e) : e),
    Ko = (e) => typeof e == `number` || I.test(e);
function qo(e, t, n, r, i, a) {
    i
        ? ((e.opacity = z(0, n.opacity ?? 1, Yo(r))),
          (e.opacityExit = z(t.opacity ?? 1, 0, Xo(r))))
    ...
    for (let i = 0; i < Wo; i++) {
        ...
        (o === void 0 && s === void 0) ||
            ...
            (s ||= 0),
            o === 0 || s === 0 || Ko(o) === Ko(s)
                ? ((e[a] = Math.max(z(Go(o), Go(s), r), 0)),
                  (F.test(s) || F.test(o)) && (e[a] += `%`))
                : (e[a] = s));
    }
...
var Yo = Zo(0, 0.5, ne),
    Xo = Zo(0.5, 0.95, l);
function Zo(e, t, n) {
    return (r) => (r < e ? 0 : r > t ? 1 : n(f(e, t, r)));
}
function Qo(e, t, n) {
    let r = K(e) ? e : G(e);
    return (r.start(mr(``, r, t, n)), r.animation);
}
function $o(e, t, n, r = { passive: !0 }) {
...
var is = class {
    ...
    os = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
    ss = [``, `X`, `Y`, `Z`],
    cs = 1e3,
    ls = 0;
function us(e, t, n, r) {
...
function fs({
    ...
    return class {
            ...
            ((this.id = ls++),
                ...
                (this.updateProjection = () => {
                    ((this.projectionUpdateScheduled = !1),
                        D.value &&
                            (os.nodes =
                                os.calculatedTargetDeltas =
                                os.calculatedProjections =
                                    0),
                        this.nodes.forEach(hs),
                        this.nodes.forEach(ws),
                        this.nodes.forEach(Ts),
                        this.nodes.forEach(gs),
                        D.addProjectionMetrics && D.addProjectionMetrics(os));
                }),
        ...
        addEventListener(e, t) {
            return (
                this.eventHandlers.has(e) || this.eventHandlers.set(e, new p()),
        ...
        mount(t) {
            ...
            ((this.isSVG = wi(t) && !zi(t)), (this.instance = t));
        ...
        startUpdate() {
            this.isUpdateBlocked() ||
                ((this.isUpdating = !0),
                this.nodes && this.nodes.forEach(Es),
                this.animationId++);
        }
        ...
        update() {
            ...
            ((this.animationCommitId = this.animationId),
                ...
                this.clearAllSnapshots());
            let e = j.now();
            ((A.delta = n(0, 1e3 / 60, e - A.timestamp)),
                (A.timestamp = e),
                (A.isProcessing = !0),
                ge.update.process(A),
                ge.preRender.process(A),
                ge.render.process(A),
                (A.isProcessing = !1));
        }
        didUpdate() {
            this.updateScheduled ||
                ((this.updateScheduled = !0), ii.read(this.scheduleUpdate));
        }
        clearAllSnapshots() {
            (this.nodes.forEach(_s), this.sharedNodes.forEach(Ds));
        }
        ...
        resetTransform() {
            ...
            let e =
                ...
                t = this.projectionDelta && !Po(this.projectionDelta),
                n = this.getTransformTemplate(),
                r = n ? n(this.latestValues, ``) : void 0,
                i = r !== this.prevTransformTemplateValue;
            e &&
                this.instance &&
                (t || Y(this.latestValues) || i) &&
                (a(this.instance, r),
                (this.shouldResetTransform = !1),
                this.scheduleRender());
        }
        ...
        applyTransform(e, t = !1, n) {
            ...
            for (let e = 0; e < this.path.length; e++) {
                ...
                (!t &&
                    ...
                    n.scroll &&
                    n !== n.root &&
                    (X(r.x, -n.scroll.offset.x), X(r.y, -n.scroll.offset.y)),
                    Y(n.latestValues) &&
                        Aa(r, n.latestValues, n.layout?.layoutBox));
            }
            return (
                Y(this.latestValues) &&
                    Aa(r, this.latestValues, this.layout?.layoutBox),
                r
            );
        }
        removeTransform(e) {
            ...
            for (let e = 0; e < this.path.length; e++) {
                ...
                let r;
                (n.instance &&
                    (va(n.latestValues) && n.updateSnapshot(),
                    (r = J()),
                    Q(r, n.measurePageBox())),
                    Mo(t, n.latestValues, n.snapshot?.layoutBox, r));
            }
            return (Y(this.latestValues) && Mo(t, this.latestValues), t);
        }
        setTargetDelta(e) {
            ((this.targetDelta = e),
                    ...
                    this.attemptToResolveRelativeTarget &&
                        ...
                        this.animationProgress !== 1
                            ...
                            : (this.relativeParent = this.relativeTarget =
                                  void 0)),
                    D.value && os.calculatedTargetDeltas++));
        }
        ...
        calcProjection() {
            ...
            let a = this.treeScale.x,
                o = this.treeScale.y;
            (Da(this.layoutCorrected, this.treeScale, this.path, t),
                e.layout &&
                    !e.target &&
            ...
            (!this.projectionDelta || !this.prevProjectionDelta
                ...
                : (po(this.prevProjectionDelta.x, this.projectionDelta.x),
                  po(this.prevProjectionDelta.y, this.projectionDelta.y)),
                So(
                ...
                (this.treeScale.x !== a ||
                    this.treeScale.y !== o ||
                    !Bo(this.projectionDelta.x, this.prevProjectionDelta.x) ||
                    !Bo(this.projectionDelta.y, this.prevProjectionDelta.y)) &&
                    ((this.hasProjected = !0),
                    this.scheduleRender(),
                    this.notifyListeners(`projectionUpdate`, s)),
                D.value && os.calculatedProjections++);
        }
        hide() {
            this.isVisible = !1;
        }
            ...
            ((this.mixTargetDelta = (t) => {
                ...
                (Os(a.x, e.x, n),
                    ...
                    s &&
                        ...
                        qo(i, r, this.latestValues, n, u, l)),
                    this.root.scheduleUpdateProjection(),
                    this.scheduleRender(),
        ...
        resetSkewAndRotation() {
            ...
            for (let t = 0; t < ss.length; t++)
                (us(`rotate${ss[t]}`, e, r, this.animationValues),
                    us(`skew${ss[t]}`, e, r, this.animationValues));
            e.render();
            for (let t in r)
        ...
        applyProjectionStyles(e, t) {
            ...
            let a = Ho(this.projectionDeltaWithTransform, this.treeScale, i);
            ...
            for (let t in Va) {
                ...
                let { correct: n, applyTo: o, isCSSVariable: s } = Va[t],
            ...
            this.options.layoutId &&
                (e.pointerEvents =
                    r === this ? rs(t?.pointerEvents) || `` : `none`);
        }
        clearSnapshot() {
...
function ms(e) {
    ...
    if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
        ...
        if (i === `size`)
            ...
            let e = i === `x` ? `y` : `x`;
            fo(a ? t.measuredBox[e] : t.layoutBox[e], n[e]);
        } else
            Ls(i, t.layoutBox, n) &&
                Vo((r) => {
                    ...
                    ((i.max = i.min + o),
                        e.relativeTarget &&
                            ...
                            (e.relativeTarget[r].max =
                                e.relativeTarget[r].min + o)));
                });
        let o = qi();
        So(o, n, t.layoutBox);
        let s = qi();
        a
            ? So(s, e.applyTransform(r, !0), t.measuredBox)
            : So(s, n, t.layoutBox);
        let c = !Po(o),
            l = !1;
        if (!e.resumeFrom) {
            ...
            if (r && !r.resumeFrom) {
                ...
                if (i && a) {
                    let o = e.options.layoutAnchor || void 0,
                        s = J();
                    Eo(s, t.layoutBox, i.layoutBox, o);
                    let c = J();
                    (Eo(c, n, a.layoutBox, o),
                        Ro(s, c) || (l = !0),
...
var Ms = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
    ...
    Ps = Ns(`applewebkit/`) && !Ns(`chrome/`) ? Math.round : l;
function Fs(e) {
    ((e.min = Ps(e.min)), (e.max = Ps(e.max)));
}
function Is(e) {
    (Fs(e.x), Fs(e.y));
}
function Ls(e, t, n) {
    return (
        e === `position` || (e === `preserve-aspect` && !bo(zo(t), zo(n), 0.2))
    );
}
function Rs(e) {
...
var zs = fs({
        attachResizeListener: (e, t) => $o(e, `resize`, t),
        measureScroll: () => ({
            x:
