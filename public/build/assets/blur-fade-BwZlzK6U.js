...
import { a as i, i as a } from './blog-DQ8ZM9pB.js';
import { L as o } from './vendor-motion-DeSHoCr9.js';
var s = e(t(), 1),
    c = { some: 0, all: 1 };
function l(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
    let a = o(e),
        s = new WeakMap(),
                ...
                e.forEach((e) => {
                    ...
                    if (e.isIntersecting !== !!n)
                        if (e.isIntersecting) {
                            ...
                            typeof n == `function` &&
                                (n(e), s.delete(e.target));
                });
            },
            {
                root: n,
                rootMargin: r,
                threshold: typeof i == `number` ? i : c[i],
            },
        );
...
function f({
    ...
    let h = (0, s.useRef)(null),
        g = u(h, { once: !0, ...(p ? { margin: p } : {}) }),
        _ = !f || g,
        v = {
            hidden: { y: -l, opacity: 0, filter: `blur(${m})` },
            visible: { y: 0, opacity: 1, filter: `blur(0px)` },
        },
        y = n || v;
    return (0, d.jsx)(i, {
        children: (0, d.jsx)(a.div, {
            ref: h,
            initial: `hidden`,
            animate: _ ? `visible` : `hidden`,
            exit: `hidden`,
            variants: y,
            transition: { delay: 0.04 + c / 1e3, duration: o, ease: `easeOut` },
            className: r(t),
            children: e,
        }),
    });
