...
((n.definition = { methods: [`get`, `head`], url: `/categories` }),
...
((i.definition = { methods: [`get`, `head`], url: `/categories/create` }),
...
((o.definition = { methods: [`post`], url: `/categories` }),
...
((c.definition = { methods: [`get`, `head`], url: `/categories/{category}` }),
    (c.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            ...
            typeof n == `object` &&
                ...
                `uuid` in n &&
                (n = { category: n.uuid }),
            Array.isArray(n) && (n = { category: n[0] }),
            (n = t(n)));
        let i = {
            category:
                typeof n.category == `object` ? n.category.uuid : n.category,
        };
        return (
            c.definition.url
                .replace(`{category}`, i.category.toString())
                .replace(/\/+$/, ``) + e(r)
        );
    }),
...
((f.definition = { methods: [`put`, `patch`], url: `/categories/{category}` }),
    (f.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            (n = { category: n }),
            typeof n == `object` &&
...
((m.definition = { methods: [`delete`], url: `/categories/{category}` }),
    (m.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            (n = { category: n }),
            typeof n == `object` &&
