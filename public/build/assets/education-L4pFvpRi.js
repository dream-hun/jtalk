...
((i.definition = { methods: [`get`, `head`], url: `/education/create` }),
...
((o.definition = { methods: [`post`], url: `/education` }),
...
((c.definition = { methods: [`get`, `head`], url: `/education/{education}` }),
    (c.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            ...
            typeof n == `object` &&
                ...
                `uuid` in n &&
                (n = { education: n.uuid }),
            Array.isArray(n) && (n = { education: n[0] }),
            (n = t(n)));
        let i = {
            education:
                typeof n.education == `object` ? n.education.uuid : n.education,
        };
        return (
            c.definition.url
                .replace(`{education}`, i.education.toString())
                .replace(/\/+$/, ``) + e(r)
        );
    }),
...
((f.definition = { methods: [`put`, `patch`], url: `/education/{education}` }),
    (f.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            (n = { education: n }),
            typeof n == `object` &&
...
((m.definition = { methods: [`delete`], url: `/education/{education}` }),
    (m.url = (n, r) => {
        ((typeof n == `string` || typeof n == `number`) &&
            (n = { education: n }),
            typeof n == `object` &&
