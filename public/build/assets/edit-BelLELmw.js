...
import { t as i } from './input-D7RkL3Of.js';
import { n as a } from './wayfinder-D3ymjKEV.js';
import { t as o } from './setting-DKMLlvTv.js';
...
((d.definition = { methods: [`get`, `head`], url: `/setting` }),
...
((f.get = (e) => ({ action: d.url(e), method: `get` })),
    ...
    (d.form = f));
var p = (e) => ({ url: p.url(e), method: `put` });
((p.definition = { methods: [`put`], url: `/setting` }),
    (p.url = (e) => p.definition.url + a(e)),
    (p.put = (e) => ({ url: p.url(e), method: `put` })));
var m = (e) => ({
    action: p.url({
        [e?.mergeQuery ? `mergeQuery` : `query`]: {
            _method: `PUT`,
...
((m.put = (e) => ({
    ...
    (p.form = m));
var h = { edit: d, update: p },
    g = n();
function _({ setting: n }) {
    return (0, g.jsxs)(g.Fragment, {
        children: [
            (0, g.jsx)(e, { title: `Setting` }),
            (0, g.jsxs)(`div`, {
...
_.layout = { breadcrumbs: [{ title: `Setting`, href: o().url }] };
export { _ as default };
